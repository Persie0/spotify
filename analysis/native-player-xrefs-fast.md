# Fast native xref report — x86_64 liborbit-jni-spotify.so

Direct RIP-relative references and one-level pointer-table references to semantic strings.

## ad.skippable_ad_delay
- string: file+0x438801, VA 0x438801
  - direct target VA 0x438801: 0 code xref(s)

## ad.is_skippable
NOT FOUND

## ad_disallow
- string: file+0x36dd45, VA 0x36dd45
  - direct target VA 0x36dd45: 11 code xref(s)
    - xref 1: <stripped/unknown>
      ---
    ...
    - xref 11: <stripped/unknown>
      ---
       125ebbd:	ff 90 80 00 00 00    	call   QWORD PTR [rax+0x80]
...
- string: file+0x43d0c1, VA 0x43d0c1
  - direct target VA 0x43d0c1: 0 code xref(s)

## mft_disallow
- string: file+0x32bea6, VA 0x32bea6
  - direct target VA 0x32bea6: 18 code xref(s)
    - xref 1: <stripped/unknown>
      ---
    ...
    - xref 17: <stripped/unknown>
      ---
       125e781:	41 56                	push   r14
       125e783:	53                   	push   rbx
    ...
    - xref 18: <stripped/unknown>
      ---
       125ea3f:	48 8b 07             	mov    rax,QWORD PTR [rdi]
...
- string: file+0x43d2a1, VA 0x43d2a1
  - direct target VA 0x43d2a1: 0 code xref(s)

## disallow_skipping_next_reasons
- string: file+0x35aa90, VA 0x35aa90
  - direct target VA 0x35aa90: 3 code xref(s)
    - xref 1: <stripped/unknown>
      ---
...
- string: file+0x597f24, VA 0x597f24
  - direct target VA 0x597f24: 0 code xref(s)

- string: file+0x597f4a, VA 0x597f4a
  - direct target VA 0x597f4a: 0 code xref(s)

- string: file+0x5f2bd0, VA 0x5f2bd0
  - direct target VA 0x5f2bd0: 0 code xref(s)

- string: file+0x5fc751, VA 0x5fc751
  - direct target VA 0x5fc751: 0 code xref(s)

- string: file+0x193231a, VA 0x193631a
  - direct target VA 0x193631a: 0 code xref(s)

- string: file+0x19a0d8a, VA 0x19a4d8a
  - direct target VA 0x19a4d8a: 0 code xref(s)

- string: file+0x19abc5c, VA 0x19afc5c
  - direct target VA 0x19afc5c: 0 code xref(s)

## SKIP_TO_NEXT_RESTRICTED
- string: file+0x5f81e3, VA 0x5f81e3
  - direct target VA 0x5f81e3: 0 code xref(s)

## skip_to_next_restricted
- string: file+0x3684ad, VA 0x3684ad
  - direct target VA 0x3684ad: 0 code xref(s)
