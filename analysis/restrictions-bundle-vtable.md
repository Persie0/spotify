...
| offset | entry addr | target | label | reloc |
|---:|---:|---:|---|---|
...
| callsite | vtable offset | target | label |
|---:|---:|---:|---|
...
## Method `+0x10` from callsite `0x1661089` -> `0x153cb86`
...
- scanned instructions: `409`
- arg-memory refs: `58`
- arg-derived writes/indirect calls: `15`
- calls: `32`
- returns in scan window: `4`
...
```text
    ...
    ... truncated 339 additional instructions ...
```

### Arg-derived writes / indirect calls
| addr | location | instruction |
|---|---|---|
...
## Method `+0x30` from callsite `0x1661095` -> `0x153cbfc`
- label: `_ZN4asio6detail16service_registry6createINS0_23reactive_socket_serviceINS_2ip3tcpEEENS_10io_contextEEEPNS_17execution_context7serviceEPv@@Base`
- scanned instructions: `408`
- arg-memory refs: `54`
- arg-derived writes/indirect calls: `12`
- calls: `34`
- returns in scan window: `4`
...
```text
    ...
    ... truncated 338 additional instructions ...
```
...
## Method `+0x18` from callsite `0x16610a2` -> `0xa3fa60`
- label: `_ZNKSt6__ndk17codecvtIcc9mbstate_tE16do_always_noconvEv@@Base`
- scanned instructions: `378`
- arg-memory refs: `3`
- arg-derived writes/indirect calls: `3`
- calls: `28`
- returns in scan window: `4`
...
```text
      ...
      a3fb1a:	cc                   	int3
      a3fb1b:	cc                   	int3
    ... truncated 308 additional instructions ...
```
...
## Interpretation
- `+0x30` is the dispatch at `1661095` after building a local descriptor whose `+0x8` points to the post-`17add2a` object.
- If `+0x30` writes through `arg:rdi+0x30`, that closes the Restrictions factory `rdx+0x30` source; otherwise follow the method-specific delegate call.
