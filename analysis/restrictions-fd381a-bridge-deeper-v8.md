# Restrictions bridge to `fd381a state+0x40/+0x140` deeper trace v8

Focus: narrow the remaining gap between the Restrictions-derived object graph and the known `e99d07 -> fd4c04 -> fd381a` readiness/mode discriminator path.

## `e99d07` window near `0xe99d07`
...
```
## `fd381a vicinity +0x140 virtual` window near `0xfd395a`
...
| `0xe9b05e` | `e9b05e:	40 88 ac 24 00 04 00 	mov    BYTE PTR [rsp+0x400],bpl` |
...
| `0xfd5683` | `fd5683:	48 8b 84 24 40 01 00 	mov    rax,QWORD PTR [rsp+0x140]` |
| `0xfd5a89` | `fd5a89:	49 8b 4c 24 40       	mov    rcx,QWORD PTR [r12+0x40]` |
| `0xfd5b84` | `fd5b84:	48 8d 4c 24 40       	lea    rcx,[rsp+0x40]` |
| `0xfd5bac` | `fd5bac:	ff 17                	call   QWORD PTR [rdi]` |
| `0xfd5be1` | `fd5be1:	c6 40 40 01          	mov    BYTE PTR [rax+0x40],0x1` |
| `0xfd5c37` | `fd5c37:	48 89 44 24 40       	mov    QWORD PTR [rsp+0x40],rax` |
| `0xfd5c5b` | `fd5c5b:	48 3b 44 24 40       	cmp    rax,QWORD PTR [rsp+0x40]` |
| `0xfd5cf3` | `fd5cf3:	ff 17                	call   QWORD PTR [rdi]` |
| `0xfd5d0e` | `fd5d0e:	41 ff 56 08          	call   QWORD PTR [r14+0x8]` |
...
| `0xfd432c` | `fd432c:	4c 89 7c 24 40       	mov    QWORD PTR [rsp+0x40],r15` |
| `0xfd443a` | `fd443a:	4c 8b 6c 24 40       	mov    r13,QWORD PTR [rsp+0x40]` |
| `0xfd4449` | `fd4449:	4c 8b 6c 24 40       	mov    r13,QWORD PTR [rsp+0x40]` |
| `0xfd4699` | `fd4699:	41 ff 56 08          	call   QWORD PTR [r14+0x8]` |
| `0xfd4868` | `fd4868:	48 8d 7c 24 40       	lea    rdi,[rsp+0x40]` |
| `0xfd488a` | `fd488a:	4c 8d 7c 24 40       	lea    r15,[rsp+0x40]` |
...
## Text mentions of bridge functions/APs
...
- This report is intended to decide whether `0x184d5d0` or `0x184d898` appears directly in the known `fd381a` path.
- If direct AP materialization is absent, the bridge is likely through erased payloads/virtual interfaces rather than literal AP identity.
