...
public class CarMessage {
    ...
    public boolean equals(Object obj) {
        ...
        return bxg1.m30826c(getSender(), carMessage.getSender()) && Objects.equals(this.mBody, carMessage.mBody) && this.mReceivedTimeEpochMillis == carMessage.mReceivedTimeEpochMillis && this.mIsRead == carMessage.mIsRead;
    }
    ...
    public nsn0 getSender() {
        Bundle bundle = this.mSender;
        if (bundle == null) {
            return null;
        }
        return nsn0.m65570a(bundle);
    }

    public int hashCode() {
        return Objects.hash(Integer.valueOf(bxg1.m30832i(getSender())), this.mBody, Long.valueOf(this.mReceivedTimeEpochMillis), Boolean.valueOf(this.mIsRead));
    }
