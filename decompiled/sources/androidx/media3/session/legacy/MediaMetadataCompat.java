...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final uj5 METADATA_KEYS_TYPE;
    ...
    public static final class Builder {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (num != null && num.intValue() != 3) {
                throw new IllegalArgumentException(s571.m77251j("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            Integer num = (Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.get(str);
            if (num != null && num.intValue() != 1) {
                throw new IllegalArgumentException(s571.m77251j("The ", str, " key cannot be used to put a CharSequence"));
            }
    ...
    static {
        ...
        METADATA_KEYS_TYPE = uj5Var;
        uj5Var.put(METADATA_KEY_TITLE, 1);
        uj5Var.put(METADATA_KEY_ARTIST, 1);
        uj5Var.put(METADATA_KEY_DURATION, 0);
        uj5Var.put(METADATA_KEY_ALBUM, 1);
        uj5Var.put(METADATA_KEY_AUTHOR, 1);
        uj5Var.put(METADATA_KEY_WRITER, 1);
        uj5Var.put(METADATA_KEY_COMPOSER, 1);
        uj5Var.put(METADATA_KEY_COMPILATION, 1);
        uj5Var.put(METADATA_KEY_DATE, 1);
        uj5Var.put(METADATA_KEY_YEAR, 0);
        uj5Var.put(METADATA_KEY_GENRE, 1);
        uj5Var.put(METADATA_KEY_TRACK_NUMBER, 0);
        uj5Var.put(METADATA_KEY_NUM_TRACKS, 0);
        uj5Var.put(METADATA_KEY_DISC_NUMBER, 0);
        uj5Var.put(METADATA_KEY_ALBUM_ARTIST, 1);
        uj5Var.put(METADATA_KEY_ART, 2);
        uj5Var.put(METADATA_KEY_ART_URI, 1);
        uj5Var.put(METADATA_KEY_ALBUM_ART, 2);
        uj5Var.put(METADATA_KEY_ALBUM_ART_URI, 1);
        uj5Var.put(METADATA_KEY_USER_RATING, 3);
        uj5Var.put(METADATA_KEY_RATING, 3);
        uj5Var.put(METADATA_KEY_DISPLAY_TITLE, 1);
        uj5Var.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        uj5Var.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        uj5Var.put(METADATA_KEY_DISPLAY_ICON, 2);
        uj5Var.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        uj5Var.put(METADATA_KEY_MEDIA_ID, 1);
        uj5Var.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        uj5Var.put(METADATA_KEY_MEDIA_URI, 1);
        uj5Var.put("android.media.metadata.ADVERTISEMENT", 0);
        uj5Var.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    private Bitmap getBitmap(String str) {
        try {
            ...
            yif1.m93821x0("Failed to retrieve a key as Bitmap.", e);
            return null;
        }
    }
    ...
    public MediaMetadata getMediaMetadata() {
        if (this.metadataFwk == null) {
            ...
            try {
                ...
                yif1.m93821x0("Failed to convert MediaMetadataCompat to MediaMetadata", e);
            }
    ...
    public byte[] getMostRelevantArtworkBitmapData() {
        ...
        if (this.compressedArtworkData == null) {
            try {
                ...
                yif1.m93821x0("Failed to compress MediaMetadataCompat artwork", e);
            }
        }
    ...
    public RatingCompat getRating(String str) {
        try {
            ...
            yif1.m93821x0("Failed to retrieve a key as Rating.", e);
            return null;
        }
    }
