        ...
        public boolean isTrustedForMediaControl(RemoteUserInfoImpl remoteUserInfoImpl) {
            ...
            try {
                ...
                if (applicationInfo != null) {
                    ...
                    if (uid == 1000 || uid == Process.myUid() || isPermissionGranted(remoteUserInfoImpl, PERMISSION_STATUS_BAR_SERVICE) || isPermissionGranted(remoteUserInfoImpl, PERMISSION_MEDIA_CONTENT_CONTROL) || isEnabledNotificationListener(remoteUserInfoImpl)) {
                        return true;
                    }
                }
                return false;
            } catch (PackageManager.NameNotFoundException unused) {
                yif1.m93806q("Package " + remoteUserInfoImpl.getPackageName() + " doesn't exist");
                return false;
            }
        }
    }
