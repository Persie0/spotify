...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class MediaSessionCallback extends MediaSession.Callback {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        if (resultReceiver != null) {
                            ...
                            xtm0.m92058E(bundle2, sessionToken.getSession2Token());
                            resultReceiver.send(0, bundle2);
                        }
                    } else if (str.equals(MediaControllerCompat.COMMAND_ADD_QUEUE_ITEM)) {
                        if (bundleM46328p != null) {
                            Callback.this.onAddQueueItem((MediaDescriptionCompat) LegacyParcelableUtil.convert(bundleM46328p.getParcelable(MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION), MediaDescriptionCompat.CREATOR));
                        }
                    } else if (str.equals(MediaControllerCompat.COMMAND_ADD_QUEUE_ITEM_AT)) {
                        if (bundleM46328p != null) {
                            Callback.this.onAddQueueItem((MediaDescriptionCompat) LegacyParcelableUtil.convert(bundleM46328p.getParcelable(MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION), MediaDescriptionCompat.CREATOR), bundleM46328p.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX));
                        }
                    } else if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM)) {
                        if (bundleM46328p != null) {
                            Callback.this.onRemoveQueueItem((MediaDescriptionCompat) LegacyParcelableUtil.convert(bundleM46328p.getParcelable(MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION), MediaDescriptionCompat.CREATOR));
                        }
                        ...
                        if (list != null && bundleM46328p != null) {
                            int i = bundleM46328p.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                            if (i >= 0 && i < list.size()) {
                        ...
                        Callback.this.onCommand(str, bundleM46328p, resultReceiver);
                    }
                } catch (BadParcelableException unused) {
                    yif1.m93808r("Could not unparcel the extra data.");
                }
            ...
            public void onCustomAction(String str, Bundle bundle) {
                ...
                try {
                    if (str.equals(MediaSessionCompat.ACTION_PLAY_FROM_URI)) {
                        if (bundleM46328p != null) {
                            Callback.this.onPlayFromUri((Uri) bundleM46328p.getParcelable(MediaSessionCompat.ACTION_ARGUMENT_URI), h0b1.m46328p(bundleM46328p.getBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS)));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_PREPARE)) {
                        Callback.this.onPrepare();
                    } else if (str.equals(MediaSessionCompat.ACTION_PREPARE_FROM_MEDIA_ID)) {
                        if (bundleM46328p != null) {
                            Callback.this.onPrepareFromMediaId(bundleM46328p.getString(MediaSessionCompat.ACTION_ARGUMENT_MEDIA_ID), h0b1.m46328p(bundleM46328p.getBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS)));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_PREPARE_FROM_SEARCH)) {
                        if (bundleM46328p != null) {
                            Callback.this.onPrepareFromSearch(bundleM46328p.getString(MediaSessionCompat.ACTION_ARGUMENT_QUERY), h0b1.m46328p(bundleM46328p.getBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS)));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_PREPARE_FROM_URI)) {
                        if (bundleM46328p != null) {
                            Callback.this.onPrepareFromUri((Uri) bundleM46328p.getParcelable(MediaSessionCompat.ACTION_ARGUMENT_URI), h0b1.m46328p(bundleM46328p.getBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS)));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_SET_CAPTIONING_ENABLED)) {
                        if (bundleM46328p != null) {
                            Callback.this.onSetCaptioningEnabled(bundleM46328p.getBoolean(MediaSessionCompat.ACTION_ARGUMENT_CAPTIONING_ENABLED));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_SET_REPEAT_MODE)) {
                        if (bundleM46328p != null) {
                            Callback.this.onSetRepeatMode(bundleM46328p.getInt(MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_SET_SHUFFLE_MODE)) {
                        if (bundleM46328p != null) {
                            Callback.this.onSetShuffleMode(bundleM46328p.getInt(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE));
                        }
                    } else if (str.equals(MediaSessionCompat.ACTION_SET_RATING)) {
                        if (bundleM46328p != null) {
                            Callback.this.onSetRating((RatingCompat) LegacyParcelableUtil.convert(bundleM46328p.getParcelable(MediaSessionCompat.ACTION_ARGUMENT_RATING), RatingCompat.CREATOR), h0b1.m46328p(bundleM46328p.getBundle(MediaSessionCompat.ACTION_ARGUMENT_EXTRAS)));
                        }
                    } else if (!str.equals(MediaSessionCompat.ACTION_SET_PLAYBACK_SPEED)) {
                        Callback.this.onCustomAction(str, bundleM46328p);
                    } else if (bundleM46328p != null) {
                        Callback.this.onSetPlaybackSpeed(bundleM46328p.getFloat(MediaSessionCompat.ACTION_ARGUMENT_PLAYBACK_SPEED, 1.0f));
                    }
                } catch (BadParcelableException unused) {
            ...
            public void onPlayFromMediaId(String str, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPlayFromMediaId(str, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
            ...
            public void onPlayFromSearch(String str, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPlayFromSearch(str, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
            ...
            public void onPlayFromUri(Uri uri, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPlayFromUri(uri, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
            ...
            public void onPrepareFromMediaId(String str, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPrepareFromMediaId(str, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
            ...
            public void onPrepareFromSearch(String str, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPrepareFromSearch(str, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
            ...
            public void onPrepareFromUri(Uri uri, Bundle bundle) {
                ...
                Bundle bundleM46328p = h0b1.m46328p(bundle);
                setCurrentControllerInfo(sessionImplIfCallbackIsSet);
                Callback.this.onPrepareFromUri(uri, bundleM46328p);
                clearCurrentControllerInfo(sessionImplIfCallbackIsSet);
            }
    ...
    public interface MediaSessionImpl {
        ...
        void setPlaybackToLocal(xs6 xs6Var);
    ...
    public static class MediaSessionImplApi23 implements MediaSessionImpl {
        ...
        public static class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                mediaSessionImplApi23.extraControllerCallbacks.register(iMediaControllerCallback, new MediaSessionManager.RemoteUserInfo(MediaSessionManager.RemoteUserInfo.LEGACY_CONTROLLER, callingPid, callingUid));
        ...
        public MediaSessionImplApi23(Context context, String str, Bundle bundle, String str2) {
            MediaSession mediaSessionCreateFwkMediaSession = createFwkMediaSession(context, str, bundle, str2);
        ...
        public MediaSession createFwkMediaSession(Context context, String str, Bundle bundle, String str2) {
        ...
        public String getCallingPackage() {
            try {
                ...
                yif1.m93810s("Cannot execute MediaSession.getCallingPackage()", e);
                return null;
            }
        }
        ...
        public void release() {
            ...
            if (Build.VERSION.SDK_INT == 27) {
                try {
                    ...
                    yif1.m93821x0("Exception happened while accessing MediaSession.mCallback.", e);
                }
            }
            ...
            synchronized (this.lock) {
                for (int iBeginBroadcast = this.extraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ...
                        yif1.m93810s("Dead object in setPlaybackState.", e);
                    }
                }
        ...
        @Override // androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(xs6 xs6Var) {
            this.sessionFwk.setPlaybackToLocal(xs6Var.m91967c());
        }
                ...
                synchronized (this.lock) {
                    for (int iBeginBroadcast = this.extraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                        try {
                            ...
                            yif1.m93810s("Dead object in setRepeatMode.", e);
                        }
                    }
                    this.extraControllerCallbacks.finishBroadcast();
                }
                ...
                synchronized (this.lock) {
                    for (int iBeginBroadcast = this.extraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                        try {
                            ...
                            yif1.m93810s("Dead object in setShuffleMode.", e);
                        }
                    }
                    this.extraControllerCallbacks.finishBroadcast();
                }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi23 {
        public MediaSessionImplApi28(Context context, String str, Bundle bundle, String str2) {
            super(context, str, bundle, str2);
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, Bundle bundle, String str2) {
            super(context, str, bundle, str2);
        }

        @Override // androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplApi23
        public MediaSession createFwkMediaSession(Context context, String str, Bundle bundle, String str2) {
            return ap4.m26637f(context, bundle, str);
        }
    }

    public static class MediaSessionImplApi37 extends MediaSessionImplApi29 {
        public MediaSessionImplApi37(Context context, String str, Bundle bundle, String str2) {
            super(context, str, bundle, str2);
        }

        @Override // androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplApi29, androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplApi23
        public MediaSession createFwkMediaSession(Context context, String str, Bundle bundle, String str2) {
            if (str2 == null) {
                return ap4.m26637f(context, bundle, str);
            }
            try {
                Constructor constructor = MediaSession.class.getConstructor(Context.class, String.class, Bundle.class, String.class);
                if (bundle == null) {
                    bundle = Bundle.EMPTY;
                }
                return (MediaSession) constructor.newInstance(context, str, bundle, str2);
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public MediaSession.QueueItem getQueueItem() {
            ...
            MediaSession.QueueItem queueItem2 = new MediaSession.QueueItem(this.description.getMediaDescription(), this.f1112id);
        ...
        public String toString() {
            ...
            sb.append(", Id=");
            return ikc0.m50938j(this.f1112id, " }", sb);
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
            this.description.writeToParcel(parcel, i);
            parcel.writeLong(this.f1112id);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            return new Token(token.inner, iMediaSessionAsInterface, nfb1VarM92098s);
        }
        ...
        public nfb1 getSession2Token() {
            nfb1 nfb1Var;
            synchronized (this.lock) {
                nfb1Var = this.session2Token;
            }
            return nfb1Var;
        }
        ...
        public void setSession2Token(nfb1 nfb1Var) {
            synchronized (this.lock) {
                this.session2Token = nfb1Var;
            }
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.lock) {
                try {
                    ...
                    nfb1 nfb1Var = this.session2Token;
                    if (nfb1Var != null) {
                        xtm0.m92058E(bundle, nfb1Var);
                    }
                } catch (Throwable th) {
                    throw th;
                }
        ...
        public Token(MediaSession.Token token, IMediaSession iMediaSession, nfb1 nfb1Var) {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, String str2) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("tag must not be null or empty");
        }
        if (str2 != null && context.checkSelfPermission("android.permission.OVERRIDE_MEDIA_SESSION_OWNER") != 0) {
            throw new SecurityException("must have OVERRIDE_MEDIA_SESSION_OWNER permission to override package name");
        }
        if (componentName == null && (componentName = MediaButtonReceiver.getMediaButtonReceiverComponent(context)) == null) {
            yif1.m93818w("Couldn't find a unique registered media button receiver in the given context.");
        }
        ...
        if (i >= 37) {
            this.impl = new MediaSessionImplApi37(context, str, bundle, str2);
        } else if (i >= 29) {
            this.impl = new MediaSessionImplApi29(context, str, bundle, str2);
        } else if (i >= 28) {
            this.impl = new MediaSessionImplApi28(context, str, bundle, str2);
        } else {
            this.impl = new MediaSessionImplApi23(context, str, bundle, str2);
        }
    ...
    public void setPlaybackToLocal(xs6 xs6Var) {
        this.impl.setPlaybackToLocal(xs6Var);
    }
        ...
        if (list != null) {
            ...
            for (QueueItem queueItem : list) {
                if (hashSet.contains(Long.valueOf(queueItem.getQueueId()))) {
                    yif1.m93810s("Found duplicate queue id: " + queueItem.getQueueId(), new IllegalArgumentException("id of each queue item should be unique"));
                }
