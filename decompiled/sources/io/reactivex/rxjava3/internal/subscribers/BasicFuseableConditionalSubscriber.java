...
public abstract class BasicFuseableConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, QueueSubscription<R> {
    ...
    public final ConditionalSubscriber f10194a;

    /* JADX INFO: renamed from: b */
    public ot51 f10195b;

    /* JADX INFO: renamed from: c */
    public QueueSubscription f10196c;
    ...
    public BasicFuseableConditionalSubscriber(ConditionalSubscriber conditionalSubscriber) {
        this.f10194a = conditionalSubscriber;
    }
    ...
    public int mo23423a(int i) {
        ...
        this.f10198e = iMo23423a;
        return iMo23423a;
    }

    /* JADX INFO: renamed from: b */
    public final void m23719b(Throwable th) {
    ...
    public final void onSubscribe(ot51 ot51Var) {
        if (SubscriptionHelper.m23733f(this.f10195b, ot51Var)) {
            this.f10195b = ot51Var;
            if (ot51Var instanceof QueueSubscription) {
                this.f10196c = (QueueSubscription) ot51Var;
            }
