...
public abstract class ExperimentalCronetEngine extends CronetEngine {
    ...
    public static boolean shouldOverrideWithHttpEngine(Context context) {
        ...
        try {
            Class.forName("org.chromium.net.impl.NativeCronetEngineBuilderImpl", false, dul.class.getClassLoader());
            z = true;
        } catch (ClassNotFoundException unused) {
            z = false;
        }
        ResolvedFlags.Value value = HttpFlagsLoader.getHttpFlags(context, cronetVersion, true, dul.m37010m(context).getBoolean("android.net.http.EnableTelemetry", !z)).flags().get(SHOULD_OVERRIDE_WITH_HTTPENGINE);
