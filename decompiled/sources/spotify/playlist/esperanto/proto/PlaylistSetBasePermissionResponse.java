...
public final class PlaylistSetBasePermissionResponse extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(PlaylistSetBasePermissionResponse.class, playlistSetBasePermissionResponse);
    }
    ...
    public static PlaylistSetBasePermissionResponse m97762o(byte[] bArr) {
        return (PlaylistSetBasePermissionResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new zmp0(DEFAULT_INSTANCE, 20);
        }
        if (iOrdinal == 5) {
    ...
    public final ResponseStatus m97763n() {
