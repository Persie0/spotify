...
public final class PlaylistOfflineResponse extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(PlaylistOfflineResponse.class, playlistOfflineResponse);
    }
    ...
    public static PlaylistOfflineResponse m97717o(byte[] bArr) {
        return (PlaylistOfflineResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new zmp0(DEFAULT_INSTANCE, 1);
        }
        if (iOrdinal == 5) {
    ...
    public final ResponseStatus m97718n() {
