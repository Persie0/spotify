...
public final class flw extends AbstractC0268g implements sre0 {
    ...
    public final void m42014m(PlaylistTrackDecorationPolicy playlistTrackDecorationPolicy) {
        copyOnWrite();
        EsLocalFiles$GetTracksRequest.m13152n((EsLocalFiles$GetTracksRequest) this.instance, playlistTrackDecorationPolicy);
    }
    ...
    public final void m42015q(ktp0 ktp0Var) {
        copyOnWrite();
        EsLocalFiles$GetTracksRequest.m13152n((EsLocalFiles$GetTracksRequest) this.instance, (PlaylistTrackDecorationPolicy) ktp0Var.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m42016r(EsLocalFiles$Query esLocalFiles$Query) {
        copyOnWrite();
        EsLocalFiles$GetTracksRequest.m13153o((EsLocalFiles$GetTracksRequest) this.instance, esLocalFiles$Query);
    }

    /* JADX INFO: renamed from: s */
    public final void m42017s(hlw hlwVar) {
        copyOnWrite();
        EsLocalFiles$GetTracksRequest.m13153o((EsLocalFiles$GetTracksRequest) this.instance, (EsLocalFiles$Query) hlwVar.build());
    }
