...
import com.spotify.checkout.proto.model.p044v1.proto.Redirect;
import com.spotify.checkout.proto.model.p044v1.proto.SpotifyCheckoutNative;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class nb10 extends AbstractC0268g implements sre0 {
    ...
    public final void m64056m(CheckoutItemUnavailable checkoutItemUnavailable) {
        copyOnWrite();
        GetSpotifyCheckoutPageResponse.m6207n((GetSpotifyCheckoutPageResponse) this.instance, checkoutItemUnavailable);
    }
    ...
    public final void m64057q(CheckoutStatus checkoutStatus) {
        copyOnWrite();
        GetSpotifyCheckoutPageResponse.m6208o((GetSpotifyCheckoutPageResponse) this.instance, checkoutStatus);
    }

    /* JADX INFO: renamed from: r */
    public final void m64058r(C0496j c0496j) {
        copyOnWrite();
        GetSpotifyCheckoutPageResponse.m6209p((GetSpotifyCheckoutPageResponse) this.instance, (Error) c0496j.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m64059s(rkv0 rkv0Var) {
        copyOnWrite();
        GetSpotifyCheckoutPageResponse.m6210q((GetSpotifyCheckoutPageResponse) this.instance, (Redirect) rkv0Var.build());
    }

    /* JADX INFO: renamed from: t */
    public final void m64060t(C0530v0 c0530v0) {
        copyOnWrite();
        GetSpotifyCheckoutPageResponse.m6211r((GetSpotifyCheckoutPageResponse) this.instance, (SpotifyCheckoutNative) c0530v0.build());
    }
