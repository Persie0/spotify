...
public final class rxe extends AbstractC0268g implements sre0 {
    public rxe() {
        super(CollaboratingUsersDecorationPolicy.DEFAULT_INSTANCE);
    }
    ...
    public final void m76613m(uye uyeVar) {
        copyOnWrite();
        CollaboratingUsersDecorationPolicy.m18296n((CollaboratingUsersDecorationPolicy) this.instance, (CollaboratorPolicy) uyeVar.build());
    }
    ...
    public final void m76614q() {
        copyOnWrite();
        CollaboratingUsersDecorationPolicy.m18297o((CollaboratingUsersDecorationPolicy) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m76615r(int i) {
        copyOnWrite();
        CollaboratingUsersDecorationPolicy.m18298p((CollaboratingUsersDecorationPolicy) this.instance, i);
    }
