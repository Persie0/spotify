...
import com.spotify.messages.ObservationEvent;
import java.io.InputStream;
import java.util.LinkedHashMap;
import java.util.Map;

/* JADX INFO: loaded from: classes2.dex */
public final class knk0 extends AbstractC0268g implements sre0 {
    ...
    public final void m56940m(Map map) {
        copyOnWrite();
        ObservationEvent.m14246n((ObservationEvent) this.instance).putAll(map);
    }
    ...
    public final void m56941q(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        ObservationEvent.m14247o((ObservationEvent) this.instance).putAll(linkedHashMap);
    }

    /* JADX INFO: renamed from: r */
    public final void m56942r(String str) {
        copyOnWrite();
        ObservationEvent.m14248p((ObservationEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m56943s(long j) {
        copyOnWrite();
        ObservationEvent.m14249q((ObservationEvent) this.instance, j);
    }

    /* JADX INFO: renamed from: t */
    public final void m56944t(String str) {
        copyOnWrite();
        ObservationEvent.m14250r((ObservationEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m56945u(String str) {
        copyOnWrite();
        ObservationEvent.m14251s((ObservationEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m56946v(long j) {
        copyOnWrite();
        ObservationEvent.m14252t((ObservationEvent) this.instance, j);
    }

    /* JADX INFO: renamed from: w */
    public final void m56947w(long j) {
        copyOnWrite();
        ObservationEvent.m14253u((ObservationEvent) this.instance, j);
    }
