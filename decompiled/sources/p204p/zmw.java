...
public final class zmw extends AbstractC0268g implements sre0 {
    ...
    public final void m96491m(ArrayList arrayList) {
        copyOnWrite();
        EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest.m17794n((EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest) this.instance, arrayList);
    }
    ...
    public final void m96492q(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest.m17795o((EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest) this.instance, esLoggingParams$LoggingParams);
    }

    /* JADX INFO: renamed from: r */
    public final void m96493r(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest.m17796p((EsPlayAsNextInQueueRequest$PlayAsNextInQueueRequest) this.instance, esCommandOptions$CommandOptions);
    }
