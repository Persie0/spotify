...
public final class mnw extends AbstractC0268g implements sre0 {
    ...
    public final void m62368m(EsContext$Context esContext$Context) {
        copyOnWrite();
        EsPreparePlay$PreparePlayRequest.m17823n((EsPreparePlay$PreparePlayRequest) this.instance, esContext$Context);
    }
    ...
    public final void m62369q(EsPreparePlayOptions$PreparePlayOptions esPreparePlayOptions$PreparePlayOptions) {
        copyOnWrite();
        EsPreparePlay$PreparePlayRequest.m17824o((EsPreparePlay$PreparePlayRequest) this.instance, esPreparePlayOptions$PreparePlayOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m62370r(EsPlayOrigin$PlayOrigin esPlayOrigin$PlayOrigin) {
        copyOnWrite();
        EsPreparePlay$PreparePlayRequest.m17825p((EsPreparePlay$PreparePlayRequest) this.instance, esPlayOrigin$PlayOrigin);
    }
