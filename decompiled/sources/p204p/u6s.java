...
public final class u6s extends AbstractC0268g implements sre0 {
    ...
    public final void m82460m(String str) {
        copyOnWrite();
        DownloadInteraction.m15761n((DownloadInteraction) this.instance, str);
    }
    ...
    public final void m82461q(String str) {
        copyOnWrite();
        DownloadInteraction.m15762o((DownloadInteraction) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m82462r(boolean z) {
        copyOnWrite();
        DownloadInteraction.m15763p((DownloadInteraction) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m82463s(String str) {
        copyOnWrite();
        DownloadInteraction.m15764q((DownloadInteraction) this.instance, str);
    }
