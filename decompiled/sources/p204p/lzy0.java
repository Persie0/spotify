...
public final class lzy0 extends AbstractC0268g implements sre0 {
    ...
    public final void m60392m(Iterable iterable) {
        copyOnWrite();
        SearchRequest.m98084n((SearchRequest) this.instance, iterable);
    }
    ...
    public final void m60393q(s1d0 s1d0Var) {
        copyOnWrite();
        SearchRequest.m98085o((SearchRequest) this.instance, s1d0Var);
    }

    /* JADX INFO: renamed from: r */
    public final void m60394r(String str) {
        copyOnWrite();
        SearchRequest.m98086p((SearchRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m60395s(TimeOffsetHighlight timeOffsetHighlight) {
        copyOnWrite();
        SearchRequest.m98087q((SearchRequest) this.instance, timeOffsetHighlight);
    }
