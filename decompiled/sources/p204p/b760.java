...
public final class b760 extends AbstractC0268g implements sre0 {
    ...
    public final void m28360m(ArrayList arrayList) {
        copyOnWrite();
        JamResolveTokenResult.m12832n((JamResolveTokenResult) this.instance, arrayList);
    }
    ...
    public final void m28361q(ArrayList arrayList) {
        copyOnWrite();
        JamResolveTokenResult.m12833o((JamResolveTokenResult) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m28362r(String str) {
        copyOnWrite();
        JamResolveTokenResult.m12834p((JamResolveTokenResult) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m28363s(String str) {
        copyOnWrite();
        JamResolveTokenResult.m12835q((JamResolveTokenResult) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m28364t(String str) {
        copyOnWrite();
        JamResolveTokenResult.m12836r((JamResolveTokenResult) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m28365u(String str) {
        copyOnWrite();
        JamResolveTokenResult.m12837s((JamResolveTokenResult) this.instance, str);
    }
