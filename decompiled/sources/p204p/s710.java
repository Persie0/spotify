...
public final class s710 extends AbstractC0268g implements sre0 {
    ...
    public final void m77354m(ContributionFilters contributionFilters) {
        copyOnWrite();
        GetContributionsRequest.m4329n((GetContributionsRequest) this.instance, contributionFilters);
    }
    ...
    public final void m77355q(ContributionPagination contributionPagination) {
        copyOnWrite();
        GetContributionsRequest.m4330o((GetContributionsRequest) this.instance, contributionPagination);
    }

    /* JADX INFO: renamed from: r */
    public final void m77356r(ContributionTarget contributionTarget) {
        copyOnWrite();
        GetContributionsRequest.m4331p((GetContributionsRequest) this.instance, contributionTarget);
    }
