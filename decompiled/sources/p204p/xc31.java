...
import com.spotify.libs.sociallistening.events.proto.SocialConnectHostApprovalRequestResult;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class xc31 extends AbstractC0268g implements sre0 {
    ...
    public final void m90347m(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12846n((SocialConnectHostApprovalRequestResult) this.instance, str);
    }
    ...
    public final void m90348q(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12847o((SocialConnectHostApprovalRequestResult) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m90349r(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12848p((SocialConnectHostApprovalRequestResult) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m90350s(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12849q((SocialConnectHostApprovalRequestResult) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m90351t() {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12850r((SocialConnectHostApprovalRequestResult) this.instance);
    }

    /* JADX INFO: renamed from: u */
    public final void m90352u(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12851s((SocialConnectHostApprovalRequestResult) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m90353v(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12852t((SocialConnectHostApprovalRequestResult) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m90354w(String str) {
        copyOnWrite();
        SocialConnectHostApprovalRequestResult.m12853u((SocialConnectHostApprovalRequestResult) this.instance, str);
    }
