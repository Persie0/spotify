...
import com.spotify.connectivity.reachability.esperanto.proto.EsReachabilityProvider$NotReachable;
...
public final class vlw extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f242611a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ vlw(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public vlw(int i) {
        super(EsOffline$Context.DEFAULT_INSTANCE);
        this.f242611a = i;
        switch (i) {
            case 2:
                ...
                break;
            case 4:
                super(EsOffline$ContextsProgressResponse.DEFAULT_INSTANCE);
                break;
            case 8:
                super(EsOffline$GetContextsResponse.DEFAULT_INSTANCE);
                break;
            case 10:
                super(EsOffline$GetItemsResponse.DEFAULT_INSTANCE);
                break;
            case 14:
                super(EsOffline$Item.DEFAULT_INSTANCE);
                break;
            case 18:
                super(EsOffline$TotalProgressResponse.DEFAULT_INSTANCE);
                break;
            case 24:
            ...
            case 28:
                ...
                break;
            case 29:
                super(EsReachabilityProvider$NotReachable.DEFAULT_INSTANCE);
                break;
            default:
                break;
        }
