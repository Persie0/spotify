...
import com.spotify.offline_esperanto.proto.EsOffline$BulkRedownloadPreflightResponse;
...
public final class qjw extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f189318a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ qjw(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public qjw(int i) {
        super(EsContextPlayerState$ContextIndex.DEFAULT_INSTANCE);
        this.f189318a = i;
        switch (i) {
            case 1:
            ...
            case 2:
                ...
                break;
            case 9:
                super(EsEncryptedStoredCredentials$EncryptedStoredCredentials.DEFAULT_INSTANCE);
                break;
            case 14:
                super(EsInteractionRequired$InteractionRequired.DEFAULT_INSTANCE);
                break;
            case 26:
                super(EsNotReachable$LegacyForcedOffline.DEFAULT_INSTANCE);
                break;
            case 28:
                super(EsOffline$BulkRedownloadPreflightResponse.DEFAULT_INSTANCE);
                break;
            default:
                break;
        }
