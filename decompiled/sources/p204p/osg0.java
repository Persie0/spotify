...
public final class osg0 implements pv91 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f168817a;

    /* JADX INFO: renamed from: b */
    public final zt91 f168818b;

    /* JADX INFO: renamed from: c */
    public final /* synthetic */ hsg0 f168819c;

    public osg0(hsg0 hsg0Var, int i) {
        this.f168817a = i;
        switch (i) {
            case 1:
                this.f168819c = hsg0Var;
                yt91 yt91VarM96903c = hsg0Var.f94693b.m96903c();
                yt91VarM96903c.f276055i.add(new bu91("system_dismiss", null, null, null, null));
                yt91VarM96903c.f276056j = false;
                this.f168818b = yt91VarM96903c.m94607a();
                break;
            default:
                this.f168819c = hsg0Var;
                ...
                this.f168818b = yt91VarM96903c2.m94607a();
                break;
        }
    }
    ...
    public final st91 mo24361d() {
        int i = this.f168817a;
        hsg0 hsg0Var = this.f168819c;
        zt91 zt91Var = this.f168818b;
        switch (i) {
            case 0:
    ...
    public final av91 m67714e() {
        switch (this.f168817a) {
            case 0:
                return new av91("", "", new dv91("hit", 1), new bv91("ui_hide", 1, nau.f152117a), this.f168818b, this.f168819c.f94694c.f180855a, System.currentTimeMillis());
            default:
                return new av91("", "", new dv91("hit", 1), new bv91("ui_hide", 1, nau.f152117a), this.f168818b, this.f168819c.f94694c.f180855a, System.currentTimeMillis());
        }
    }
