...
public final class nnq extends AbstractC0268g implements sre0 {
    public nnq() {
        super(DeleteConversationRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m65217m(String str) {
        copyOnWrite();
        DeleteConversationRequest.m2906n((DeleteConversationRequest) this.instance, str);
    }
