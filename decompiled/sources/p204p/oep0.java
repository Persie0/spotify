...
public final class oep0 extends AbstractC0268g implements sre0 {
    ...
    public final void m66800m(AlbumDecorationPolicy.Builder builder) {
        copyOnWrite();
        PlaylistAlbumDecorationPolicy.m18327n((PlaylistAlbumDecorationPolicy) this.instance, (AlbumDecorationPolicy) builder.build());
    }
    ...
    public final void m66801q(AlbumDecorationPolicy albumDecorationPolicy) {
        copyOnWrite();
        PlaylistAlbumDecorationPolicy.m18327n((PlaylistAlbumDecorationPolicy) this.instance, albumDecorationPolicy);
    }
