...
public final class k3n0 extends AbstractC0268g implements sre0 {
    ...
    public final void m55273m(int i) {
        copyOnWrite();
        PartnerAIResolveIntentError.m3076n((PartnerAIResolveIntentError) this.instance, i);
    }
    ...
    public final void m55274q(String str) {
        copyOnWrite();
        PartnerAIResolveIntentError.m3077o((PartnerAIResolveIntentError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m55275r(String str) {
        copyOnWrite();
        PartnerAIResolveIntentError.m3078p((PartnerAIResolveIntentError) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m55276s(String str) {
        copyOnWrite();
        PartnerAIResolveIntentError.m3079q((PartnerAIResolveIntentError) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m55277t(String str) {
        copyOnWrite();
        PartnerAIResolveIntentError.m3080r((PartnerAIResolveIntentError) this.instance, str);
    }
