...
public final class inw extends AbstractC0268g implements sre0 {
    ...
    public final void m51140m(EsPrefs$Value esPrefs$Value, String str) {
        esPrefs$Value.getClass();
        copyOnWrite();
        EsPrefs$SetParams.m19517n((EsPrefs$SetParams) this.instance).put(str, esPrefs$Value);
    }
