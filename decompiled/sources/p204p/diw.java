...
public final class diw extends AbstractC0268g implements sre0 {
    ...
    public final void m36128m(EsAuthenticateCredentials$AuthenticateCredentials esAuthenticateCredentials$AuthenticateCredentials) {
        copyOnWrite();
        EsAuthenticateRequest$AuthenticateRequest.m3555n((EsAuthenticateRequest$AuthenticateRequest) this.instance, esAuthenticateCredentials$AuthenticateCredentials);
    }
    ...
    public final void m36129q(String str) {
        copyOnWrite();
        EsAuthenticateRequest$AuthenticateRequest.m3556o((EsAuthenticateRequest$AuthenticateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m36130r() {
        copyOnWrite();
        EsAuthenticateRequest$AuthenticateRequest.m3557p((EsAuthenticateRequest$AuthenticateRequest) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m36131s(EsRecaptchaInfo$RecaptchaInfo esRecaptchaInfo$RecaptchaInfo) {
        copyOnWrite();
        EsAuthenticateRequest$AuthenticateRequest.m3558q((EsAuthenticateRequest$AuthenticateRequest) this.instance, esRecaptchaInfo$RecaptchaInfo);
    }

    /* JADX INFO: renamed from: t */
    public final void m36132t(String str) {
        copyOnWrite();
        EsAuthenticateRequest$AuthenticateRequest.m3559r((EsAuthenticateRequest$AuthenticateRequest) this.instance, str);
    }
