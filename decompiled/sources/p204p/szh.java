...
public final class szh extends AbstractC0268g implements sre0 {
    public szh() {
        super(ConcertCampaignPageRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m79751m(String str) {
        copyOnWrite();
        ConcertCampaignPageRequest.m6982n((ConcertCampaignPageRequest) this.instance, str);
    }
