...
import com.spotify.messages.StickerSelected;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class m351 extends AbstractC0268g implements sre0 {
    ...
    public final void m60641m(String str) {
        copyOnWrite();
        StickerSelected.m14423n((StickerSelected) this.instance, str);
    }
    ...
    public final void m60642q(String str) {
        copyOnWrite();
        StickerSelected.m14424o((StickerSelected) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m60643r(String str) {
        copyOnWrite();
        StickerSelected.m14425p((StickerSelected) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m60644s(String str) {
        copyOnWrite();
        StickerSelected.m14426q((StickerSelected) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m60645t(String str) {
        copyOnWrite();
        StickerSelected.m14427r((StickerSelected) this.instance, str);
    }
