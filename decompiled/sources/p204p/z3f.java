...
import com.spotify.collection_platform.esperanto.proto.CollectionPlatformContainsResponse;
...
public final class z3f extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f278883a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ z3f(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z3f(int i) {
        super(CollectionPlatformContainsResponse.DEFAULT_INSTANCE);
        this.f278883a = i;
        switch (i) {
            case 12:
                super(CollectionPlatformEsperantoContainsResponse.DEFAULT_INSTANCE);
                break;
            case 20:
                super(ColorSet.DEFAULT_INSTANCE);
                break;
            case 21:
                super(ColorSetContrastOptions.DEFAULT_INSTANCE);
                break;
            default:
                break;
        }
