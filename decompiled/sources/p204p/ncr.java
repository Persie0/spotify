...
public final class ncr extends AbstractC0268g implements sre0 {
    ...
    public final void m64165m(List list) {
        copyOnWrite();
        DeviceSuggestionProvided.m9260n((DeviceSuggestionProvided) this.instance, list);
    }
    ...
    public final void m64166q(String str) {
        copyOnWrite();
        DeviceSuggestionProvided.m9261o((DeviceSuggestionProvided) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m64167r(String str) {
        copyOnWrite();
        DeviceSuggestionProvided.m9262p((DeviceSuggestionProvided) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m64168s(String str) {
        copyOnWrite();
        DeviceSuggestionProvided.m9263q((DeviceSuggestionProvided) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m64169t(String str) {
        copyOnWrite();
        DeviceSuggestionProvided.m9264r((DeviceSuggestionProvided) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m64170u(String str) {
        copyOnWrite();
        DeviceSuggestionProvided.m9265s((DeviceSuggestionProvided) this.instance, str);
    }
