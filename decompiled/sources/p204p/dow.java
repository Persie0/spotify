...
public final class dow extends AbstractC0268g implements sre0 {
    public dow() {
        super(EsRestrictions$RestrictionReasons.DEFAULT_INSTANCE);
    }
    ...
    public final void m36552m(List list) {
        copyOnWrite();
        EsRestrictions$RestrictionReasons.m17867n((EsRestrictions$RestrictionReasons) this.instance, list);
    }
