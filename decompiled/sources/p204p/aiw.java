...
public final class aiw extends AbstractC0268g implements sre0 {
    public aiw() {
        super(EsAuthenticateCredentials$Password.DEFAULT_INSTANCE);
    }
    ...
    public final void m26117m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$Password.m3542n((EsAuthenticateCredentials$Password) this.instance, str);
    }
