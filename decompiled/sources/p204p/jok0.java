...
public final class jok0 extends AbstractC0268g implements sre0 {
    ...
    public final void m53887m(String str) {
        copyOnWrite();
        ObservationPlatformProto$Point.m17332n((ObservationPlatformProto$Point) this.instance, str);
    }
    ...
    public final void m53888q(long j) {
        copyOnWrite();
        ObservationPlatformProto$Point.m17333o((ObservationPlatformProto$Point) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m53889r(double d) {
        copyOnWrite();
        ObservationPlatformProto$Point.m17334p((ObservationPlatformProto$Point) this.instance, d);
    }
