...
import com.spotify.connectivity.reachability.esperanto.proto.EsConnectionInfoReceiver$Connected;
import com.spotify.connectivity.reachability.esperanto.proto.EsConnectionType$ConnectionType;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes6.dex */
public final class ajw extends AbstractC0268g implements sre0 {
    ...
    public final void m26176m(ArrayList arrayList) {
        copyOnWrite();
        EsConnectionInfoReceiver$Connected.m7556n((EsConnectionInfoReceiver$Connected) this.instance, arrayList);
    }
    ...
    public final void m26177q(EsConnectionType$ConnectionType esConnectionType$ConnectionType) {
        copyOnWrite();
        EsConnectionInfoReceiver$Connected.m7557o((EsConnectionInfoReceiver$Connected) this.instance, esConnectionType$ConnectionType);
    }

    /* JADX INFO: renamed from: r */
    public final void m26178r(djw djwVar) {
        copyOnWrite();
        EsConnectionInfoReceiver$Connected.m7558p((EsConnectionInfoReceiver$Connected) this.instance, djwVar);
    }
