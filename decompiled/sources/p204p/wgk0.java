...
public final class wgk0 extends AbstractC0268g implements sre0 {
    ...
    public final void m88055m(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetErrorEvent.m23097n((NpvRecommendationsWidgetErrorEvent) this.instance, str);
    }
    ...
    public final void m88056q(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetErrorEvent.m23098o((NpvRecommendationsWidgetErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m88057r(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetErrorEvent.m23099p((NpvRecommendationsWidgetErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m88058s(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetErrorEvent.m23100q((NpvRecommendationsWidgetErrorEvent) this.instance, str);
    }
