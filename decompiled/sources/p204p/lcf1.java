...
public abstract class lcf1 {

    /* JADX INFO: renamed from: a */
    public static final /* synthetic */ int f131931a = 0;
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m58708a(int i, byte[] bArr, int i2) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
    ...
    public static int m58709b(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int length;
        int i5;
    ...
    public static String m58710c(int i, byte[] bArr, int i2) {
        if (i2 == 0) {
            return "";
        }
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                if (b2 >= -32) {
                    if (b2 >= -16) {
                        if (i5 >= i3 - 2) {
                            throw new zzagk("Protocol message had invalid UTF-8.");
                        }
                        byte b4 = bArr[i5];
                        int i6 = i + 3;
                        byte b5 = bArr[i + 2];
                        ...
                        byte b6 = bArr[i6];
                        if (!k0y0.m55016D(b4)) {
                            if ((((b4 + 112) + (b2 << 28)) >> 30) == 0 && !k0y0.m55016D(b5) && !k0y0.m55016D(b6)) {
