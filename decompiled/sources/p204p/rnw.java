...
public final class rnw extends AbstractC0268g implements sre0 {
    public rnw() {
    ...
    public final void m76012m(EsContextTrack$ContextTrack esContextTrack$ContextTrack) {
        copyOnWrite();
        EsProvidedTrack$ProvidedTrack.m17845n((EsProvidedTrack$ProvidedTrack) this.instance, esContextTrack$ContextTrack);
    }
    ...
    public final void m76013q(String str) {
        copyOnWrite();
        EsProvidedTrack$ProvidedTrack.m17846o((EsProvidedTrack$ProvidedTrack) this.instance, str);
    }
