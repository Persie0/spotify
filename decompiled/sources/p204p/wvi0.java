...
import com.spotify.marquee.marquee.events.proto.NativeAdsFreeUserSinglePromo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class wvi0 extends AbstractC0268g implements sre0 {
    ...
    public final void m89124m(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m13419n((NativeAdsFreeUserSinglePromo) this.instance, str);
    }
    ...
    public final void m89125q(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m13420o((NativeAdsFreeUserSinglePromo) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m89126r(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m13421p((NativeAdsFreeUserSinglePromo) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m89127s(boolean z) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m13422q((NativeAdsFreeUserSinglePromo) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m89128t() {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m13423r((NativeAdsFreeUserSinglePromo) this.instance);
    }
