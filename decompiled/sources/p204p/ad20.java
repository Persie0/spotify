...
public final class ad20 extends AbstractC0268g implements sre0 {
    ...
    public final void m25504m(Chains chains) {
        copyOnWrite();
        HarmonizeRequestBody.m19393n((HarmonizeRequestBody) this.instance, chains);
    }
    ...
    public final void m25505q(Exclusions exclusions) {
        copyOnWrite();
        HarmonizeRequestBody.m19394o((HarmonizeRequestBody) this.instance, exclusions);
    }

    /* JADX INFO: renamed from: r */
    public final void m25506r(ManualOps manualOps) {
        copyOnWrite();
        HarmonizeRequestBody.m19395p((HarmonizeRequestBody) this.instance, manualOps);
    }

    /* JADX INFO: renamed from: s */
    public final void m25507s(String str) {
        copyOnWrite();
        HarmonizeRequestBody.m19396q((HarmonizeRequestBody) this.instance, str);
    }
