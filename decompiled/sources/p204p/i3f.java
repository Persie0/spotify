...
public final class i3f extends AbstractC0268g implements sre0 {
    public i3f() {
        super(CollectionEpisodeDecorationPolicy.DEFAULT_INSTANCE);
    }
    ...
    public final void m49613m(EpisodeCollectionDecorationPolicy episodeCollectionDecorationPolicy) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97492n((CollectionEpisodeDecorationPolicy) this.instance, episodeCollectionDecorationPolicy);
    }
    ...
    public final void m49614q() {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97493o((CollectionEpisodeDecorationPolicy) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m49615r(EpisodeDecorationPolicy episodeDecorationPolicy) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97494p((CollectionEpisodeDecorationPolicy) this.instance, episodeDecorationPolicy);
    }

    /* JADX INFO: renamed from: s */
    public final void m49616s(EpisodePlayedStateDecorationPolicy.Builder builder) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97495q((CollectionEpisodeDecorationPolicy) this.instance, (EpisodePlayedStateDecorationPolicy) builder.build());
    }

    /* JADX INFO: renamed from: t */
    public final void m49617t(EpisodePlayedStateDecorationPolicy episodePlayedStateDecorationPolicy) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97495q((CollectionEpisodeDecorationPolicy) this.instance, episodePlayedStateDecorationPolicy);
    }

    /* JADX INFO: renamed from: u */
    public final void m49618u(CollectionShowDecorationPolicy collectionShowDecorationPolicy) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97496r((CollectionEpisodeDecorationPolicy) this.instance, collectionShowDecorationPolicy);
    }

    /* JADX INFO: renamed from: v */
    public final void m49619v(EpisodeSyncDecorationPolicy episodeSyncDecorationPolicy) {
        copyOnWrite();
        CollectionEpisodeDecorationPolicy.m97497s((CollectionEpisodeDecorationPolicy) this.instance, episodeSyncDecorationPolicy);
    }
