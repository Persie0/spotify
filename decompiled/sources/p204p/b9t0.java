...
import com.spotify.messages.PuffinFiltersUsage;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class b9t0 extends AbstractC0268g implements sre0 {
    ...
    public final void m28529m(String str) {
        copyOnWrite();
        PuffinFiltersUsage.m14347n((PuffinFiltersUsage) this.instance, str);
    }
    ...
    public final void m28530q(String str) {
        copyOnWrite();
        PuffinFiltersUsage.m14348o((PuffinFiltersUsage) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m28531r(String str) {
        copyOnWrite();
        PuffinFiltersUsage.m14349p((PuffinFiltersUsage) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m28532s(boolean z) {
        copyOnWrite();
        PuffinFiltersUsage.m14350q((PuffinFiltersUsage) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m28533t(int i) {
        copyOnWrite();
        PuffinFiltersUsage.m14351r((PuffinFiltersUsage) this.instance, i);
    }

    /* JADX INFO: renamed from: u */
    public final void m28534u(String str) {
        copyOnWrite();
        PuffinFiltersUsage.m14352s((PuffinFiltersUsage) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m28535v(boolean z) {
        copyOnWrite();
        PuffinFiltersUsage.m14353t((PuffinFiltersUsage) this.instance, z);
    }

    /* JADX INFO: renamed from: w */
    public final void m28536w(int i) {
        copyOnWrite();
        PuffinFiltersUsage.m14354u((PuffinFiltersUsage) this.instance, i);
    }

    /* JADX INFO: renamed from: x */
    public final void m28537x(String str) {
        copyOnWrite();
        PuffinFiltersUsage.m14355v((PuffinFiltersUsage) this.instance, str);
    }
