...
public final class plw extends AbstractC0268g implements sre0 {
    ...
    public final void m70269m(int i) {
        copyOnWrite();
        EsMediaPrefetch$SegmentedVideoResource.m19504n((EsMediaPrefetch$SegmentedVideoResource) this.instance, i);
    }
    ...
    public final void m70270q(int i) {
        copyOnWrite();
        EsMediaPrefetch$SegmentedVideoResource.m19505o((EsMediaPrefetch$SegmentedVideoResource) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m70271r(cva cvaVar) {
        copyOnWrite();
        EsMediaPrefetch$SegmentedVideoResource.m19506p((EsMediaPrefetch$SegmentedVideoResource) this.instance, cvaVar);
    }
