...
public final class zac extends AbstractC0268g implements sre0 {
    ...
    public final void m95768m(String str) {
        copyOnWrite();
        CastMessages$ConnectionErrorRequest.m7286n((CastMessages$ConnectionErrorRequest) this.instance, str);
    }
    ...
    public final void m95769q(int i) {
        copyOnWrite();
        CastMessages$ConnectionErrorRequest.m7287o((CastMessages$ConnectionErrorRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m95770r(int i) {
        copyOnWrite();
        CastMessages$ConnectionErrorRequest.m7288p((CastMessages$ConnectionErrorRequest) this.instance, i);
    }
