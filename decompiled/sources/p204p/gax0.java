...
public final class gax0 extends AbstractC0268g implements sre0 {
    ...
    public final void m44184m(Iterable iterable) {
        copyOnWrite();
        ResumptionProgressEsperanto$GetResumePointRequest.m97875n((ResumptionProgressEsperanto$GetResumePointRequest) this.instance, iterable);
    }
    ...
    public final void m44185q(String str) {
        copyOnWrite();
        ResumptionProgressEsperanto$GetResumePointRequest.m97876o((ResumptionProgressEsperanto$GetResumePointRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m44186r(String str) {
        copyOnWrite();
        ResumptionProgressEsperanto$GetResumePointRequest.m97877p((ResumptionProgressEsperanto$GetResumePointRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m44187s(String str) {
        copyOnWrite();
        ResumptionProgressEsperanto$GetResumePointRequest.m97878q((ResumptionProgressEsperanto$GetResumePointRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m44188t() {
        copyOnWrite();
        ResumptionProgressEsperanto$GetResumePointRequest.m97879r((ResumptionProgressEsperanto$GetResumePointRequest) this.instance);
    }
