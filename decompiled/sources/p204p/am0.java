...
import com.spotify.p010ad.detection.esperanto.proto.AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes4.dex */
public final class am0 extends AbstractC0268g implements sre0 {
    ...
    public final void m26371m(ArrayList arrayList) {
        copyOnWrite();
        AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest.m2292n((AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest) this.instance, arrayList);
    }
    ...
    public final void m26372q(String str) {
        copyOnWrite();
        AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest.m2293o((AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m26373r(String str) {
        copyOnWrite();
        AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest.m2294p((AdDetectionOuterClass$SubscribeCreatorToUserTimestampRequest) this.instance, str);
    }
