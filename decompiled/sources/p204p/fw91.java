...
import com.spotify.messages.UbiProd1ImpressionSegment;
import java.io.InputStream;
import java.util.ArrayList;
import java.util.LinkedHashMap;

/* JADX INFO: loaded from: classes2.dex */
public final class fw91 extends AbstractC0268g implements sre0 {
    ...
    public final void m42954m(ArrayList arrayList) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14662n((UbiProd1ImpressionSegment) this.instance, arrayList);
    }
    ...
    public final void m42955q(ArrayList arrayList) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14663o((UbiProd1ImpressionSegment) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m42956r(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14664p((UbiProd1ImpressionSegment) this.instance).putAll(linkedHashMap);
    }

    /* JADX INFO: renamed from: s */
    public final void m42957s(String str) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14665q((UbiProd1ImpressionSegment) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m42958t(int i) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14666r((UbiProd1ImpressionSegment) this.instance, i);
    }

    /* JADX INFO: renamed from: u */
    public final void m42959u(long j) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14667s((UbiProd1ImpressionSegment) this.instance, j);
    }

    /* JADX INFO: renamed from: v */
    public final void m42960v(String str) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14668t((UbiProd1ImpressionSegment) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m42961w(int i) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14669u((UbiProd1ImpressionSegment) this.instance, i);
    }

    /* JADX INFO: renamed from: x */
    public final void m42962x(String str) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14670v((UbiProd1ImpressionSegment) this.instance, str);
    }

    /* JADX INFO: renamed from: y */
    public final void m42963y(int i) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14671w((UbiProd1ImpressionSegment) this.instance, i);
    }

    /* JADX INFO: renamed from: z */
    public final void m42964z(long j) {
        copyOnWrite();
        UbiProd1ImpressionSegment.m14672x((UbiProd1ImpressionSegment) this.instance, j);
    }
