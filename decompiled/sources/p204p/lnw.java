...
public final class lnw extends AbstractC0268g implements sre0 {
    ...
    public final void m59512m(boolean z) {
        copyOnWrite();
        EsPrefs$Value.m19522n((EsPrefs$Value) this.instance, z);
    }
    ...
    public final void m59513q(long j) {
        copyOnWrite();
        EsPrefs$Value.m19523o((EsPrefs$Value) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m59514r(String str) {
        copyOnWrite();
        EsPrefs$Value.m19524p((EsPrefs$Value) this.instance, str);
    }
