...
public final class mb10 extends AbstractC0268g implements sre0 {
    ...
    public final void m61339m(String str) {
        copyOnWrite();
        GetSpotifyCheckoutPageRequest.m6203n((GetSpotifyCheckoutPageRequest) this.instance, str);
    }
    ...
    public final void m61340q(it81 it81Var) {
        copyOnWrite();
        GetSpotifyCheckoutPageRequest.m6204o((GetSpotifyCheckoutPageRequest) this.instance, (TrackingData) it81Var.build());
    }
