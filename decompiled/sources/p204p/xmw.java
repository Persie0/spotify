...
public final class xmw extends AbstractC0268g implements sre0 {
    ...
    public final void m91478m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsPlay$PlayPreparedRequest.m17785n((EsPlay$PlayPreparedRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m91479q(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsPlay$PlayPreparedRequest.m17786o((EsPlay$PlayPreparedRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m91480r(EsPlayOptions$PlayOptions esPlayOptions$PlayOptions) {
        copyOnWrite();
        EsPlay$PlayPreparedRequest.m17787p((EsPlay$PlayPreparedRequest) this.instance, esPlayOptions$PlayOptions);
    }

    /* JADX INFO: renamed from: s */
    public final void m91481s(String str) {
        copyOnWrite();
        EsPlay$PlayPreparedRequest.m17788q((EsPlay$PlayPreparedRequest) this.instance, str);
    }
