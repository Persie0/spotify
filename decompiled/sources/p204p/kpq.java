...
public final class kpq extends AbstractC0268g implements sre0 {
    public kpq() {
    ...
    public final void m57060m(String str) {
        copyOnWrite();
        DeleteReactionRequest.m22167n((DeleteReactionRequest) this.instance, str);
    }
