...
import com.spotify.authentication.login5esperanto.EsAuthenticateContext$AuthenticateContext;
import com.spotify.authentication.login5esperanto.EsInteractionRequired$InteractionRequiredProceedRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class blw extends AbstractC0268g implements sre0 {
    ...
    public final void m29784m(EsAuthenticateContext$AuthenticateContext esAuthenticateContext$AuthenticateContext) {
        copyOnWrite();
        EsInteractionRequired$InteractionRequiredProceedRequest.m3628n((EsInteractionRequired$InteractionRequiredProceedRequest) this.instance, esAuthenticateContext$AuthenticateContext);
    }
    ...
    public final void m29785q(String str) {
        copyOnWrite();
        EsInteractionRequired$InteractionRequiredProceedRequest.m3629o((EsInteractionRequired$InteractionRequiredProceedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m29786r(String str) {
        copyOnWrite();
        EsInteractionRequired$InteractionRequiredProceedRequest.m3630p((EsInteractionRequired$InteractionRequiredProceedRequest) this.instance, str);
    }
