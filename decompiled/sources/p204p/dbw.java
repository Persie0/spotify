...
import com.spotify.authentication.login5esperanto.EsAuthenticateCredentials$AppleSignInCredentials;
...
public final class dbw extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f47378a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ dbw(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public dbw(int i) {
        super(EsAccessToken$AccessToken.DEFAULT_INSTANCE);
        this.f47378a = i;
        switch (i) {
            case 18:
                super(EsAdBreakContext$AdBreakContext.DEFAULT_INSTANCE);
                break;
            case 19:
                super(EsAuthStorageResult$AuthStorageResult.DEFAULT_INSTANCE);
                break;
            case 20:
            case 22:
            default:
                break;
            case 21:
                super(EsAuthenticateCredentials$AppleSignInCredentials.DEFAULT_INSTANCE);
                break;
            case 23:
                super(EsAuthenticateResult$AuthenticateResult.DEFAULT_INSTANCE);
                break;
            case 24:
                super(EsAuthenticateResult$AuthenticateSuccess.DEFAULT_INSTANCE);
                break;
        }
    }
