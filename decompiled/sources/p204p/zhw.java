...
public final class zhw extends AbstractC0268g implements sre0 {
    public zhw() {
        super(EsAuthenticateCredentials$ParentChildCredentials.DEFAULT_INSTANCE);
    }
    ...
    public final void m96180m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$ParentChildCredentials.m3538n((EsAuthenticateCredentials$ParentChildCredentials) this.instance, str);
    }
    ...
    public final void m96181q(EsUnencryptedStoredCredentials$UnencryptedStoredCredentials esUnencryptedStoredCredentials$UnencryptedStoredCredentials) {
        copyOnWrite();
        EsAuthenticateCredentials$ParentChildCredentials.m3539o((EsAuthenticateCredentials$ParentChildCredentials) this.instance, esUnencryptedStoredCredentials$UnencryptedStoredCredentials);
    }
