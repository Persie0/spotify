...
import com.spotify.sharecard.config.impl.proto.Image;
import com.spotify.sharecard.config.impl.proto.ImageBytes;
import com.spotify.sharecard.config.impl.proto.SetImage;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class l501 extends AbstractC0268g implements sre0 {
    ...
    public final void m58189m(m440 m440Var) {
        copyOnWrite();
        SetImage.m21179n((SetImage) this.instance, (ImageBytes) m440Var.build());
    }
    ...
    public final void m58190q(u240 u240Var) {
        copyOnWrite();
        SetImage.m21180o((SetImage) this.instance, (Image) u240Var.build());
    }
