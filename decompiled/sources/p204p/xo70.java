...
import com.spotify.home.slotloading.events.proto.LayoutLoadingEvent;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes7.dex */
public final class xo70 extends AbstractC0268g implements sre0 {
    ...
    public final void m91533m(ArrayList arrayList) {
        copyOnWrite();
        LayoutLoadingEvent.m11816n((LayoutLoadingEvent) this.instance, arrayList);
    }
    ...
    public final void m91534q(boolean z) {
        copyOnWrite();
        LayoutLoadingEvent.m11817o((LayoutLoadingEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m91535r(String str) {
        copyOnWrite();
        LayoutLoadingEvent.m11818p((LayoutLoadingEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m91536s(boolean z) {
        copyOnWrite();
        LayoutLoadingEvent.m11819q((LayoutLoadingEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m91537t(boolean z) {
        copyOnWrite();
        LayoutLoadingEvent.m11820r((LayoutLoadingEvent) this.instance, z);
    }
