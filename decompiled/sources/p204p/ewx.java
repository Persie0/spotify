...
public final class ewx extends AbstractC0268g implements sre0 {
    ...
    public final void m40147m(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m10562n((ExternalAccessoryRemoteError) this.instance, str);
    }
    ...
    public final void m40148q(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m10563o((ExternalAccessoryRemoteError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m40149r(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m10564p((ExternalAccessoryRemoteError) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m40150s(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m10565q((ExternalAccessoryRemoteError) this.instance, str);
    }
