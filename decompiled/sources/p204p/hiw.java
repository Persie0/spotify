...
public final class hiw extends AbstractC0268g implements sre0 {
    ...
    public final void m47639m(double d) {
        copyOnWrite();
        EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest.m3659n((EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest) this.instance, d);
    }
    ...
    public final void m47640q(double d) {
        copyOnWrite();
        EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest.m3660o((EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest) this.instance, d);
    }

    /* JADX INFO: renamed from: r */
    public final void m47641r(String str) {
        copyOnWrite();
        EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest.m3661p((EsAutomix$AdjustTransitionRecipeForItemSpeedsRequest) this.instance, str);
    }
