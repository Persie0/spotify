...
public final class a9j extends AbstractC0268g implements sre0 {
    ...
    public final void m25141m(String str) {
        copyOnWrite();
        ConsumerShareRequest.m23140n((ConsumerShareRequest) this.instance, str);
    }
    ...
    public final void m25142q(String str) {
        copyOnWrite();
        ConsumerShareRequest.m23141o((ConsumerShareRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m25143r(ConsumerShareRequestParameters consumerShareRequestParameters) {
        copyOnWrite();
        ConsumerShareRequest.m23142p((ConsumerShareRequest) this.instance, consumerShareRequestParameters);
    }
