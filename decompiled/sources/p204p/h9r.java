...
public final class h9r extends AbstractC0268g implements sre0 {
    ...
    public final void m46900m(double d) {
        copyOnWrite();
        DeviceLocationWrite.m9250n((DeviceLocationWrite) this.instance, d);
    }
    ...
    public final void m46901q(int i) {
        copyOnWrite();
        DeviceLocationWrite.m9251o((DeviceLocationWrite) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m46902r(String str) {
        copyOnWrite();
        DeviceLocationWrite.m9252p((DeviceLocationWrite) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m46903s(String str) {
        copyOnWrite();
        DeviceLocationWrite.m9253q((DeviceLocationWrite) this.instance, str);
    }
