...
public final class u9l extends AbstractC0268g implements sre0 {
    ...
    public final void m82641m(String str) {
        copyOnWrite();
        CreateNoteRequest.m21538n((CreateNoteRequest) this.instance, str);
    }
    ...
    public final void m82642q(String str) {
        copyOnWrite();
        CreateNoteRequest.m21539o((CreateNoteRequest) this.instance, str);
    }
