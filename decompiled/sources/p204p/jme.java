...
public final class jme extends AbstractC0268g implements sre0 {
    ...
    public final void m53775m(String str) {
        copyOnWrite();
        ClientSideEventRequest.m9133n((ClientSideEventRequest) this.instance, str);
    }
    ...
    public final void m53776q(dft0 dft0Var) {
        copyOnWrite();
        ClientSideEventRequest.m9134o((ClientSideEventRequest) this.instance, (PushNotificationTappedEvent) dft0Var.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m53777r(syy0 syy0Var) {
        copyOnWrite();
        ClientSideEventRequest.m9135p((ClientSideEventRequest) this.instance, (SearchPlayableItemTappedEvent) syy0Var.build());
    }
