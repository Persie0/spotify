...
import com.spotify.performancesdk.observationplatform.proto.ObservationPlatformProto$Event;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes2.dex */
public final class gok0 extends AbstractC0268g implements sre0 {
    ...
    public final void m45347m(Map map) {
        copyOnWrite();
        ObservationPlatformProto$Event.m17320n((ObservationPlatformProto$Event) this.instance).putAll(map);
    }
    ...
    public final void m45348q(String str) {
        copyOnWrite();
        ObservationPlatformProto$Event.m17321o((ObservationPlatformProto$Event) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m45349r(String str) {
        copyOnWrite();
        ObservationPlatformProto$Event.m17322p((ObservationPlatformProto$Event) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m45350s(long j) {
        copyOnWrite();
        ObservationPlatformProto$Event.m17323q((ObservationPlatformProto$Event) this.instance, j);
    }
