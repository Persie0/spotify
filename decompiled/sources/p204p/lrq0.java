...
public final class lrq0 extends AbstractC0268g implements sre0 {
    ...
    public final void m59818m(Map map) {
        copyOnWrite();
        PrepareSlotRequest.m2677n((PrepareSlotRequest) this.instance).putAll(map);
    }
    ...
    public final void m59819q(String str) {
        copyOnWrite();
        PrepareSlotRequest.m2678o((PrepareSlotRequest) this.instance, str);
    }
