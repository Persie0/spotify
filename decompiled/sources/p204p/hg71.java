...
import com.spotify.messages.ThirdPartyAppAttributionClientNonAuth;
import java.io.InputStream;

/* JADX INFO: loaded from: classes2.dex */
public final class hg71 extends AbstractC0268g implements sre0 {
    ...
    public final void m47418m(String str) {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14434n((ThirdPartyAppAttributionClientNonAuth) this.instance, str);
    }
    ...
    public final void m47419q(String str) {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14435o((ThirdPartyAppAttributionClientNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m47420r(String str) {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14436p((ThirdPartyAppAttributionClientNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m47421s(String str) {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14437q((ThirdPartyAppAttributionClientNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m47422t() {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14438r((ThirdPartyAppAttributionClientNonAuth) this.instance);
    }

    /* JADX INFO: renamed from: u */
    public final void m47423u(String str) {
        copyOnWrite();
        ThirdPartyAppAttributionClientNonAuth.m14439s((ThirdPartyAppAttributionClientNonAuth) this.instance, str);
    }
