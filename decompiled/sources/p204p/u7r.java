...
public final class u7r extends AbstractC0268g implements sre0 {
    ...
    public final void m82543m(boolean z) {
        copyOnWrite();
        DeviceLocationPermissionOutcome.m9245n((DeviceLocationPermissionOutcome) this.instance, z);
    }
    ...
    public final void m82544q(String str) {
        copyOnWrite();
        DeviceLocationPermissionOutcome.m9246o((DeviceLocationPermissionOutcome) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m82545r(String str) {
        copyOnWrite();
        DeviceLocationPermissionOutcome.m9247p((DeviceLocationPermissionOutcome) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m82546s(String str) {
        copyOnWrite();
        DeviceLocationPermissionOutcome.m9248q((DeviceLocationPermissionOutcome) this.instance, str);
    }
