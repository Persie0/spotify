...
public enum btg1 implements qqf1 {
    UNKNOWN_EVENT(0),
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(ContentType.SHORT_FORM_ON_DEMAND),
    CLOUD_SAFE_SEARCH_DETECT(ContentType.LONG_FORM_ON_DEMAND),
    CLOUD_SAFE_SEARCH_CLOSE(ContentType.LIVE),
    CLOUD_TEXT_CREATE(ContentType.USER_GENERATED_SHORT_FORM_ON_DEMAND),
    CLOUD_TEXT_DETECT(ContentType.USER_GENERATED_LONG_FORM_ON_DEMAND),
    CLOUD_TEXT_CLOSE(ContentType.USER_GENERATED_LIVE),
    ...
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(AdvertisementType.ON_DEMAND_PRE_ROLL),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(AdvertisementType.ON_DEMAND_MID_ROLL),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(AdvertisementType.ON_DEMAND_POST_ROLL),
    ...
    ON_DEVICE_IMAGE_CAPTIONING_MODEL_DOWNLOAD(ContentDeliverySubscriptionType.TRANSACTIONAL),
    ...
    ON_DEVICE_SHADOW_REMOVAL_CREATE(ContentDeliveryComposition.CLEAN),
    ON_DEVICE_SHADOW_REMOVAL_LOAD(ContentDeliveryComposition.EMBED),
