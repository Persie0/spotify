...
import com.spotify.connectivity.auth.clienttoken.esperanto.proto.EsClientToken$AcquireFailure;
...
public final class iiw extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f102642a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ iiw(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public iiw(int i) {
        super(EsClientToken$AcquireFailure.DEFAULT_INSTANCE);
        this.f102642a = i;
        switch (i) {
            case 18:
                super(EsCodeRequired$CodeRequired.DEFAULT_INSTANCE);
                break;
            case 26:
                super(EsConnectionId$ConnectionID.DEFAULT_INSTANCE);
                break;
            case 27:
                super(EsConnectionQualityService$ConnectionQualityEvent.DEFAULT_INSTANCE);
                break;
            case 29:
