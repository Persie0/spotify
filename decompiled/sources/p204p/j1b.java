...
import com.spotify.checkout.spotifycheckout.events.proto.CPHostedCheckoutPaymentEjectedToWeb;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class j1b extends AbstractC0268g implements sre0 {
    ...
    public final void m52120m(String str) {
        copyOnWrite();
        CPHostedCheckoutPaymentEjectedToWeb.m6761n((CPHostedCheckoutPaymentEjectedToWeb) this.instance, str);
    }
    ...
    public final void m52121q(String str) {
        copyOnWrite();
        CPHostedCheckoutPaymentEjectedToWeb.m6762o((CPHostedCheckoutPaymentEjectedToWeb) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m52122r(String str) {
        copyOnWrite();
        CPHostedCheckoutPaymentEjectedToWeb.m6763p((CPHostedCheckoutPaymentEjectedToWeb) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m52123s(String str) {
        copyOnWrite();
        CPHostedCheckoutPaymentEjectedToWeb.m6764q((CPHostedCheckoutPaymentEjectedToWeb) this.instance, str);
    }
