...
public final class vow extends AbstractC0268g implements sre0 {
    ...
    public final void m86104m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSkipNext$SkipNextRequest.m17993n((EsSkipNext$SkipNextRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m86105q(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSkipNext$SkipNextRequest.m17994o((EsSkipNext$SkipNextRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m86106r(EsContextTrack$ContextTrack esContextTrack$ContextTrack) {
        copyOnWrite();
        EsSkipNext$SkipNextRequest.m17995p((EsSkipNext$SkipNextRequest) this.instance, esContextTrack$ContextTrack);
    }
