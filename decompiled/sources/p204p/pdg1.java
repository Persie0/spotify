...
public abstract class pdg1 {

    /* JADX INFO: renamed from: a */
    public static final /* synthetic */ int f176464a = 0;
    ...
    static {
        ...
        if (adg1.f14624e && adg1.f14623d) {
            int i = dyf1.f54334a;
        }
    }

    /* JADX INFO: renamed from: a */
    public static int m69685a(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int length;
        int i5;
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    if (i7 <= i3 - 4) {
                        ...
                        byte[] bytes = str.getBytes(a5g1.f12516a);
                        length = bytes.length;
                        if (length - i > i2) {
                        ...
                        byte[] bytes2 = str.getBytes(a5g1.f12516a);
    ...
    public static int m69686b(String str) {
        ...
        while (i2 < length) {
            ...
            if (cCharAt >= 2048) {
                try {
                        ...
                        if (cCharAt2 < 2048) {
                            ...
                            if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                                if (Character.codePointAt(str, i2) < 65536) {
                                    throw new kdg1("Unpaired surrogate at index " + i2 + " of " + length2);
                                }
                                i2++;
                            }
                        }
                    ...
                    return str.getBytes(a5g1.f12516a).length;
                }
            }
            i3 += (127 - cCharAt) >>> 31;
            i2++;
    ...
    public static boolean m69687c(int i, byte[] bArr, int i2) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
