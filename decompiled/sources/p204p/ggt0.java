...
public final class ggt0 extends AbstractC0268g implements sre0 {
    ...
    public final void m44701m(Map map) {
        copyOnWrite();
        PutTargetingRequest.m2688n((PutTargetingRequest) this.instance).putAll(map);
    }
