...
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficEvents$FailedEvent;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficRequestInfo$RequestInfo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes.dex */
public final class hpw extends AbstractC0268g implements sre0 {
    ...
    public final void m48182m(String str) {
        copyOnWrite();
        EsTrafficEvents$FailedEvent.m7621n((EsTrafficEvents$FailedEvent) this.instance, str);
    }
    ...
    public final void m48183q(npw npwVar) {
        copyOnWrite();
        EsTrafficEvents$FailedEvent.m7622o((EsTrafficEvents$FailedEvent) this.instance, npwVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m48184r(EsTrafficConnectionMetrics$ConnectionMetrics esTrafficConnectionMetrics$ConnectionMetrics) {
        copyOnWrite();
        EsTrafficEvents$FailedEvent.m7623p((EsTrafficEvents$FailedEvent) this.instance, esTrafficConnectionMetrics$ConnectionMetrics);
    }

    /* JADX INFO: renamed from: s */
    public final void m48185s(EsTrafficRequestInfo$RequestInfo esTrafficRequestInfo$RequestInfo) {
        copyOnWrite();
        EsTrafficEvents$FailedEvent.m7624q((EsTrafficEvents$FailedEvent) this.instance, esTrafficRequestInfo$RequestInfo);
    }
