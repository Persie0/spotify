...
import com.spotify.aipartner.aipartnerapi.proto.Device;
import java.io.InputStream;

/* JADX INFO: loaded from: classes4.dex */
public final class ezj extends AbstractC0268g implements sre0 {
    ...
    public final void m40357m(Device device) {
        copyOnWrite();
        Context.m3040n((Context) this.instance, device);
    }
    ...
    public final void m40358q(String str) {
        copyOnWrite();
        Context.m3041o((Context) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m40359r(vxd0 vxd0Var) {
        copyOnWrite();
        Context.m3042p((Context) this.instance, vxd0Var);
    }

    /* JADX INFO: renamed from: s */
    public final void m40360s(vco0 vco0Var) {
        copyOnWrite();
        Context.m3043q((Context) this.instance, vco0Var);
    }
