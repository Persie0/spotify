...
public final class m8j extends AbstractC0268g implements sre0 {
    ...
    public final void m61112m(ArrayList arrayList) {
        copyOnWrite();
        ConsumedGroup.m22468n((ConsumedGroup) this.instance, arrayList);
    }
    ...
    public final void m61113q(String str) {
        copyOnWrite();
        ConsumedGroup.m22469o((ConsumedGroup) this.instance, str);
    }
