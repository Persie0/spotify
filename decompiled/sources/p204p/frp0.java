...
public final class frp0 extends AbstractC0268g implements sre0 {
    ...
    public final void m42505m(Iterable iterable) {
        copyOnWrite();
        PlaylistSetBasePermissionRequest.m97759n((PlaylistSetBasePermissionRequest) this.instance, iterable);
    }
    ...
    public final void m42506q(w401 w401Var) {
        copyOnWrite();
        PlaylistSetBasePermissionRequest.m97760o((PlaylistSetBasePermissionRequest) this.instance, (SetBasePermissionRequest) w401Var.build());
    }
