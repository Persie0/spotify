...
import com.spotify.aipartner.aipartnerapi.proto.Context;
import com.spotify.aipartner.aipartnerapi.proto.Query;
import com.spotify.aipartner.aipartnerapi.proto.ResolveIntentRequest;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes4.dex */
public final class czw0 extends AbstractC0268g implements sre0 {
    ...
    public final void m34463m(List list) {
        copyOnWrite();
        ResolveIntentRequest.m3066n((ResolveIntentRequest) this.instance, list);
    }
    ...
    public final void m34464q(Context context) {
        copyOnWrite();
        ResolveIntentRequest.m3067o((ResolveIntentRequest) this.instance, context);
    }

    /* JADX INFO: renamed from: r */
    public final void m34465r(int i) {
        copyOnWrite();
        ResolveIntentRequest.m3068p((ResolveIntentRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: s */
    public final void m34466s(Query query) {
        copyOnWrite();
        ResolveIntentRequest.m3069q((ResolveIntentRequest) this.instance, query);
    }

    /* JADX INFO: renamed from: t */
    public final void m34467t(String str) {
        copyOnWrite();
        ResolveIntentRequest.m3070r((ResolveIntentRequest) this.instance, str);
    }
