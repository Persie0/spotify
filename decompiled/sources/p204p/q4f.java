...
public final class q4f extends AbstractC0268g implements sre0 {
    public q4f() {
        super(CollectionPlatformItem.DEFAULT_INSTANCE);
    }
    ...
    public final void m72157m(f4f f4fVar) {
        copyOnWrite();
        CollectionPlatformItem.m6878n((CollectionPlatformItem) this.instance, (CollectionItemdata$ItemData) f4fVar.build());
    }
    ...
    public final void m72158q(String str) {
        copyOnWrite();
        CollectionPlatformItem.m6879o((CollectionPlatformItem) this.instance, str);
    }
