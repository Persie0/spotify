...
public final class k5v0 extends AbstractC0268g implements sre0 {
    ...
    public final void m55566m(String str) {
        copyOnWrite();
        RecentsDecorationErrorEvent.m20345n((RecentsDecorationErrorEvent) this.instance, str);
    }
    ...
    public final void m55567q(String str) {
        copyOnWrite();
        RecentsDecorationErrorEvent.m20346o((RecentsDecorationErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m55568r(String str) {
        copyOnWrite();
        RecentsDecorationErrorEvent.m20347p((RecentsDecorationErrorEvent) this.instance, str);
    }
