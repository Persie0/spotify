...
public final class z4d0 extends AbstractC0268g implements sre0 {
    ...
    public final void m95343m(List list) {
        copyOnWrite();
        Mdata$LocalExtensionQuery.m97634n((Mdata$LocalExtensionQuery) this.instance, list);
    }
    ...
    public final void m95344q(String str) {
        copyOnWrite();
        Mdata$LocalExtensionQuery.m97635o((Mdata$LocalExtensionQuery) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m95345r(ntx ntxVar) {
        copyOnWrite();
        Mdata$LocalExtensionQuery.m97636p((Mdata$LocalExtensionQuery) this.instance, ntxVar);
    }
