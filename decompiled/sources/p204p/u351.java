...
public final class u351 extends AbstractC0268g implements sre0 {
    ...
    public final void m82270m(String str) {
        copyOnWrite();
        StickerTapped.m14429n((StickerTapped) this.instance, str);
    }
    ...
    public final void m82271q(String str) {
        copyOnWrite();
        StickerTapped.m14430o((StickerTapped) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m82272r(String str) {
        copyOnWrite();
        StickerTapped.m14431p((StickerTapped) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m82273s(String str) {
        copyOnWrite();
        StickerTapped.m14432q((StickerTapped) this.instance, str);
    }
