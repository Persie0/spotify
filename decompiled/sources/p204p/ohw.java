...
public final class ohw extends AbstractC0268g implements sre0 {
    ...
    public final void m66981m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsAddToQueueRequest$AddToQueueRequest.m17660n((EsAddToQueueRequest$AddToQueueRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m66982q(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsAddToQueueRequest$AddToQueueRequest.m17661o((EsAddToQueueRequest$AddToQueueRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m66983r(EsContextTrack$ContextTrack esContextTrack$ContextTrack) {
        copyOnWrite();
        EsAddToQueueRequest$AddToQueueRequest.m17662p((EsAddToQueueRequest$AddToQueueRequest) this.instance, esContextTrack$ContextTrack);
    }
