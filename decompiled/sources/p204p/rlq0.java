...
import com.spotify.premiummarketing.premiumdestinationpage.p130v1.PremiumFeatureCard;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class rlq0 extends AbstractC0268g implements sre0 {
    ...
    public final void m75882m(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19655n((PremiumFeatureCard) this.instance, str);
    }
    ...
    public final void m75883q(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19656o((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m75884r(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19657p((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m75885s(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19658q((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m75886t(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19659r((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m75887u(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19660s((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m75888v(LoggingInfo loggingInfo) {
        copyOnWrite();
        PremiumFeatureCard.m19661t((PremiumFeatureCard) this.instance, loggingInfo);
    }

    /* JADX INFO: renamed from: w */
    public final void m75889w(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19662u((PremiumFeatureCard) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m75890x(String str) {
        copyOnWrite();
        PremiumFeatureCard.m19663v((PremiumFeatureCard) this.instance, str);
    }
