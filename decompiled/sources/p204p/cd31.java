...
import com.spotify.libs.sociallistening.events.proto.SocialConnectInviteNotificationCriteriaFailureV1;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class cd31 extends AbstractC0268g implements sre0 {
    ...
    public final void m32341m(boolean z) {
        copyOnWrite();
        SocialConnectInviteNotificationCriteriaFailureV1.m12855n((SocialConnectInviteNotificationCriteriaFailureV1) this.instance, z);
    }
    ...
    public final void m32342q(boolean z) {
        copyOnWrite();
        SocialConnectInviteNotificationCriteriaFailureV1.m12856o((SocialConnectInviteNotificationCriteriaFailureV1) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m32343r(String str) {
        copyOnWrite();
        SocialConnectInviteNotificationCriteriaFailureV1.m12857p((SocialConnectInviteNotificationCriteriaFailureV1) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m32344s(boolean z) {
        copyOnWrite();
        SocialConnectInviteNotificationCriteriaFailureV1.m12858q((SocialConnectInviteNotificationCriteriaFailureV1) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m32345t(String str) {
        copyOnWrite();
        SocialConnectInviteNotificationCriteriaFailureV1.m12859r((SocialConnectInviteNotificationCriteriaFailureV1) this.instance, str);
    }
