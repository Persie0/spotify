...
import com.spotify.connect.esperanto.proto.ConnectMessages$InstallSpotifyRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class cti extends AbstractC0268g implements sre0 {
    ...
    public final void m33843m(String str) {
        copyOnWrite();
        ConnectMessages$InstallSpotifyRequest.m7339n((ConnectMessages$InstallSpotifyRequest) this.instance, str);
    }
    ...
    public final void m33844q(CommonMessages$LoggingParams commonMessages$LoggingParams) {
        copyOnWrite();
        ConnectMessages$InstallSpotifyRequest.m7340o((ConnectMessages$InstallSpotifyRequest) this.instance, commonMessages$LoggingParams);
    }
