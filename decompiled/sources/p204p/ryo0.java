...
public final class ryo0 extends AbstractC0268g implements sre0 {
    ...
    public final void m76733m(qyo0 qyo0Var) {
        copyOnWrite();
        PlaybackEsperanto$DuckRequest.m17553n((PlaybackEsperanto$DuckRequest) this.instance, qyo0Var);
    }
    ...
    public final void m76734q(int i) {
        copyOnWrite();
        PlaybackEsperanto$DuckRequest.m17554o((PlaybackEsperanto$DuckRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m76735r(double d) {
        copyOnWrite();
        PlaybackEsperanto$DuckRequest.m17555p((PlaybackEsperanto$DuckRequest) this.instance, d);
    }
