...
import com.spotify.marquee.marquee.events.proto.MarqueeUserHoldoutEvent;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes8.dex */
public final class src0 extends AbstractC0268g implements sre0 {
    ...
    public final void m79111m(List list) {
        copyOnWrite();
        MarqueeUserHoldoutEvent.m13414n((MarqueeUserHoldoutEvent) this.instance, list);
    }
    ...
    public final void m79112q(String str) {
        copyOnWrite();
        MarqueeUserHoldoutEvent.m13415o((MarqueeUserHoldoutEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m79113r(String str) {
        copyOnWrite();
        MarqueeUserHoldoutEvent.m13416p((MarqueeUserHoldoutEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m79114s(String str) {
        copyOnWrite();
        MarqueeUserHoldoutEvent.m13417q((MarqueeUserHoldoutEvent) this.instance, str);
    }
