...
public final class u5f extends AbstractC0268g implements sre0 {
    ...
    public final void m82401m(ShowCollectionDecorationPolicy showCollectionDecorationPolicy) {
        copyOnWrite();
        CollectionShowDecorationPolicy.m97525n((CollectionShowDecorationPolicy) this.instance, showCollectionDecorationPolicy);
    }
    ...
    public final void m82402q() {
        copyOnWrite();
        CollectionShowDecorationPolicy.m97526o((CollectionShowDecorationPolicy) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m82403r(ShowPlayedStateDecorationPolicy.Builder builder) {
        copyOnWrite();
        CollectionShowDecorationPolicy.m97527p((CollectionShowDecorationPolicy) this.instance, (ShowPlayedStateDecorationPolicy) builder.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m82404s(ShowDecorationPolicy showDecorationPolicy) {
        copyOnWrite();
        CollectionShowDecorationPolicy.m97528q((CollectionShowDecorationPolicy) this.instance, showDecorationPolicy);
    }
