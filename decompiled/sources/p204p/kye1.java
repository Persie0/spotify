...
public final class kye1 extends AbstractC0268g implements sre0 {
    ...
    public final void m57684m(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        ZeroFrictionFeatureFlagExposureNonAuth.m14906n((ZeroFrictionFeatureFlagExposureNonAuth) this.instance).putAll(linkedHashMap);
    }
    ...
    public final void m57685q(boolean z) {
        copyOnWrite();
        ZeroFrictionFeatureFlagExposureNonAuth.m14907o((ZeroFrictionFeatureFlagExposureNonAuth) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m57686r(String str) {
        copyOnWrite();
        ZeroFrictionFeatureFlagExposureNonAuth.m14908p((ZeroFrictionFeatureFlagExposureNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m57687s(String str) {
        copyOnWrite();
        ZeroFrictionFeatureFlagExposureNonAuth.m14909q((ZeroFrictionFeatureFlagExposureNonAuth) this.instance, str);
    }
