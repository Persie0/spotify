...
public final class yhw extends AbstractC0268g implements sre0 {
    public yhw() {
        super(EsAuthenticateCredentials$OneTimeToken.DEFAULT_INSTANCE);
    }
    ...
    public final void m93695m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$OneTimeToken.m3535n((EsAuthenticateCredentials$OneTimeToken) this.instance, str);
    }
