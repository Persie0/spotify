...
public final class aa1 extends AbstractC0268g implements sre0 {
    ...
    public final void m25174m(ChildAttributes childAttributes) {
        copyOnWrite();
        AddChildRequest.m12109n((AddChildRequest) this.instance, childAttributes);
    }
    ...
    public final void m25175q(String str) {
        copyOnWrite();
        AddChildRequest.m12110o((AddChildRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m25176r(String str) {
        copyOnWrite();
        AddChildRequest.m12111p((AddChildRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m25177s(ChildProfile childProfile) {
        copyOnWrite();
        AddChildRequest.m12112q((AddChildRequest) this.instance, childProfile);
    }
