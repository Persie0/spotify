...
public final class n501 extends AbstractC0268g implements sre0 {
    ...
    public final void m63696m(ManagedAccountIdentifier managedAccountIdentifier) {
        copyOnWrite();
        SetManagedAccountSettingsRequest.m12512n((SetManagedAccountSettingsRequest) this.instance, managedAccountIdentifier);
    }
    ...
    public final void m63697q(AccountControls accountControls) {
        copyOnWrite();
        SetManagedAccountSettingsRequest.m12513o((SetManagedAccountSettingsRequest) this.instance, accountControls);
    }
