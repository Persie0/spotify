...
public final class l6f extends AbstractC0268g implements sre0 {
    ...
    public final void m58335m(String str) {
        copyOnWrite();
        Color.m20972n((Color) this.instance, str);
    }
    ...
    public final void m58336q(String str) {
        copyOnWrite();
        Color.m20973o((Color) this.instance, str);
    }
