...
public final class s2p0 extends AbstractC0268g implements sre0 {
    ...
    public final void m77094m(boolean z) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$FieldValue.m17575n((PlaybackSettingsEsperantoService$FieldValue) this.instance, z);
    }
    ...
    public final void m77095q(int i) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$FieldValue.m17576o((PlaybackSettingsEsperantoService$FieldValue) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m77096r(String str) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$FieldValue.m17577p((PlaybackSettingsEsperantoService$FieldValue) this.instance, str);
    }
