...
public final class v0b extends AbstractC0268g implements sre0 {
    ...
    public final void m84370m(String str) {
        copyOnWrite();
        CPGpbCheckoutError.m11197n((CPGpbCheckoutError) this.instance, str);
    }
    ...
    public final void m84371q(String str) {
        copyOnWrite();
        CPGpbCheckoutError.m11198o((CPGpbCheckoutError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84372r(String str) {
        copyOnWrite();
        CPGpbCheckoutError.m11199p((CPGpbCheckoutError) this.instance, str);
    }
