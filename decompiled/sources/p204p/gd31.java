...
import com.spotify.libs.sociallistening.events.proto.SocialConnectSessionAskToJoinResult;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes7.dex */
public final class gd31 extends AbstractC0268g implements sre0 {
    ...
    public final void m44334m(ArrayList arrayList) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12871n((SocialConnectSessionAskToJoinResult) this.instance, arrayList);
    }
    ...
    public final void m44335q(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12872o((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m44336r(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12873p((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m44337s(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12874q((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m44338t(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12875r((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m44339u(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12876s((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m44340v(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12877t((SocialConnectSessionAskToJoinResult) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m44341w(String str) {
        copyOnWrite();
        SocialConnectSessionAskToJoinResult.m12878u((SocialConnectSessionAskToJoinResult) this.instance, str);
    }
