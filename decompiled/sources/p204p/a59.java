...
public final class a59 extends AbstractC0268g implements sre0 {
    ...
    public final void m24776m(pj11 pj11Var) {
        copyOnWrite();
        BatchShouldUpsellRequestItem.m22044n((BatchShouldUpsellRequestItem) this.instance, (ShouldUpsellRequest) pj11Var.build());
    }
    ...
    public final void m24777q(String str) {
        copyOnWrite();
        BatchShouldUpsellRequestItem.m22045o((BatchShouldUpsellRequestItem) this.instance, str);
    }
