...
import com.spotify.checkout.spotifycheckout.events.proto.AddressCollectionView;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class kw1 extends AbstractC0268g implements sre0 {
    ...
    public final void m57493m(String str) {
        copyOnWrite();
        AddressCollectionView.m6730n((AddressCollectionView) this.instance, str);
    }
    ...
    public final void m57494q(String str) {
        copyOnWrite();
        AddressCollectionView.m6731o((AddressCollectionView) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m57495r(String str) {
        copyOnWrite();
        AddressCollectionView.m6732p((AddressCollectionView) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m57496s(String str) {
        copyOnWrite();
        AddressCollectionView.m6733q((AddressCollectionView) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m57497t(String str) {
        copyOnWrite();
        AddressCollectionView.m6734r((AddressCollectionView) this.instance, str);
    }
