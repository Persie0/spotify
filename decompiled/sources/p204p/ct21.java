...
import com.spotify.home.slotloading.events.proto.SlotContentLoadingEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class ct21 extends AbstractC0268g implements sre0 {
    ...
    public final void m33819m(boolean z) {
        copyOnWrite();
        SlotContentLoadingEvent.m11828n((SlotContentLoadingEvent) this.instance, z);
    }
    ...
    public final void m33820q(String str) {
        copyOnWrite();
        SlotContentLoadingEvent.m11829o((SlotContentLoadingEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m33821r(boolean z) {
        copyOnWrite();
        SlotContentLoadingEvent.m11830p((SlotContentLoadingEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m33822s(String str) {
        copyOnWrite();
        SlotContentLoadingEvent.m11831q((SlotContentLoadingEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m33823t(String str) {
        copyOnWrite();
        SlotContentLoadingEvent.m11832r((SlotContentLoadingEvent) this.instance, str);
    }
