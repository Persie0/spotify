...
public final class njw extends AbstractC0268g implements sre0 {
    ...
    public final void m64639m(Map map) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17684n((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance).putAll(map);
    }
    ...
    public final void m64640q(String str, String str2) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17684n((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance).put(str, str2);
    }

    /* JADX INFO: renamed from: r */
    public final void m64641r(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17685o((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance, esOptional$OptionalBoolean);
    }

    /* JADX INFO: renamed from: s */
    public final void m64642s(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17686p((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance, esOptional$OptionalBoolean);
    }

    /* JADX INFO: renamed from: t */
    public final void m64643t(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17687q((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance, esOptional$OptionalBoolean);
    }

    /* JADX INFO: renamed from: u */
    public final void m64644u(tmw tmwVar) {
        copyOnWrite();
        EsContextPlayerOptions$ContextPlayerOptionOverrides.m17687q((EsContextPlayerOptions$ContextPlayerOptionOverrides) this.instance, (EsOptional$OptionalBoolean) tmwVar.build());
    }
