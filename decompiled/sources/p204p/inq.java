...
public final class inq extends AbstractC0268g implements sre0 {
    public inq() {
    ...
    public final void m51139m(String str) {
        copyOnWrite();
        DeleteCommentRequest.m22164n((DeleteCommentRequest) this.instance, str);
    }
