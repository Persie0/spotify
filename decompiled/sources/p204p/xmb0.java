...
import com.spotify.lyrics.sharecard.events.proto.LyricsSharingV3;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes8.dex */
public final class xmb0 extends AbstractC0268g implements sre0 {
    ...
    public final void m91450m(Map map) {
        copyOnWrite();
        LyricsSharingV3.m13376n((LyricsSharingV3) this.instance).putAll(map);
    }
    ...
    public final void m91451q(String str) {
        copyOnWrite();
        LyricsSharingV3.m13377o((LyricsSharingV3) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m91452r() {
        copyOnWrite();
        LyricsSharingV3.m13378p((LyricsSharingV3) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m91453s(String str) {
        copyOnWrite();
        LyricsSharingV3.m13379q((LyricsSharingV3) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m91454t(String str) {
        copyOnWrite();
        LyricsSharingV3.m13380r((LyricsSharingV3) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m91455u(String str) {
        copyOnWrite();
        LyricsSharingV3.m13381s((LyricsSharingV3) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m91456v(String str) {
        copyOnWrite();
        LyricsSharingV3.m13382t((LyricsSharingV3) this.instance, str);
    }
