...
public final class zos0 extends AbstractC0268g implements sre0 {
    ...
    public final void m96632m(Iterable iterable) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19928n((PromptedContentFeedbackEvent) this.instance, iterable);
    }
    ...
    public final void m96633q(int i) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19929o((PromptedContentFeedbackEvent) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m96634r(String str) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19930p((PromptedContentFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m96635s(boolean z) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19931q((PromptedContentFeedbackEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m96636t(String str) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19932r((PromptedContentFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m96637u(String str) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19933s((PromptedContentFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m96638v(String str) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19934t((PromptedContentFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m96639w(String str) {
        copyOnWrite();
        PromptedContentFeedbackEvent.m19935u((PromptedContentFeedbackEvent) this.instance, str);
    }
