...
public final class b5l extends AbstractC0268g implements sre0 {
    public b5l() {
        super(CreateChildLoginTokenRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m28171m(String str) {
        copyOnWrite();
        CreateChildLoginTokenRequest.m12073n((CreateChildLoginTokenRequest) this.instance, str);
    }
