...
public final class bhk0 extends AbstractC0268g implements sre0 {
    ...
    public final void m29250m(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23122n((NpvRecommendationsWidgetViewBound) this.instance, str);
    }
    ...
    public final void m29251q(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23123o((NpvRecommendationsWidgetViewBound) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m29252r(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23124p((NpvRecommendationsWidgetViewBound) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m29253s(int i) {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23125q((NpvRecommendationsWidgetViewBound) this.instance, i);
    }

    /* JADX INFO: renamed from: t */
    public final void m29254t() {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23126r((NpvRecommendationsWidgetViewBound) this.instance);
    }

    /* JADX INFO: renamed from: u */
    public final void m29255u(int i) {
        copyOnWrite();
        NpvRecommendationsWidgetViewBound.m23127s((NpvRecommendationsWidgetViewBound) this.instance, i);
    }
