...
public final class shw extends AbstractC0268g implements sre0 {
    public shw() {
        super(EsAuthenticateCredentials$EmailAddress.DEFAULT_INSTANCE);
    }
    ...
    public final void m78142m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$EmailAddress.m3512n((EsAuthenticateCredentials$EmailAddress) this.instance, str);
    }
