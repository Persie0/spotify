...
public final class hea1 extends AbstractC0268g implements sre0 {
    ...
    public final void m47297m(String str) {
        copyOnWrite();
        UploadBackground.m20982n((UploadBackground) this.instance, str);
    }
    ...
    public final void m47298q(Color color) {
        copyOnWrite();
        UploadBackground.m20983o((UploadBackground) this.instance, color);
    }

    /* JADX INFO: renamed from: r */
    public final void m47299r(UploadImage uploadImage) {
        copyOnWrite();
        UploadBackground.m20984p((UploadBackground) this.instance, uploadImage);
    }

    /* JADX INFO: renamed from: s */
    public final void m47300s(Video video) {
        copyOnWrite();
        UploadBackground.m20985q((UploadBackground) this.instance, video);
    }
