...
public final class eea1 extends AbstractC0268g implements sre0 {
    ...
    public final void m38648m(String str) {
        copyOnWrite();
        UploadAttachmentRequest.m17535n((UploadAttachmentRequest) this.instance, str);
    }
    ...
    public final void m38649q(long j) {
        copyOnWrite();
        UploadAttachmentRequest.m17536o((UploadAttachmentRequest) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m38650r(ImageAttachmentMetadata imageAttachmentMetadata) {
        copyOnWrite();
        UploadAttachmentRequest.m17537p((UploadAttachmentRequest) this.instance, imageAttachmentMetadata);
    }

    /* JADX INFO: renamed from: s */
    public final void m38651s(dhn0 dhn0Var) {
        copyOnWrite();
        UploadAttachmentRequest.m17538q((UploadAttachmentRequest) this.instance, (PdfAttachmentMetadata) dhn0Var.build());
    }
