...
public final class wow extends AbstractC0268g implements sre0 {
    ...
    public final void m88667m(boolean z) {
        copyOnWrite();
        EsSkipPrev$SkipPrevRequest.m17998n((EsSkipPrev$SkipPrevRequest) this.instance, z);
    }
    ...
    public final void m88668q(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSkipPrev$SkipPrevRequest.m17999o((EsSkipPrev$SkipPrevRequest) this.instance, esLoggingParams$LoggingParams);
    }

    /* JADX INFO: renamed from: r */
    public final void m88669r(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSkipPrev$SkipPrevRequest.m18000p((EsSkipPrev$SkipPrevRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: s */
    public final void m88670s(EsContextTrack$ContextTrack esContextTrack$ContextTrack) {
        copyOnWrite();
        EsSkipPrev$SkipPrevRequest.m18001q((EsSkipPrev$SkipPrevRequest) this.instance, esContextTrack$ContextTrack);
    }
