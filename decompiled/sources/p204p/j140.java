...
public final class j140 extends AbstractC0268g implements sre0 {
    public j140() {
        super(Identity$SocialHandleRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m52111m(String str) {
        copyOnWrite();
        Identity$SocialHandleRequest.m11937n(str, (Identity$SocialHandleRequest) this.instance);
    }
