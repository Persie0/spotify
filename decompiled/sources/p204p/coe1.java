...
public final class coe1 extends AbstractC0268g implements sre0 {
    ...
    public final void m33501m(String str) {
        copyOnWrite();
        YourLibraryConfig$YourLibraryLabelAndImage.m98216n((YourLibraryConfig$YourLibraryLabelAndImage) this.instance, str);
    }
    ...
    public final void m33502q(boolean z) {
        copyOnWrite();
        YourLibraryConfig$YourLibraryLabelAndImage.m98217o((YourLibraryConfig$YourLibraryLabelAndImage) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m33503r(String str) {
        copyOnWrite();
        YourLibraryConfig$YourLibraryLabelAndImage.m98218p((YourLibraryConfig$YourLibraryLabelAndImage) this.instance, str);
    }
