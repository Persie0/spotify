...
import com.spotify.showcase.showcase.events.proto.NativeAdsFreeUserSinglePromo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class vvi0 extends AbstractC0268g implements sre0 {
    ...
    public final void m86477m(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m21270n((NativeAdsFreeUserSinglePromo) this.instance, str);
    }
    ...
    public final void m86478q(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m21271o((NativeAdsFreeUserSinglePromo) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m86479r(String str) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m21272p((NativeAdsFreeUserSinglePromo) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m86480s(boolean z) {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m21273q((NativeAdsFreeUserSinglePromo) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m86481t() {
        copyOnWrite();
        NativeAdsFreeUserSinglePromo.m21274r((NativeAdsFreeUserSinglePromo) this.instance);
    }
