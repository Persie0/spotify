...
public final class mo50 extends AbstractC0268g implements sre0 {
    ...
    public final void m62387m(Iterable iterable) {
        copyOnWrite();
        IsCuratedRequest.m98121n((IsCuratedRequest) this.instance, iterable);
    }
    ...
    public final void m62388q(String str) {
        copyOnWrite();
        IsCuratedRequest.m98122o((IsCuratedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m62389r(String str) {
        copyOnWrite();
        IsCuratedRequest.m98123p((IsCuratedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m62390s(no50 no50Var) {
        copyOnWrite();
        IsCuratedRequest.m98124q((IsCuratedRequest) this.instance, no50Var);
    }
