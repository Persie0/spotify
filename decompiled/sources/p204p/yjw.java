...
public final class yjw extends AbstractC0268g implements sre0 {
    public yjw() {
    ...
    public final void m93939m(xf40 xf40Var) {
        copyOnWrite();
        EsContextTrack$ContextTrack.m17748n((EsContextTrack$ContextTrack) this.instance).putAll(xf40Var);
    }
    ...
    public final void m93940q(String str) {
        copyOnWrite();
        EsContextTrack$ContextTrack.m17749o((EsContextTrack$ContextTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m93941r(String str) {
        copyOnWrite();
        EsContextTrack$ContextTrack.m17750p((EsContextTrack$ContextTrack) this.instance, str);
    }
