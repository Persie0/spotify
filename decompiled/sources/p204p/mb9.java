...
import com.spotify.messages.BetamaxTranscoderSessionItem;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes8.dex */
public final class mb9 extends AbstractC0268g implements sre0 {
    ...
    public final void m61352m(ArrayList arrayList) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13702n((BetamaxTranscoderSessionItem) this.instance, arrayList);
    }
    ...
    public final void m61353q(long j) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13703o((BetamaxTranscoderSessionItem) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m61354r(long j) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13704p((BetamaxTranscoderSessionItem) this.instance, j);
    }

    /* JADX INFO: renamed from: s */
    public final void m61355s(boolean z) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13705q((BetamaxTranscoderSessionItem) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m61356t(int i) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13706r((BetamaxTranscoderSessionItem) this.instance, i);
    }

    /* JADX INFO: renamed from: u */
    public final void m61357u() {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13707s((BetamaxTranscoderSessionItem) this.instance);
    }

    /* JADX INFO: renamed from: v */
    public final void m61358v(String str) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13708t((BetamaxTranscoderSessionItem) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m61359w(String str) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13709u((BetamaxTranscoderSessionItem) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m61360x(String str) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13710v((BetamaxTranscoderSessionItem) this.instance, str);
    }

    /* JADX INFO: renamed from: y */
    public final void m61361y(String str) {
        copyOnWrite();
        BetamaxTranscoderSessionItem.m13711w((BetamaxTranscoderSessionItem) this.instance, str);
    }
