...
public final class hge1 extends AbstractC0268g implements sre0 {
    ...
    public final void m47444m(String str) {
        copyOnWrite();
        XrGlassesOnboardingEligibility.m23235n((XrGlassesOnboardingEligibility) this.instance, str);
    }
    ...
    public final void m47445q(String str) {
        copyOnWrite();
        XrGlassesOnboardingEligibility.m23236o((XrGlassesOnboardingEligibility) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m47446r(String str) {
        copyOnWrite();
        XrGlassesOnboardingEligibility.m23237p((XrGlassesOnboardingEligibility) this.instance, str);
    }
