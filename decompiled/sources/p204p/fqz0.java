...
public final class fqz0 extends AbstractC0268g implements sre0 {
    ...
    public final void m42447m(Map map) {
        copyOnWrite();
        SendClientActionRequest.m6769n((SendClientActionRequest) this.instance).putAll(map);
    }
    ...
    public final void m42448q(String str) {
        copyOnWrite();
        SendClientActionRequest.m6770o((SendClientActionRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m42449r(boolean z) {
        copyOnWrite();
        SendClientActionRequest.m6771p((SendClientActionRequest) this.instance, z);
    }
