...
import com.spotify.listplatform.sortingimpl.ListSortingProto$StoredProvidedSortOrder;
import com.spotify.listplatform.sortingimpl.ListSortingProto$UserSortOrders;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class z490 extends AbstractC0268g implements sre0 {
    ...
    public final void m95322m(ListSortingProto$StoredProvidedSortOrder listSortingProto$StoredProvidedSortOrder, String str) {
        str.getClass();
        copyOnWrite();
        ListSortingProto$UserSortOrders.m13022n((ListSortingProto$UserSortOrders) this.instance).put(str, listSortingProto$StoredProvidedSortOrder);
    }
    ...
    public final void m95323q(String str, String str2) {
        str.getClass();
        str2.getClass();
        copyOnWrite();
        ListSortingProto$UserSortOrders.m13023o((ListSortingProto$UserSortOrders) this.instance).put(str, str2);
    }

    /* JADX INFO: renamed from: r */
    public final void m95324r(String str) {
        str.getClass();
        copyOnWrite();
        ListSortingProto$UserSortOrders.m13022n((ListSortingProto$UserSortOrders) this.instance).remove(str);
    }

    /* JADX INFO: renamed from: s */
    public final void m95325s(String str) {
        str.getClass();
        copyOnWrite();
        ListSortingProto$UserSortOrders.m13023o((ListSortingProto$UserSortOrders) this.instance).remove(str);
    }
