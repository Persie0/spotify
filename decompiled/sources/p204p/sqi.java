...
import com.spotify.decipher.agent.p057v1.ConnectDevice;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class sqi extends AbstractC0268g implements sre0 {
    ...
    public final void m78954m(String str) {
        copyOnWrite();
        ConnectDevice.m9137n((ConnectDevice) this.instance, str);
    }
    ...
    public final void m78955q(boolean z) {
        copyOnWrite();
        ConnectDevice.m9138o((ConnectDevice) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m78956r(String str) {
        copyOnWrite();
        ConnectDevice.m9139p((ConnectDevice) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m78957s(zfr zfrVar) {
        copyOnWrite();
        ConnectDevice.m9140q((ConnectDevice) this.instance, zfrVar);
    }
