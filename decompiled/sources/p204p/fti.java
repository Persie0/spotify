...
import com.spotify.connect.esperanto.proto.ConnectMessages$NotifyAudioRouteChangedRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes.dex */
public final class fti extends AbstractC0268g implements sre0 {
    ...
    public final void m42667m(String str) {
        copyOnWrite();
        ConnectMessages$NotifyAudioRouteChangedRequest.m7346n((ConnectMessages$NotifyAudioRouteChangedRequest) this.instance, str);
    }
    ...
    public final void m42668q(gti gtiVar) {
        copyOnWrite();
        ConnectMessages$NotifyAudioRouteChangedRequest.m7347o((ConnectMessages$NotifyAudioRouteChangedRequest) this.instance, gtiVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m42669r(hti htiVar) {
        copyOnWrite();
        ConnectMessages$NotifyAudioRouteChangedRequest.m7348p((ConnectMessages$NotifyAudioRouteChangedRequest) this.instance, htiVar);
    }

    /* JADX INFO: renamed from: s */
    public final void m42670s(String str) {
        copyOnWrite();
        ConnectMessages$NotifyAudioRouteChangedRequest.m7349q((ConnectMessages$NotifyAudioRouteChangedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m42671t(String str) {
        copyOnWrite();
        ConnectMessages$NotifyAudioRouteChangedRequest.m7350r((ConnectMessages$NotifyAudioRouteChangedRequest) this.instance, str);
    }
