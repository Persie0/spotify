...
public final class dnw extends AbstractC0268g implements sre0 {
    public dnw() {
    ...
    public final void m36491m(ef40 ef40Var) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17805n((EsPlayOrigin$PlayOrigin) this.instance, ef40Var);
    }
    ...
    public final void m36492q(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17806o((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m36493r(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17807p((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m36494s(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17808q((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m36495t(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17809r((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m36496u(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17810s((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m36497v(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17811t((EsPlayOrigin$PlayOrigin) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m36498w(String str) {
        copyOnWrite();
        EsPlayOrigin$PlayOrigin.m17812u((EsPlayOrigin$PlayOrigin) this.instance, str);
    }
