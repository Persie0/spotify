...
import com.spotify.passkeys.p122v1.IdentityAssertionOptions;
import com.spotify.passkeys.p122v1.Signals;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class r9z extends AbstractC0268g implements sre0 {
    public r9z() {
        super(FinishAuthenticationRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m75090m(cva cvaVar) {
        copyOnWrite();
        FinishAuthenticationRequest.m16640n((FinishAuthenticationRequest) this.instance, cvaVar);
    }
    ...
    public final void m75091q(cva cvaVar) {
        copyOnWrite();
        FinishAuthenticationRequest.m16641o((FinishAuthenticationRequest) this.instance, cvaVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m75092r(cva cvaVar) {
        copyOnWrite();
        FinishAuthenticationRequest.m16642p((FinishAuthenticationRequest) this.instance, cvaVar);
    }

    /* JADX INFO: renamed from: s */
    public final void m75093s(o140 o140Var) {
        copyOnWrite();
        FinishAuthenticationRequest.m16643q((FinishAuthenticationRequest) this.instance, (IdentityAssertionOptions) o140Var.build());
    }

    /* JADX INFO: renamed from: t */
    public final void m75094t(String str) {
        copyOnWrite();
        FinishAuthenticationRequest.m16644r((FinishAuthenticationRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m75095u(Signals signals) {
        copyOnWrite();
        FinishAuthenticationRequest.m16645s((FinishAuthenticationRequest) this.instance, signals);
    }

    /* JADX INFO: renamed from: v */
    public final void m75096v(cva cvaVar) {
        copyOnWrite();
        FinishAuthenticationRequest.m16646t((FinishAuthenticationRequest) this.instance, cvaVar);
    }

    /* JADX INFO: renamed from: w */
    public final void m75097w(cva cvaVar) {
        copyOnWrite();
        FinishAuthenticationRequest.m16647u((FinishAuthenticationRequest) this.instance, cvaVar);
    }
