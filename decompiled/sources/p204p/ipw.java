...
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficConnectionMetrics$ConnectionMetrics;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficEvents$FinishedEvent;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficRequestInfo$RequestInfo;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficResponseInfo$ResponseInfo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes.dex */
public final class ipw extends AbstractC0268g implements sre0 {
    ...
    public final void m51282m(EsTrafficConnectionMetrics$ConnectionMetrics esTrafficConnectionMetrics$ConnectionMetrics) {
        copyOnWrite();
        EsTrafficEvents$FinishedEvent.m7632n((EsTrafficEvents$FinishedEvent) this.instance, esTrafficConnectionMetrics$ConnectionMetrics);
    }
    ...
    public final void m51283q(EsTrafficRequestInfo$RequestInfo esTrafficRequestInfo$RequestInfo) {
        copyOnWrite();
        EsTrafficEvents$FinishedEvent.m7633o((EsTrafficEvents$FinishedEvent) this.instance, esTrafficRequestInfo$RequestInfo);
    }

    /* JADX INFO: renamed from: r */
    public final void m51284r(EsTrafficResponseInfo$ResponseInfo esTrafficResponseInfo$ResponseInfo) {
        copyOnWrite();
        EsTrafficEvents$FinishedEvent.m7634p((EsTrafficEvents$FinishedEvent) this.instance, esTrafficResponseInfo$ResponseInfo);
    }
