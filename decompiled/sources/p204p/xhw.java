...
public final class xhw extends AbstractC0268g implements sre0 {
    public xhw() {
        super(EsAuthenticateCredentials$NaverSignInCredentials.DEFAULT_INSTANCE);
    }
    ...
    public final void m91066m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$NaverSignInCredentials.m3531n((EsAuthenticateCredentials$NaverSignInCredentials) this.instance, str);
    }
    ...
    public final void m91067q(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$NaverSignInCredentials.m3532o((EsAuthenticateCredentials$NaverSignInCredentials) this.instance, str);
    }
