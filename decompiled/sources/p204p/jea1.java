...
public final class jea1 extends AbstractC0268g implements sre0 {
    ...
    public final void m53086m(UploadBackground uploadBackground) {
        copyOnWrite();
        UploadChatPreviewRequest.m20987n((UploadChatPreviewRequest) this.instance, uploadBackground);
    }
    ...
    public final void m53087q(String str) {
        copyOnWrite();
        UploadChatPreviewRequest.m20988o((UploadChatPreviewRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m53088r(ShareFormat shareFormat) {
        copyOnWrite();
        UploadChatPreviewRequest.m20989p((UploadChatPreviewRequest) this.instance, shareFormat);
    }

    /* JADX INFO: renamed from: s */
    public final void m53089s(UploadImage uploadImage) {
        copyOnWrite();
        UploadChatPreviewRequest.m20990q((UploadChatPreviewRequest) this.instance, uploadImage);
    }
