...
import com.spotify.messages.AccountSwitchingRemoveAccountNonAuth;
import java.io.InputStream;

/* JADX INFO: renamed from: p.uv */
/* JADX INFO: loaded from: classes18.dex */
public final class C2472uv extends AbstractC0268g implements sre0 {
    ...
    public final void m84043m(String str) {
        copyOnWrite();
        AccountSwitchingRemoveAccountNonAuth.m13504n((AccountSwitchingRemoveAccountNonAuth) this.instance, str);
    }
    ...
    public final void m84044q(String str) {
        copyOnWrite();
        AccountSwitchingRemoveAccountNonAuth.m13505o((AccountSwitchingRemoveAccountNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84045r(String str) {
        copyOnWrite();
        AccountSwitchingRemoveAccountNonAuth.m13506p((AccountSwitchingRemoveAccountNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m84046s(int i) {
        copyOnWrite();
        AccountSwitchingRemoveAccountNonAuth.m13507q((AccountSwitchingRemoveAccountNonAuth) this.instance, i);
    }
