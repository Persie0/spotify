...
public final class gle extends AbstractC0268g implements sre0 {
    ...
    public final void m45127m(String str) {
        copyOnWrite();
        ClientMessagingPlatformRequestErrorEvent.m15292n((ClientMessagingPlatformRequestErrorEvent) this.instance, str);
    }
    ...
    public final void m45128q(String str) {
        copyOnWrite();
        ClientMessagingPlatformRequestErrorEvent.m15293o((ClientMessagingPlatformRequestErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m45129r(String str) {
        copyOnWrite();
        ClientMessagingPlatformRequestErrorEvent.m15294p((ClientMessagingPlatformRequestErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m45130s(String str) {
        copyOnWrite();
        ClientMessagingPlatformRequestErrorEvent.m15295q((ClientMessagingPlatformRequestErrorEvent) this.instance, str);
    }
