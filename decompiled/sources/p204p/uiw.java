...
import com.spotify.authentication.login5esperanto.EsCodeRequired$CodeRequiredProceedRequest;
import com.spotify.authentication.login5esperanto.EsRecaptchaInfo$RecaptchaInfo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class uiw extends AbstractC0268g implements sre0 {
    ...
    public final void m83208m(String str) {
        copyOnWrite();
        EsCodeRequired$CodeRequiredProceedRequest.m3608n((EsCodeRequired$CodeRequiredProceedRequest) this.instance, str);
    }
    ...
    public final void m83209q(EsAuthenticateContext$AuthenticateContext esAuthenticateContext$AuthenticateContext) {
        copyOnWrite();
        EsCodeRequired$CodeRequiredProceedRequest.m3609o((EsCodeRequired$CodeRequiredProceedRequest) this.instance, esAuthenticateContext$AuthenticateContext);
    }

    /* JADX INFO: renamed from: r */
    public final void m83210r(EsRecaptchaInfo$RecaptchaInfo esRecaptchaInfo$RecaptchaInfo) {
        copyOnWrite();
        EsCodeRequired$CodeRequiredProceedRequest.m3610p((EsCodeRequired$CodeRequiredProceedRequest) this.instance, esRecaptchaInfo$RecaptchaInfo);
    }
