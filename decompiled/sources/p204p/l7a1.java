...
public final class l7a1 extends AbstractC0268g implements sre0 {
    ...
    public final void m58412m(ChildBanStatus childBanStatus) {
        copyOnWrite();
        UpdateBanStatusRequest.m12180n((UpdateBanStatusRequest) this.instance, childBanStatus);
    }
    ...
    public final void m58413q(h3e h3eVar) {
        copyOnWrite();
        UpdateBanStatusRequest.m12180n((UpdateBanStatusRequest) this.instance, (ChildBanStatus) h3eVar.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m58414r(String str) {
        copyOnWrite();
        UpdateBanStatusRequest.m12181o((UpdateBanStatusRequest) this.instance, str);
    }
