...
public final class o991 extends AbstractC0268g implements sre0 {
    ...
    public final void m66455m(boolean z) {
        copyOnWrite();
        TransitionOuterClass$Transition.m3948n((TransitionOuterClass$Transition) this.instance, z);
    }
    ...
    public final void m66456q(boolean z) {
        copyOnWrite();
        TransitionOuterClass$Transition.m3949o((TransitionOuterClass$Transition) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m66457r(TransitionOuterClass$Overlap transitionOuterClass$Overlap) {
        copyOnWrite();
        TransitionOuterClass$Transition.m3950p((TransitionOuterClass$Transition) this.instance, transitionOuterClass$Overlap);
    }

    /* JADX INFO: renamed from: s */
    public final void m66458s(TransitionOuterClass$Preset transitionOuterClass$Preset) {
        copyOnWrite();
        TransitionOuterClass$Transition.m3951q((TransitionOuterClass$Transition) this.instance, transitionOuterClass$Preset);
    }
