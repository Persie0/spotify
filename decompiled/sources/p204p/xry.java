...
import com.spotify.pendragon.p123v1.proto.FetchMessageRequest;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes2.dex */
public final class xry extends AbstractC0268g implements sre0 {
    ...
    public final void m91952m(List list) {
        copyOnWrite();
        FetchMessageRequest.m17165n((FetchMessageRequest) this.instance, list);
    }
    ...
    public final void m91953q(String str) {
        copyOnWrite();
        FetchMessageRequest.m17166o((FetchMessageRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m91954r() {
        copyOnWrite();
        FetchMessageRequest.m17167p((FetchMessageRequest) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m91955s(String str) {
        copyOnWrite();
        FetchMessageRequest.m17168q((FetchMessageRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m91956t(boolean z) {
        copyOnWrite();
        FetchMessageRequest.m17169r((FetchMessageRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: u */
    public final void m91957u(qk91 qk91Var) {
        copyOnWrite();
        FetchMessageRequest.m17170s((FetchMessageRequest) this.instance, qk91Var);
    }

    /* JADX INFO: renamed from: v */
    public final void m91958v(String str) {
        copyOnWrite();
        FetchMessageRequest.m17171t((FetchMessageRequest) this.instance, str);
    }
