...
import com.spotify.payment.paymentimpl.events.proto.CheckoutPaymentAttemptJS;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class tzd extends AbstractC0268g implements sre0 {
    ...
    public final void m82060m(String str) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16931n((CheckoutPaymentAttemptJS) this.instance, str);
    }
    ...
    public final void m82061q() {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16932o((CheckoutPaymentAttemptJS) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m82062r(String str) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16933p((CheckoutPaymentAttemptJS) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m82063s(String str) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16934q((CheckoutPaymentAttemptJS) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m82064t(String str) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16935r((CheckoutPaymentAttemptJS) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m82065u(boolean z) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16936s((CheckoutPaymentAttemptJS) this.instance, z);
    }

    /* JADX INFO: renamed from: v */
    public final void m82066v(String str) {
        copyOnWrite();
        CheckoutPaymentAttemptJS.m16937t((CheckoutPaymentAttemptJS) this.instance, str);
    }
