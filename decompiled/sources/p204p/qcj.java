...
public final class qcj extends AbstractC0268g implements sre0 {
    ...
    public final void m72555m(List list) {
        copyOnWrite();
        ContainsRelationsResponse$ContainRelationsUsernameRequest.m19835n((ContainsRelationsResponse$ContainRelationsUsernameRequest) this.instance, list);
    }
    ...
    public final void m72556q() {
        copyOnWrite();
        ContainsRelationsResponse$ContainRelationsUsernameRequest.m19836o((ContainsRelationsResponse$ContainRelationsUsernameRequest) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m72557r(String str) {
        copyOnWrite();
        ContainsRelationsResponse$ContainRelationsUsernameRequest.m19837p((ContainsRelationsResponse$ContainRelationsUsernameRequest) this.instance, str);
    }
