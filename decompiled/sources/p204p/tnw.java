...
public final class tnw extends AbstractC0268g implements sre0 {
    ...
    public final void m81186m(EsNotReachable$LegacyNotReachable esNotReachable$LegacyNotReachable) {
        copyOnWrite();
        EsReachability$LegacyReachability.m7580n((EsReachability$LegacyReachability) this.instance, esNotReachable$LegacyNotReachable);
    }
    ...
    public final void m81187q(wnw wnwVar) {
        copyOnWrite();
        EsReachability$LegacyReachability.m7581o((EsReachability$LegacyReachability) this.instance, (EsReachable$LegacyReachable) wnwVar.build());
    }
