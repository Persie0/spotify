...
public final class ros0 extends AbstractC0268g implements sre0 {
    ...
    public final void m76077m(boolean z) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98011n((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, z);
    }
    ...
    public final void m76078q(String str) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98012o((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m76079r(boolean z) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98013p((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m76080s(String str) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98014q((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m76081t(Promptableplaylist$RefreshMetadata promptableplaylist$RefreshMetadata) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98015r((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, promptableplaylist$RefreshMetadata);
    }

    /* JADX INFO: renamed from: u */
    public final void m76082u(String str) {
        copyOnWrite();
        Promptableplaylist$CreatePromptablePlaylistRequest.m98016s((Promptableplaylist$CreatePromptablePlaylistRequest) this.instance, str);
    }
