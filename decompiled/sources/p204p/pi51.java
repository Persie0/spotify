...
public final class pi51 extends AbstractC0268g implements sre0 {
    ...
    public final void m70070m(String str) {
        copyOnWrite();
        StreamReportingAttributionOuterClass$StreamReportingAttribution.m21613n((StreamReportingAttributionOuterClass$StreamReportingAttribution) this.instance, str);
    }
    ...
    public final void m70071q(String str) {
        copyOnWrite();
        StreamReportingAttributionOuterClass$StreamReportingAttribution.m21614o((StreamReportingAttributionOuterClass$StreamReportingAttribution) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m70072r(String str) {
        copyOnWrite();
        StreamReportingAttributionOuterClass$StreamReportingAttribution.m21615p((StreamReportingAttributionOuterClass$StreamReportingAttribution) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m70073s(String str) {
        copyOnWrite();
        StreamReportingAttributionOuterClass$StreamReportingAttribution.m21616q((StreamReportingAttributionOuterClass$StreamReportingAttribution) this.instance, str);
    }
