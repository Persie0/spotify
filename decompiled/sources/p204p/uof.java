...
public final class uof extends AbstractC0268g implements sre0 {
    ...
    public final void m83616m(long j) {
        copyOnWrite();
        CommonCappingOuterClass$ReportConsumptionRequest.m6913n((CommonCappingOuterClass$ReportConsumptionRequest) this.instance, j);
    }
    ...
    public final void m83617q(String str) {
        copyOnWrite();
        CommonCappingOuterClass$ReportConsumptionRequest.m6914o((CommonCappingOuterClass$ReportConsumptionRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m83618r(String str) {
        copyOnWrite();
        CommonCappingOuterClass$ReportConsumptionRequest.m6915p((CommonCappingOuterClass$ReportConsumptionRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m83619s(nof nofVar) {
        copyOnWrite();
        CommonCappingOuterClass$ReportConsumptionRequest.m6916q((CommonCappingOuterClass$ReportConsumptionRequest) this.instance, nofVar);
    }
