...
import com.spotify.agentgateway.p016v1.UserMessage;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes4.dex */
public final class prz0 extends AbstractC0268g implements sre0 {
    public prz0() {
        super(SendMessageWithImageRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m70743m(ArrayList arrayList) {
        copyOnWrite();
        SendMessageWithImageRequest.m2977n((SendMessageWithImageRequest) this.instance, arrayList);
    }
    ...
    public final void m70744q(ArrayList arrayList) {
        copyOnWrite();
        SendMessageWithImageRequest.m2978o((SendMessageWithImageRequest) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m70745r(String str) {
        copyOnWrite();
        SendMessageWithImageRequest.m2979p((SendMessageWithImageRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m70746s(String str) {
        copyOnWrite();
        SendMessageWithImageRequest.m2980q((SendMessageWithImageRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m70747t(UserMessage userMessage) {
        copyOnWrite();
        SendMessageWithImageRequest.m2981r((SendMessageWithImageRequest) this.instance, userMessage);
    }

    /* JADX INFO: renamed from: u */
    public final void m70748u(String str) {
        copyOnWrite();
        SendMessageWithImageRequest.m2982s((SendMessageWithImageRequest) this.instance, str);
    }
