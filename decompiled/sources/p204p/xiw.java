...
public final class xiw extends AbstractC0268g implements sre0 {
    ...
    public final void m91160m(boolean z) {
        copyOnWrite();
        EsCommandOptions$CommandOptions.m17664n((EsCommandOptions$CommandOptions) this.instance, z);
    }
    ...
    public final void m91161q(cva cvaVar) {
        copyOnWrite();
        EsCommandOptions$CommandOptions.m17665o((EsCommandOptions$CommandOptions) this.instance, cvaVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m91162r(boolean z) {
        copyOnWrite();
        EsCommandOptions$CommandOptions.m17666p((EsCommandOptions$CommandOptions) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m91163s(boolean z) {
        copyOnWrite();
        EsCommandOptions$CommandOptions.m17667q((EsCommandOptions$CommandOptions) this.instance, z);
    }
