...
import com.spotify.personalizedepisodes.contentservice.p124v1.Schedule;
import com.spotify.personalizedepisodes.contentservice.p124v1.ToolSelection;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class dal extends AbstractC0268g implements sre0 {
    ...
    public final void m35491m(String str) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17396n((CreateOrUpdateScheduleRequest) this.instance, str);
    }
    ...
    public final void m35492q(boolean z) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17397o((CreateOrUpdateScheduleRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m35493r(String str) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17398p((CreateOrUpdateScheduleRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m35494s(String str) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17399q((CreateOrUpdateScheduleRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m35495t(Schedule schedule) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17400r((CreateOrUpdateScheduleRequest) this.instance, schedule);
    }

    /* JADX INFO: renamed from: u */
    public final void m35496u(String str) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17401s((CreateOrUpdateScheduleRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m35497v(ToolSelection toolSelection) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17402t((CreateOrUpdateScheduleRequest) this.instance, toolSelection);
    }

    /* JADX INFO: renamed from: w */
    public final void m35498w(String str) {
        copyOnWrite();
        CreateOrUpdateScheduleRequest.m17403u((CreateOrUpdateScheduleRequest) this.instance, str);
    }
