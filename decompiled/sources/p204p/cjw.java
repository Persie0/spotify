...
public final class cjw extends AbstractC0268g implements sre0 {
    ...
    public final void m33000m(ajw ajwVar) {
        copyOnWrite();
        EsConnectionInfoReceiver$ConnectionStatus.m7565n((EsConnectionInfoReceiver$ConnectionStatus) this.instance, (EsConnectionInfoReceiver$Connected) ajwVar.build());
    }
    ...
    public final void m33001q(Empty empty) {
        copyOnWrite();
        EsConnectionInfoReceiver$ConnectionStatus.m7566o((EsConnectionInfoReceiver$ConnectionStatus) this.instance, empty);
    }
