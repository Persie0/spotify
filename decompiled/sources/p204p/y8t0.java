...
import com.spotify.puffin_esperanto.proto.PuffinFilterRequestOuterClass$PuffinFilterRequest;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes10.dex */
public final class y8t0 extends AbstractC0268g implements sre0 {
    ...
    public final void m93130m(List list) {
        copyOnWrite();
        PuffinFilterRequestOuterClass$PuffinFilterRequest.m20009n((PuffinFilterRequestOuterClass$PuffinFilterRequest) this.instance, list);
    }
    ...
    public final void m93131q(boolean z) {
        copyOnWrite();
        PuffinFilterRequestOuterClass$PuffinFilterRequest.m20010o((PuffinFilterRequestOuterClass$PuffinFilterRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m93132r(boolean z) {
        copyOnWrite();
        PuffinFilterRequestOuterClass$PuffinFilterRequest.m20011p((PuffinFilterRequestOuterClass$PuffinFilterRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m93133s(z8t0 z8t0Var) {
        copyOnWrite();
        PuffinFilterRequestOuterClass$PuffinFilterRequest.m20012q((PuffinFilterRequestOuterClass$PuffinFilterRequest) this.instance, z8t0Var);
    }
