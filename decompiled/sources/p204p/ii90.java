...
import com.spotify.messages.ListeningPartyMusicTrackEnded;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class ii90 extends AbstractC0268g implements sre0 {
    ...
    public final void m50700m(long j) {
        copyOnWrite();
        ListeningPartyMusicTrackEnded.m13930n((ListeningPartyMusicTrackEnded) this.instance, j);
    }
    ...
    public final void m50701q(long j) {
        copyOnWrite();
        ListeningPartyMusicTrackEnded.m13931o((ListeningPartyMusicTrackEnded) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m50702r(String str) {
        copyOnWrite();
        ListeningPartyMusicTrackEnded.m13932p((ListeningPartyMusicTrackEnded) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m50703s(String str) {
        copyOnWrite();
        ListeningPartyMusicTrackEnded.m13933q((ListeningPartyMusicTrackEnded) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m50704t(String str) {
        copyOnWrite();
        ListeningPartyMusicTrackEnded.m13934r((ListeningPartyMusicTrackEnded) this.instance, str);
    }
