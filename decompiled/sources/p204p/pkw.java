...
import com.spotify.download.esperanto.proto.EsDownload$RequestSegmentDataParams;
import com.spotify.download.esperanto.proto.EsDownload$SegmentFileStreamerId;
import com.spotify.download.esperanto.proto.EsDownload$SegmentRequestMetadata;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes6.dex */
public final class pkw extends AbstractC0268g implements sre0 {
    ...
    public final void m70228m(ArrayList arrayList) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9548n((EsDownload$RequestSegmentDataParams) this.instance, arrayList);
    }
    ...
    public final void m70229q(long j) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9549o((EsDownload$RequestSegmentDataParams) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m70230r(EsDownload$SegmentRequestMetadata esDownload$SegmentRequestMetadata) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9550p((EsDownload$RequestSegmentDataParams) this.instance, esDownload$SegmentRequestMetadata);
    }

    /* JADX INFO: renamed from: s */
    public final void m70231s(EsDownload$SegmentFileStreamerId esDownload$SegmentFileStreamerId) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9551q((EsDownload$RequestSegmentDataParams) this.instance, esDownload$SegmentFileStreamerId);
    }

    /* JADX INFO: renamed from: t */
    public final void m70232t(long j) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9552r((EsDownload$RequestSegmentDataParams) this.instance, j);
    }

    /* JADX INFO: renamed from: u */
    public final void m70233u(String str) {
        copyOnWrite();
        EsDownload$RequestSegmentDataParams.m9553s((EsDownload$RequestSegmentDataParams) this.instance, str);
    }
