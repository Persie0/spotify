...
public final class row extends AbstractC0268g implements sre0 {
    ...
    public final void m76085m(ArrayList arrayList) {
        copyOnWrite();
        EsSetQueueRequest$SetQueueRequest.m17969n((EsSetQueueRequest$SetQueueRequest) this.instance, arrayList);
    }
    ...
    public final void m76086q(ArrayList arrayList) {
        copyOnWrite();
        EsSetQueueRequest$SetQueueRequest.m17970o((EsSetQueueRequest$SetQueueRequest) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m76087r(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSetQueueRequest$SetQueueRequest.m17971p((EsSetQueueRequest$SetQueueRequest) this.instance, esLoggingParams$LoggingParams);
    }

    /* JADX INFO: renamed from: s */
    public final void m76088s(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSetQueueRequest$SetQueueRequest.m17972q((EsSetQueueRequest$SetQueueRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: t */
    public final void m76089t(long j) {
        copyOnWrite();
        EsSetQueueRequest$SetQueueRequest.m17973r((EsSetQueueRequest$SetQueueRequest) this.instance, j);
    }
