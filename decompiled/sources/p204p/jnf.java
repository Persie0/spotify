...
public final class jnf extends AbstractC0268g implements sre0 {
    ...
    public final void m53821m(String str) {
        copyOnWrite();
        CommitPendingEventRequest.m16965n((CommitPendingEventRequest) this.instance, str);
    }
    ...
    public final void m53822q(int i) {
        copyOnWrite();
        CommitPendingEventRequest.m16966o((CommitPendingEventRequest) this.instance, i);
    }
