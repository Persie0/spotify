...
public final class y3f extends AbstractC0268g implements sre0 {
    ...
    public final void m92761m(CollectionAlbumDecorationPolicy collectionAlbumDecorationPolicy) {
        copyOnWrite();
        CollectionGetArtistViewRequest.m97500n((CollectionGetArtistViewRequest) this.instance, collectionAlbumDecorationPolicy);
    }
    ...
    public final void m92762q(CollectionArtistDecorationPolicy collectionArtistDecorationPolicy) {
        copyOnWrite();
        CollectionGetArtistViewRequest.m97501o((CollectionGetArtistViewRequest) this.instance, collectionArtistDecorationPolicy);
    }

    /* JADX INFO: renamed from: r */
    public final void m92763r(String str) {
        copyOnWrite();
        CollectionGetArtistViewRequest.m97502p((CollectionGetArtistViewRequest) this.instance, str);
    }
