...
import com.spotify.signup.signup.p150v2.proto.EmailOtpProvider;
import com.spotify.signup.signup.p150v2.proto.GoogleProvider;
import com.spotify.signup.signup.p150v2.proto.IdentityProviderIdentifier;
import com.spotify.signup.signup.p150v2.proto.NaverProvider;
import com.spotify.signup.signup.p150v2.proto.PhoneNumberProvider;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class r140 extends AbstractC0268g implements sre0 {
    ...
    public final void m74450m(i1u i1uVar) {
        copyOnWrite();
        IdentityProviderIdentifier.m21389n((IdentityProviderIdentifier) this.instance, (EmailOtpProvider) i1uVar.build());
    }
    ...
    public final void m74451q(xo10 xo10Var) {
        copyOnWrite();
        IdentityProviderIdentifier.m21390o((IdentityProviderIdentifier) this.instance, (GoogleProvider) xo10Var.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m74452r(d0j0 d0j0Var) {
        copyOnWrite();
        IdentityProviderIdentifier.m21391p((IdentityProviderIdentifier) this.instance, (NaverProvider) d0j0Var.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m74453s(evn0 evn0Var) {
        copyOnWrite();
        IdentityProviderIdentifier.m21392q((IdentityProviderIdentifier) this.instance, (PhoneNumberProvider) evn0Var.build());
    }

    /* JADX INFO: renamed from: t */
    public final void m74454t(String str) {
        copyOnWrite();
        IdentityProviderIdentifier.m21393r((IdentityProviderIdentifier) this.instance, str);
    }
