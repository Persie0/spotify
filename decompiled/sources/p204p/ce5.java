...
import com.spotify.agesignal.agesignalverifierimpl.proto.AppStoreAgeSignalGenericNonAuth;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes4.dex */
public final class ce5 extends AbstractC0268g implements sre0 {
    ...
    public final void m32491m(Map map) {
        copyOnWrite();
        AppStoreAgeSignalGenericNonAuth.m3031n((AppStoreAgeSignalGenericNonAuth) this.instance).putAll(map);
    }
    ...
    public final void m32492q(String str) {
        copyOnWrite();
        AppStoreAgeSignalGenericNonAuth.m3032o((AppStoreAgeSignalGenericNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m32493r(String str) {
        copyOnWrite();
        AppStoreAgeSignalGenericNonAuth.m3033p((AppStoreAgeSignalGenericNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m32494s(String str) {
        copyOnWrite();
        AppStoreAgeSignalGenericNonAuth.m3034q((AppStoreAgeSignalGenericNonAuth) this.instance, str);
    }
