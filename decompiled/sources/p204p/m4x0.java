...
public final class m4x0 extends AbstractC0268g implements sre0 {
    public m4x0() {
        super(RestrictedIntegrationsRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m60817m(String str) {
        copyOnWrite();
        RestrictedIntegrationsRequest.m6795n((RestrictedIntegrationsRequest) this.instance, str);
    }
