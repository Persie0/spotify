...
public final class ijt0 extends AbstractC0268g implements sre0 {
    ...
    public final void m50833m(List list) {
        copyOnWrite();
        QuestionFeedback.m15891n((QuestionFeedback) this.instance, list);
    }
    ...
    public final void m50834q(int i) {
        copyOnWrite();
        QuestionFeedback.m15892o((QuestionFeedback) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m50835r(String str) {
        copyOnWrite();
        QuestionFeedback.m15893p((QuestionFeedback) this.instance, str);
    }
