...
import com.spotify.campfire.contribution.proto.p037v1.ListeningActivityTarget;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class xf90 extends AbstractC0268g implements sre0 {
    ...
    public final void m90469m(String str) {
        copyOnWrite();
        ListeningActivityTarget.m4339n((ListeningActivityTarget) this.instance, str);
    }
    ...
    public final void m90470q(String str) {
        copyOnWrite();
        ListeningActivityTarget.m4340o((ListeningActivityTarget) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m90471r(lu71 lu71Var) {
        copyOnWrite();
        ListeningActivityTarget.m4341p((ListeningActivityTarget) this.instance, (Timestamp) lu71Var.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m90472s(String str) {
        copyOnWrite();
        ListeningActivityTarget.m4342q((ListeningActivityTarget) this.instance, str);
    }
