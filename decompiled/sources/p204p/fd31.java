...
import com.spotify.libs.sociallistening.events.proto.SocialConnectNotificationOpenError;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class fd31 extends AbstractC0268g implements sre0 {
    ...
    public final void m41346m(String str) {
        copyOnWrite();
        SocialConnectNotificationOpenError.m12866n((SocialConnectNotificationOpenError) this.instance, str);
    }
    ...
    public final void m41347q(String str) {
        copyOnWrite();
        SocialConnectNotificationOpenError.m12867o((SocialConnectNotificationOpenError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m41348r(String str) {
        copyOnWrite();
        SocialConnectNotificationOpenError.m12868p((SocialConnectNotificationOpenError) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m41349s(String str) {
        copyOnWrite();
        SocialConnectNotificationOpenError.m12869q((SocialConnectNotificationOpenError) this.instance, str);
    }
