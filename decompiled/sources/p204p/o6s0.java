...
public final class o6s0 extends AbstractC0268g implements sre0 {
    ...
    public final void m66355m(Duration duration) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97827n((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, duration);
    }
    ...
    public final void m66356q(String str) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97828o((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m66357r(String str) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97829p((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m66358s(boolean z) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97830q((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m66359t(Duration duration) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97831r((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, duration);
    }

    /* JADX INFO: renamed from: u */
    public final void m66360u(bks bksVar) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97831r((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, (Duration) bksVar.build());
    }

    /* JADX INFO: renamed from: v */
    public final void m66361v(p6s0 p6s0Var) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97832s((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, p6s0Var);
    }

    /* JADX INFO: renamed from: w */
    public final void m66362w(String str) {
        copyOnWrite();
        ProgressPlaybackEsperanto$OnUpdateRequest.m97833t((ProgressPlaybackEsperanto$OnUpdateRequest) this.instance, str);
    }
