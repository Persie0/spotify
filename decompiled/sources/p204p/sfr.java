...
public final class sfr extends AbstractC0268g implements sre0 {
    ...
    public final void m78007m(int i) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9267n((DeviceSuggestionSourceResult) this.instance, i);
    }
    ...
    public final void m78008q(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9268o((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m78009r(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9269p((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m78010s(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9270q((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m78011t(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9271r((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m78012u(boolean z) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9272s((DeviceSuggestionSourceResult) this.instance, z);
    }

    /* JADX INFO: renamed from: v */
    public final void m78013v(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9273t((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m78014w(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9274u((DeviceSuggestionSourceResult) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m78015x(String str) {
        copyOnWrite();
        DeviceSuggestionSourceResult.m9275v((DeviceSuggestionSourceResult) this.instance, str);
    }
