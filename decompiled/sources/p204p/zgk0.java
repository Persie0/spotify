...
import com.spotify.widgets.recommendationswidget.events.proto.NpvRecommendationsWidgetLifecycleEventNonAuth;
import java.io.InputStream;

/* JADX INFO: loaded from: classes11.dex */
public final class zgk0 extends AbstractC0268g implements sre0 {
    ...
    public final void m96098m(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23114n((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }
    ...
    public final void m96099q(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23115o((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m96100r(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23116p((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m96101s(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23117q((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m96102t(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23118r((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m96103u(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23119s((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m96104v(long j) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEventNonAuth.m23120t((NpvRecommendationsWidgetLifecycleEventNonAuth) this.instance, j);
    }
