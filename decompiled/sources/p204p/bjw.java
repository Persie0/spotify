...
import com.spotify.connectivity.reachability.esperanto.proto.EsConnectionAvailability$ConnectionAvailability;
import com.spotify.connectivity.reachability.esperanto.proto.EsConnectionInfoReceiver$ConnectionInfo;
import com.spotify.connectivity.reachability.esperanto.proto.EsConnectionInfoReceiver$ConnectionStatus;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class bjw extends AbstractC0268g implements sre0 {
    ...
    public final void m29539m(yiw yiwVar) {
        copyOnWrite();
        EsConnectionInfoReceiver$ConnectionInfo.m7560n((EsConnectionInfoReceiver$ConnectionInfo) this.instance, (EsConnectionAvailability$ConnectionAvailability) yiwVar.build());
    }
    ...
    public final void m29540q(EsConnectionInfoReceiver$ConnectionStatus esConnectionInfoReceiver$ConnectionStatus) {
        copyOnWrite();
        EsConnectionInfoReceiver$ConnectionInfo.m7561o((EsConnectionInfoReceiver$ConnectionInfo) this.instance, esConnectionInfoReceiver$ConnectionStatus);
    }

    /* JADX INFO: renamed from: r */
    public final void m29541r(boolean z) {
        copyOnWrite();
        EsConnectionInfoReceiver$ConnectionInfo.m7562p((EsConnectionInfoReceiver$ConnectionInfo) this.instance, z);
    }
