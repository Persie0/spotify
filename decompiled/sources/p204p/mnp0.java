...
public final class mnp0 extends AbstractC0268g implements sre0 {
    ...
    public final void m62361m(lnp0 lnp0Var) {
        copyOnWrite();
        PlaylistOfflineRequest.m97713n((PlaylistOfflineRequest) this.instance, lnp0Var);
    }
    ...
    public final void m62362q(PlaylistQuery playlistQuery) {
        copyOnWrite();
        PlaylistOfflineRequest.m97714o((PlaylistOfflineRequest) this.instance, playlistQuery);
    }

    /* JADX INFO: renamed from: r */
    public final void m62363r(String str) {
        copyOnWrite();
        PlaylistOfflineRequest.m97715p((PlaylistOfflineRequest) this.instance, str);
    }
