...
public final class ovb1 extends AbstractC0268g implements sre0 {
    ...
    public final void m68126m(String str, boolean z) {
        str.getClass();
        copyOnWrite();
        VideoFirstProto$UserState.m15948n((VideoFirstProto$UserState) this.instance).put(str, Boolean.valueOf(z));
    }
