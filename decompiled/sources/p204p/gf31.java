...
import com.spotify.libs.sociallistening.events.proto.SocialListeningClientSessionCreated;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class gf31 extends AbstractC0268g implements sre0 {
    ...
    public final void m44563m(String str) {
        copyOnWrite();
        SocialListeningClientSessionCreated.m12890n((SocialListeningClientSessionCreated) this.instance, str);
    }
    ...
    public final void m44564q(String str) {
        copyOnWrite();
        SocialListeningClientSessionCreated.m12891o((SocialListeningClientSessionCreated) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m44565r(String str) {
        copyOnWrite();
        SocialListeningClientSessionCreated.m12892p((SocialListeningClientSessionCreated) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m44566s(String str) {
        copyOnWrite();
        SocialListeningClientSessionCreated.m12893q((SocialListeningClientSessionCreated) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m44567t(String str) {
        copyOnWrite();
        SocialListeningClientSessionCreated.m12894r((SocialListeningClientSessionCreated) this.instance, str);
    }
