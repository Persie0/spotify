...
public final class nke extends AbstractC0268g implements sre0 {
    ...
    public final void m64683m(ArrayList arrayList) {
        copyOnWrite();
        ClientLanguageRaw.m12529n((ClientLanguageRaw) this.instance, arrayList);
    }
    ...
    public final void m64684q(String str) {
        copyOnWrite();
        ClientLanguageRaw.m12530o((ClientLanguageRaw) this.instance, str);
    }
