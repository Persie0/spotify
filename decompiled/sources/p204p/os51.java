...
public final class os51 extends AbstractC0268g implements sre0 {
    ...
    public final void m67707m(String str) {
        copyOnWrite();
        SubmitFeedbackRequest.m21481n((SubmitFeedbackRequest) this.instance, str);
    }
    ...
    public final void m67708q(nky nkyVar) {
        copyOnWrite();
        SubmitFeedbackRequest.m21482o((SubmitFeedbackRequest) this.instance, nkyVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m67709r(String str) {
        copyOnWrite();
        SubmitFeedbackRequest.m21483p((SubmitFeedbackRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m67710s(r1y0 r1y0Var) {
        copyOnWrite();
        SubmitFeedbackRequest.m21484q((SubmitFeedbackRequest) this.instance, r1y0Var);
    }

    /* JADX INFO: renamed from: t */
    public final void m67711t(cl31 cl31Var) {
        copyOnWrite();
        SubmitFeedbackRequest.m21485r((SubmitFeedbackRequest) this.instance, cl31Var);
    }
