...
public final class bff0 extends AbstractC0268g implements sre0 {
    ...
    public final void m29012m(boolean z) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13302n((MinimumLyricsCharactersSeen) this.instance, z);
    }
    ...
    public final void m29013q(boolean z) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13303o((MinimumLyricsCharactersSeen) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m29014r(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13304p((MinimumLyricsCharactersSeen) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m29015s(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13305q((MinimumLyricsCharactersSeen) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m29016t(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13306r((MinimumLyricsCharactersSeen) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m29017u(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13307s((MinimumLyricsCharactersSeen) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m29018v(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13308t((MinimumLyricsCharactersSeen) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m29019w(String str) {
        copyOnWrite();
        MinimumLyricsCharactersSeen.m13309u((MinimumLyricsCharactersSeen) this.instance, str);
    }
