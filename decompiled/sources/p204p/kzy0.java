...
public final class kzy0 extends AbstractC0268g implements sre0 {
    ...
    public final void m57767m(String str) {
        copyOnWrite();
        SearchRequest.m12196n((SearchRequest) this.instance, str);
    }
    ...
    public final void m57768q(int i) {
        copyOnWrite();
        SearchRequest.m12197o((SearchRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m57769r(String str) {
        copyOnWrite();
        SearchRequest.m12198p((SearchRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m57770s(String str) {
        copyOnWrite();
        SearchRequest.m12199q((SearchRequest) this.instance, str);
    }
