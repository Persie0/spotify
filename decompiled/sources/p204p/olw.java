...
public final class olw extends AbstractC0268g implements sre0 {
    ...
    public final void m67307m(klw klwVar) {
        copyOnWrite();
        EsMediaPrefetch$SegmentProfileSelectionConfig.m19500n((EsMediaPrefetch$SegmentProfileSelectionConfig) this.instance, klwVar);
    }
    ...
    public final void m67308q(rlw rlwVar) {
        copyOnWrite();
        EsMediaPrefetch$SegmentProfileSelectionConfig.m19501o((EsMediaPrefetch$SegmentProfileSelectionConfig) this.instance, rlwVar);
    }

    /* JADX INFO: renamed from: r */
    public final void m67309r(boolean z) {
        copyOnWrite();
        EsMediaPrefetch$SegmentProfileSelectionConfig.m19502p((EsMediaPrefetch$SegmentProfileSelectionConfig) this.instance, z);
    }
