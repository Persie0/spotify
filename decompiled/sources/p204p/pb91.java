...
public final class pb91 extends AbstractC0268g implements sre0 {
    public pb91() {
    ...
    public final void m69518m(String str) {
        copyOnWrite();
        TransitionToManagedAccountRequest.m10789n((TransitionToManagedAccountRequest) this.instance, str);
    }
    ...
    public final void m69519q(String str) {
        copyOnWrite();
        TransitionToManagedAccountRequest.m10790o((TransitionToManagedAccountRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m69520r(GenAlphaManagedSettings genAlphaManagedSettings) {
        copyOnWrite();
        TransitionToManagedAccountRequest.m10791p((TransitionToManagedAccountRequest) this.instance, genAlphaManagedSettings);
    }
