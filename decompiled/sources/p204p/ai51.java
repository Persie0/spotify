...
public final class ai51 extends AbstractC0268g implements sre0 {
    ...
    public final void m26062m(Timestamp timestamp) {
        copyOnWrite();
        StreamEndRequestOuterClass$StreamEndRequest.m21632n((StreamEndRequestOuterClass$StreamEndRequest) this.instance, timestamp);
    }
    ...
    public final void m26063q(tqo0 tqo0Var) {
        copyOnWrite();
        StreamEndRequestOuterClass$StreamEndRequest.m21633o((StreamEndRequestOuterClass$StreamEndRequest) this.instance, tqo0Var);
    }

    /* JADX INFO: renamed from: r */
    public final void m26064r(StreamHandleOuterClass$StreamHandle streamHandleOuterClass$StreamHandle) {
        copyOnWrite();
        StreamEndRequestOuterClass$StreamEndRequest.m21634p((StreamEndRequestOuterClass$StreamEndRequest) this.instance, streamHandleOuterClass$StreamHandle);
    }
