...
public final class vmw extends AbstractC0268g implements sre0 {
    ...
    public final void m86021m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsPause$PauseRequest.m17779n((EsPause$PauseRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m86022q(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsPause$PauseRequest.m17780o((EsPause$PauseRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m86023r(EsPauseresumeOrigin$PauseResumeOrigin esPauseresumeOrigin$PauseResumeOrigin) {
        copyOnWrite();
        EsPause$PauseRequest.m17781p((EsPause$PauseRequest) this.instance, esPauseresumeOrigin$PauseResumeOrigin);
    }
