...
import com.spotify.playlistmixing.proto.ExplicitFeedbackSubmission;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes9.dex */
public final class smx extends AbstractC0268g implements sre0 {
    ...
    public final void m78527m(ArrayList arrayList) {
        copyOnWrite();
        ExplicitFeedbackSubmission.m19388n((ExplicitFeedbackSubmission) this.instance, arrayList);
    }
    ...
    public final void m78528q(String str) {
        copyOnWrite();
        ExplicitFeedbackSubmission.m19389o((ExplicitFeedbackSubmission) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m78529r(String str) {
        copyOnWrite();
        ExplicitFeedbackSubmission.m19390p((ExplicitFeedbackSubmission) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m78530s(String str) {
        copyOnWrite();
        ExplicitFeedbackSubmission.m19391q((ExplicitFeedbackSubmission) this.instance, str);
    }
