...
public final class pow extends AbstractC0268g implements sre0 {
    ...
    public final void m70494m(Map map) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17961n((EsSetOptions$SetOptionsRequest) this.instance).putAll(map);
    }
    ...
    public final void m70495q(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17962o((EsSetOptions$SetOptionsRequest) this.instance, esLoggingParams$LoggingParams);
    }

    /* JADX INFO: renamed from: r */
    public final void m70496r(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17963p((EsSetOptions$SetOptionsRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: s */
    public final void m70497s(float f) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17964q((EsSetOptions$SetOptionsRequest) this.instance, f);
    }

    /* JADX INFO: renamed from: t */
    public final void m70498t(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17965r((EsSetOptions$SetOptionsRequest) this.instance, esOptional$OptionalBoolean);
    }

    /* JADX INFO: renamed from: u */
    public final void m70499u(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17966s((EsSetOptions$SetOptionsRequest) this.instance, esOptional$OptionalBoolean);
    }

    /* JADX INFO: renamed from: v */
    public final void m70500v(EsOptional$OptionalBoolean esOptional$OptionalBoolean) {
        copyOnWrite();
        EsSetOptions$SetOptionsRequest.m17967t((EsSetOptions$SetOptionsRequest) this.instance, esOptional$OptionalBoolean);
    }
