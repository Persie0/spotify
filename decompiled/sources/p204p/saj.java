...
import com.spotify.casita.p040v1.resolved.ContentEvaluationList;
import com.spotify.contentagnostic.ContentTypeTrait;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class saj extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f207222a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ saj(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public saj(int i) {
        super(ContentEvaluationList.DEFAULT_INSTANCE);
        this.f207222a = i;
        switch (i) {
            case 26:
                super(ContentTypeTrait.DEFAULT_INSTANCE);
                break;
            default:
                break;
        }
