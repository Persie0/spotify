...
public final class w2f extends AbstractC0268g implements sre0 {
    ...
    public final void m87076m(Iterable iterable) {
        copyOnWrite();
        CollectionContainsRequest.m97460n((CollectionContainsRequest) this.instance, iterable);
    }
    ...
    public final void m87077q(String str) {
        copyOnWrite();
        CollectionContainsRequest.m97461o((CollectionContainsRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m87078r(String str) {
        copyOnWrite();
        CollectionContainsRequest.m97462p((CollectionContainsRequest) this.instance, str);
    }
