...
import com.spotify.download.esperanto.proto.EsDownload$ProgressiveFileStreamerParams;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class nkw extends AbstractC0268g implements sre0 {
    ...
    public final void m64707m(boolean z) {
        copyOnWrite();
        EsDownload$ProgressiveFileStreamerParams.m9532n((EsDownload$ProgressiveFileStreamerParams) this.instance, z);
    }
    ...
    public final void m64708q(String str) {
        copyOnWrite();
        EsDownload$ProgressiveFileStreamerParams.m9533o((EsDownload$ProgressiveFileStreamerParams) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m64709r(String str) {
        copyOnWrite();
        EsDownload$ProgressiveFileStreamerParams.m9534p((EsDownload$ProgressiveFileStreamerParams) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m64710s(String str) {
        copyOnWrite();
        EsDownload$ProgressiveFileStreamerParams.m9535q((EsDownload$ProgressiveFileStreamerParams) this.instance, str);
    }
