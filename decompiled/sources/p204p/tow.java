...
public final class tow extends AbstractC0268g implements sre0 {
    ...
    public final void m81223m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSignalRequest$SignalRequest.m17989n((EsSignalRequest$SignalRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m81224q(String str) {
        copyOnWrite();
        EsSignalRequest$SignalRequest.m17990o((EsSignalRequest$SignalRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m81225r(String str) {
        copyOnWrite();
        EsSignalRequest$SignalRequest.m17991p((EsSignalRequest$SignalRequest) this.instance, str);
    }
