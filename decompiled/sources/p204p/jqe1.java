...
public final class jqe1 extends AbstractC0268g implements sre0 {
    ...
    public final void m54085m(kqe1 kqe1Var) {
        copyOnWrite();
        YourLibraryRequest.m98170n((YourLibraryRequest) this.instance, (YourLibraryRequestHeader) kqe1Var.build());
    }
    ...
    public final void m54086q(YourLibraryRequestHeader yourLibraryRequestHeader) {
        copyOnWrite();
        YourLibraryRequest.m98170n((YourLibraryRequest) this.instance, yourLibraryRequestHeader);
    }

    /* JADX INFO: renamed from: r */
    public final void m54087r(YourLibraryConfig$YourLibraryPredefinedPlaylistConfigs yourLibraryConfig$YourLibraryPredefinedPlaylistConfigs) {
        copyOnWrite();
        YourLibraryRequest.m98171o((YourLibraryRequest) this.instance, yourLibraryConfig$YourLibraryPredefinedPlaylistConfigs);
    }

    /* JADX INFO: renamed from: s */
    public final void m54088s(int i) {
        copyOnWrite();
        YourLibraryRequest.m98172p((YourLibraryRequest) this.instance, i);
    }
