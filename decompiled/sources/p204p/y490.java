...
public final class y490 extends AbstractC0268g implements sre0 {
    ...
    public final void m92799m(String str) {
        copyOnWrite();
        ListSortingProto$StoredProvidedSortOrder.m13015n((ListSortingProto$StoredProvidedSortOrder) this.instance, str);
    }
    ...
    public final void m92800q(boolean z) {
        copyOnWrite();
        ListSortingProto$StoredProvidedSortOrder.m13016o((ListSortingProto$StoredProvidedSortOrder) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m92801r(String str) {
        copyOnWrite();
        ListSortingProto$StoredProvidedSortOrder.m13017p((ListSortingProto$StoredProvidedSortOrder) this.instance, str);
    }
