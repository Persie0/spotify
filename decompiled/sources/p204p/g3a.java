...
import com.spotify.libs.bluetooth.events.proto.BluetoothMtuNegotiationResult;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class g3a extends AbstractC0268g implements sre0 {
    ...
    public final void m43468m(int i) {
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12615n((BluetoothMtuNegotiationResult) this.instance, i);
    }
    ...
    public final void m43469q(String str) {
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12616o((BluetoothMtuNegotiationResult) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m43470r() {
        String str = Build.MANUFACTURER;
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12617p((BluetoothMtuNegotiationResult) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m43471s() {
        String str = Build.MODEL;
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12618q((BluetoothMtuNegotiationResult) this.instance);
    }

    /* JADX INFO: renamed from: t */
    public final void m43472t(int i) {
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12619r((BluetoothMtuNegotiationResult) this.instance, i);
    }

    /* JADX INFO: renamed from: u */
    public final void m43473u(int i) {
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12620s((BluetoothMtuNegotiationResult) this.instance, i);
    }

    /* JADX INFO: renamed from: v */
    public final void m43474v(int i) {
        copyOnWrite();
        BluetoothMtuNegotiationResult.m12621t((BluetoothMtuNegotiationResult) this.instance, i);
    }
