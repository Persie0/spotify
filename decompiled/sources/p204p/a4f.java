...
public final class a4f extends AbstractC0268g implements sre0 {
    ...
    public final void m24693m(CollectionEpisodeDecorationPolicy collectionEpisodeDecorationPolicy) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97506n((CollectionGetUnplayedEpisodesRequest) this.instance, collectionEpisodeDecorationPolicy);
    }
    ...
    public final void m24694q(String str) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97507o((CollectionGetUnplayedEpisodesRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m24695r(boolean z) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97508p((CollectionGetUnplayedEpisodesRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m24696s(int i) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97509q((CollectionGetUnplayedEpisodesRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: t */
    public final void m24697t(String str) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97510r((CollectionGetUnplayedEpisodesRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m24698u(int i) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97511s((CollectionGetUnplayedEpisodesRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: v */
    public final void m24699v(int i) {
        copyOnWrite();
        CollectionGetUnplayedEpisodesRequest.m97512t((CollectionGetUnplayedEpisodesRequest) this.instance, i);
    }
