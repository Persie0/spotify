...
import com.spotify.messages.ListeningPartyPlayedMusicTrack;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class ni90 extends AbstractC0268g implements sre0 {
    ...
    public final void m64566m(long j) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13936n((ListeningPartyPlayedMusicTrack) this.instance, j);
    }
    ...
    public final void m64567q(long j) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13937o((ListeningPartyPlayedMusicTrack) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m64568r(String str) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13938p((ListeningPartyPlayedMusicTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m64569s(String str) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13939q((ListeningPartyPlayedMusicTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m64570t(long j) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13940r((ListeningPartyPlayedMusicTrack) this.instance, j);
    }

    /* JADX INFO: renamed from: u */
    public final void m64571u(String str) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13941s((ListeningPartyPlayedMusicTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m64572v(long j) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13942t((ListeningPartyPlayedMusicTrack) this.instance, j);
    }

    /* JADX INFO: renamed from: w */
    public final void m64573w(String str) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13943u((ListeningPartyPlayedMusicTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m64574x(String str) {
        copyOnWrite();
        ListeningPartyPlayedMusicTrack.m13944v((ListeningPartyPlayedMusicTrack) this.instance, str);
    }
