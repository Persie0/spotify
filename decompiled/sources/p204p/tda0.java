...
public final class tda0 extends AbstractC0268g implements sre0 {
    ...
    public final void m80494m(String str) {
        copyOnWrite();
        LocalListConfig.m97806n((LocalListConfig) this.instance, str);
    }
    ...
    public final void m80495q(String str) {
        copyOnWrite();
        LocalListConfig.m97807o((LocalListConfig) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m80496r(String str) {
        copyOnWrite();
        LocalListConfig.m97808p((LocalListConfig) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m80497s(String str) {
        copyOnWrite();
        LocalListConfig.m97809q((LocalListConfig) this.instance, str);
    }
