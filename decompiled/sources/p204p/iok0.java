...
import com.spotify.performancesdk.observationplatform.proto.ObservationPlatformProto$Histogram;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes9.dex */
public final class iok0 extends AbstractC0268g implements sre0 {
    ...
    public final void m51208m(Iterable iterable) {
        copyOnWrite();
        ObservationPlatformProto$Histogram.m17327n((ObservationPlatformProto$Histogram) this.instance, iterable);
    }
    ...
    public final void m51209q(ArrayList arrayList) {
        copyOnWrite();
        ObservationPlatformProto$Histogram.m17328o((ObservationPlatformProto$Histogram) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m51210r(long j) {
        copyOnWrite();
        ObservationPlatformProto$Histogram.m17329p((ObservationPlatformProto$Histogram) this.instance, j);
    }

    /* JADX INFO: renamed from: s */
    public final void m51211s(double d) {
        copyOnWrite();
        ObservationPlatformProto$Histogram.m17330q((ObservationPlatformProto$Histogram) this.instance, d);
    }
