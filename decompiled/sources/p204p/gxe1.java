...
import com.spotify.yourupdates.domain.YourUpdatesNotificationInteraction;
import java.io.InputStream;

/* JADX INFO: loaded from: classes11.dex */
public final class gxe1 extends AbstractC0268g implements sre0 {
    ...
    public final void m46055m(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23268n((YourUpdatesNotificationInteraction) this.instance, str);
    }
    ...
    public final void m46056q(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23269o((YourUpdatesNotificationInteraction) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m46057r(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23270p((YourUpdatesNotificationInteraction) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m46058s(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23271q((YourUpdatesNotificationInteraction) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m46059t(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23272r((YourUpdatesNotificationInteraction) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m46060u(String str) {
        copyOnWrite();
        YourUpdatesNotificationInteraction.m23273s((YourUpdatesNotificationInteraction) this.instance, str);
    }
