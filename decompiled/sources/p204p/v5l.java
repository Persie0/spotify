...
public final class v5l extends AbstractC0268g implements sre0 {
    public v5l() {
    ...
    public final void m84732m(ArrayList arrayList) {
        copyOnWrite();
        CreateConversationRequest.m2888n((CreateConversationRequest) this.instance, arrayList);
    }
    ...
    public final void m84733q(String str) {
        copyOnWrite();
        CreateConversationRequest.m2889o((CreateConversationRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84734r(boolean z) {
        copyOnWrite();
        CreateConversationRequest.m2890p((CreateConversationRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m84735s(UserMessage userMessage) {
        copyOnWrite();
        CreateConversationRequest.m2891q((CreateConversationRequest) this.instance, userMessage);
    }

    /* JADX INFO: renamed from: t */
    public final void m84736t(String str) {
        copyOnWrite();
        CreateConversationRequest.m2892r((CreateConversationRequest) this.instance, str);
    }
