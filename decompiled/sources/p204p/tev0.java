...
public final class tev0 extends AbstractC0268g implements sre0 {
    ...
    public final void m80572m(Iterable iterable) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3336n((RecommendationsProto$CurationRecommendationsRequest) this.instance, iterable);
    }
    ...
    public final void m80573q(Iterable iterable) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3337o((RecommendationsProto$CurationRecommendationsRequest) this.instance, iterable);
    }

    /* JADX INFO: renamed from: r */
    public final void m80574r(String str) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3338p((RecommendationsProto$CurationRecommendationsRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m80575s(int i) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3339q((RecommendationsProto$CurationRecommendationsRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: t */
    public final void m80576t(RecommendationsProto$SuggestedAudiobooks recommendationsProto$SuggestedAudiobooks) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3340r((RecommendationsProto$CurationRecommendationsRequest) this.instance, recommendationsProto$SuggestedAudiobooks);
    }

    /* JADX INFO: renamed from: u */
    public final void m80577u(RecommendationsProto$SuggestedEpisodes recommendationsProto$SuggestedEpisodes) {
        copyOnWrite();
        RecommendationsProto$CurationRecommendationsRequest.m3341s((RecommendationsProto$CurationRecommendationsRequest) this.instance, recommendationsProto$SuggestedEpisodes);
    }
