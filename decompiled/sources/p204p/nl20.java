...
public final class nl20 extends AbstractC0268g implements sre0 {
    ...
    public final void m64713m(ShowCollectionDecorationPolicy showCollectionDecorationPolicy) {
        copyOnWrite();
        HeaderPolicy.m21220n((HeaderPolicy) this.instance, showCollectionDecorationPolicy);
    }
    ...
    public final void m64714q(ShowOfflineStateDecorationPolicy showOfflineStateDecorationPolicy) {
        copyOnWrite();
        HeaderPolicy.m21221o((HeaderPolicy) this.instance, showOfflineStateDecorationPolicy);
    }

    /* JADX INFO: renamed from: r */
    public final void m64715r(ShowPlayedStateDecorationPolicy.Builder builder) {
        copyOnWrite();
        HeaderPolicy.m21222p((HeaderPolicy) this.instance, (ShowPlayedStateDecorationPolicy) builder.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m64716s(ShowPlayedStateDecorationPolicy showPlayedStateDecorationPolicy) {
        copyOnWrite();
        HeaderPolicy.m21222p((HeaderPolicy) this.instance, showPlayedStateDecorationPolicy);
    }

    /* JADX INFO: renamed from: t */
    public final void m64717t(ShowDecorationPolicy.Builder builder) {
        copyOnWrite();
        HeaderPolicy.m21223q((HeaderPolicy) this.instance, (ShowDecorationPolicy) builder.build());
    }

    /* JADX INFO: renamed from: u */
    public final void m64718u(ShowDecorationPolicy showDecorationPolicy) {
        copyOnWrite();
        HeaderPolicy.m21223q((HeaderPolicy) this.instance, showDecorationPolicy);
    }
