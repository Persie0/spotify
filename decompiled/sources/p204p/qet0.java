...
import com.spotify.messages.PushNotificationDisplayedAndroidEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class qet0 extends AbstractC0268g implements sre0 {
    ...
    public final void m72667m(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14377n((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }
    ...
    public final void m72668q(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14378o((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m72669r(boolean z) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14379p((PushNotificationDisplayedAndroidEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m72670s(boolean z) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14380q((PushNotificationDisplayedAndroidEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m72671t(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14381r((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m72672u(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14382s((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m72673v(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14383t((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m72674w(String str) {
        copyOnWrite();
        PushNotificationDisplayedAndroidEvent.m14384u((PushNotificationDisplayedAndroidEvent) this.instance, str);
    }
