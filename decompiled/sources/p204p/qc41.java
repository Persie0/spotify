...
public final class qc41 extends AbstractC0268g implements sre0 {
    ...
    public final void m72515m(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21788n((SpotifyGoCommandLifecycle) this.instance, str);
    }
    ...
    public final void m72516q(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21789o((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m72517r(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21790p((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m72518s(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21791q((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m72519t(boolean z) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21792r((SpotifyGoCommandLifecycle) this.instance, z);
    }

    /* JADX INFO: renamed from: u */
    public final void m72520u(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21793s((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m72521v(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21794t((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m72522w(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21795u((SpotifyGoCommandLifecycle) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m72523x(String str) {
        copyOnWrite();
        SpotifyGoCommandLifecycle.m21796v((SpotifyGoCommandLifecycle) this.instance, str);
    }
