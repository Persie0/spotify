...
public final class pz41 extends AbstractC0268g implements sre0 {
    ...
    public final void m71686m(u3r u3rVar) {
        copyOnWrite();
        StatsDetailsRequest.m11431n((StatsDetailsRequest) this.instance, u3rVar);
    }
    ...
    public final void m71687q(int i) {
        copyOnWrite();
        StatsDetailsRequest.m11432o((StatsDetailsRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m71688r(e5u0 e5u0Var) {
        copyOnWrite();
        StatsDetailsRequest.m11433p((StatsDetailsRequest) this.instance, e5u0Var);
    }

    /* JADX INFO: renamed from: s */
    public final void m71689s(String str) {
        copyOnWrite();
        StatsDetailsRequest.m11434q((StatsDetailsRequest) this.instance, str);
    }
