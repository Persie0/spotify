...
public final class moe1 extends AbstractC0268g implements sre0 {
    ...
    public final void m62396m(List list) {
        copyOnWrite();
        YourLibraryDecorateRequest.m98158n((YourLibraryDecorateRequest) this.instance, list);
    }
    ...
    public final void m62397q(String str) {
        copyOnWrite();
        YourLibraryDecorateRequest.m98159o((YourLibraryDecorateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m62398r(YourLibraryConfig$YourLibraryPredefinedPlaylistConfigs yourLibraryConfig$YourLibraryPredefinedPlaylistConfigs) {
        copyOnWrite();
        YourLibraryDecorateRequest.m98160p((YourLibraryDecorateRequest) this.instance, yourLibraryConfig$YourLibraryPredefinedPlaylistConfigs);
    }

    /* JADX INFO: renamed from: s */
    public final void m62399s() {
        copyOnWrite();
        YourLibraryDecorateRequest.m98161q((YourLibraryDecorateRequest) this.instance);
    }
