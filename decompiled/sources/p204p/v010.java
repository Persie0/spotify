...
public final class v010 extends AbstractC0268g implements sre0 {
    ...
    public final void m84354m(String str) {
        copyOnWrite();
        GeneratePromptedPlaylistRequest.m21448n((GeneratePromptedPlaylistRequest) this.instance, str);
    }
    ...
    public final void m84355q(String str) {
        copyOnWrite();
        GeneratePromptedPlaylistRequest.m21449o((GeneratePromptedPlaylistRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84356r(cms0 cms0Var) {
        copyOnWrite();
        GeneratePromptedPlaylistRequest.m21450p((GeneratePromptedPlaylistRequest) this.instance, cms0Var);
    }

    /* JADX INFO: renamed from: s */
    public final void m84357s(String str) {
        copyOnWrite();
        GeneratePromptedPlaylistRequest.m21451q((GeneratePromptedPlaylistRequest) this.instance, str);
    }
