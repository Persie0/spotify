...
import com.spotify.nowplayingmodes.adsmode.events.proto.AdFeedbackEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class eo0 extends AbstractC0268g implements sre0 {
    ...
    public final void m39527m(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16007n((AdFeedbackEvent) this.instance, str);
    }
    ...
    public final void m39528q(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16008o((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m39529r(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16009p((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m39530s(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16010q((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m39531t(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16011r((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m39532u(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16012s((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m39533v(String str) {
        copyOnWrite();
        AdFeedbackEvent.m16013t((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m39534w(long j) {
        copyOnWrite();
        AdFeedbackEvent.m16014u((AdFeedbackEvent) this.instance, j);
    }

    /* JADX INFO: renamed from: x */
    public final void m39535x(double d) {
        copyOnWrite();
        AdFeedbackEvent.m16015v((AdFeedbackEvent) this.instance, d);
    }
