...
public final class upw extends AbstractC0268g implements sre0 {
    ...
    public final void m83730m(cva cvaVar) {
        copyOnWrite();
        EsUnencryptedStoredCredentials$UnencryptedStoredCredentials.m7483n((EsUnencryptedStoredCredentials$UnencryptedStoredCredentials) this.instance, cvaVar);
    }
    ...
    public final void m83731q(String str) {
        copyOnWrite();
        EsUnencryptedStoredCredentials$UnencryptedStoredCredentials.m7484o((EsUnencryptedStoredCredentials$UnencryptedStoredCredentials) this.instance, str);
    }
