...
import com.spotify.widgets.recommendationswidget.events.proto.NpvRecommendationsWidgetLifecycleEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes11.dex */
public final class ygk0 extends AbstractC0268g implements sre0 {
    ...
    public final void m93598m(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23107n((NpvRecommendationsWidgetLifecycleEvent) this.instance, str);
    }
    ...
    public final void m93599q(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23108o((NpvRecommendationsWidgetLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m93600r(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23109p((NpvRecommendationsWidgetLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m93601s(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23110q((NpvRecommendationsWidgetLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m93602t(String str) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23111r((NpvRecommendationsWidgetLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m93603u(long j) {
        copyOnWrite();
        NpvRecommendationsWidgetLifecycleEvent.m23112s((NpvRecommendationsWidgetLifecycleEvent) this.instance, j);
    }
