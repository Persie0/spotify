...
import com.spotify.libs.sociallistening.events.proto.JamNearbyBroadcastStarted;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class v460 extends AbstractC0268g implements sre0 {
    ...
    public final void m84634m(String str) {
        copyOnWrite();
        JamNearbyBroadcastStarted.m12823n((JamNearbyBroadcastStarted) this.instance, str);
    }
    ...
    public final void m84635q(String str) {
        copyOnWrite();
        JamNearbyBroadcastStarted.m12824o((JamNearbyBroadcastStarted) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84636r(String str) {
        copyOnWrite();
        JamNearbyBroadcastStarted.m12825p((JamNearbyBroadcastStarted) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m84637s(String str) {
        copyOnWrite();
        JamNearbyBroadcastStarted.m12826q((JamNearbyBroadcastStarted) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m84638t(String str) {
        copyOnWrite();
        JamNearbyBroadcastStarted.m12827r((JamNearbyBroadcastStarted) this.instance, str);
    }
