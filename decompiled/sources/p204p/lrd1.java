...
public final class lrd1 extends AbstractC0268g implements sre0 {
    ...
    public final void m59798m(String str) {
        copyOnWrite();
        WhereToPlayClientRecommendationNotDisplayed.m14842n((WhereToPlayClientRecommendationNotDisplayed) this.instance, str);
    }
    ...
    public final void m59799q(String str) {
        copyOnWrite();
        WhereToPlayClientRecommendationNotDisplayed.m14843o((WhereToPlayClientRecommendationNotDisplayed) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m59800r(boolean z) {
        copyOnWrite();
        WhereToPlayClientRecommendationNotDisplayed.m14844p((WhereToPlayClientRecommendationNotDisplayed) this.instance, z);
    }
