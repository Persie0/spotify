...
public final class oqa1 extends AbstractC0268g implements sre0 {
    ...
    public final void m67610m(Duration duration) {
        copyOnWrite();
        UserHighlightChange.m22120n((UserHighlightChange) this.instance, duration);
    }
    ...
    public final void m67611q(EntityReference entityReference) {
        copyOnWrite();
        UserHighlightChange.m22121o((UserHighlightChange) this.instance, entityReference);
    }

    /* JADX INFO: renamed from: r */
    public final void m67612r(Duration duration) {
        copyOnWrite();
        UserHighlightChange.m22122p((UserHighlightChange) this.instance, duration);
    }

    /* JADX INFO: renamed from: s */
    public final void m67613s(String str) {
        copyOnWrite();
        UserHighlightChange.m22123q((UserHighlightChange) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m67614t(String str) {
        copyOnWrite();
        UserHighlightChange.m22124r((UserHighlightChange) this.instance, str);
    }
