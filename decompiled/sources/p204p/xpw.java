...
import com.spotify.connectivity.websocket.esperanto.proto.EsWebsocketEvent$WebSocketEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class xpw extends AbstractC0268g implements sre0 {
    ...
    public final void m91722m(cva cvaVar) {
        copyOnWrite();
        EsWebsocketEvent$WebSocketEvent.m7736n((EsWebsocketEvent$WebSocketEvent) this.instance, cvaVar);
    }
    ...
    public final void m91723q() {
        copyOnWrite();
        EsWebsocketEvent$WebSocketEvent.m7737o((EsWebsocketEvent$WebSocketEvent) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m91724r() {
        copyOnWrite();
        EsWebsocketEvent$WebSocketEvent.m7738p((EsWebsocketEvent$WebSocketEvent) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m91725s(wpw wpwVar) {
        copyOnWrite();
        EsWebsocketEvent$WebSocketEvent.m7739q((EsWebsocketEvent$WebSocketEvent) this.instance, wpwVar);
    }

    /* JADX INFO: renamed from: t */
    public final void m91726t(String str) {
        copyOnWrite();
        EsWebsocketEvent$WebSocketEvent.m7740r((EsWebsocketEvent$WebSocketEvent) this.instance, str);
    }
