...
import com.spotify.libs.connect.events.proto.BLEDeviceDiscoverySnapshot;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class eg8 extends AbstractC0268g implements sre0 {
    ...
    public final void m38810m(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12661n((BLEDeviceDiscoverySnapshot) this.instance, str);
    }
    ...
    public final void m38811q(int i) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12662o((BLEDeviceDiscoverySnapshot) this.instance, i);
    }

    /* JADX INFO: renamed from: r */
    public final void m38812r(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12663p((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m38813s(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12664q((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m38814t(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12665r((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m38815u(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12666s((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m38816v(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12667t((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m38817w(int i) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12668u((BLEDeviceDiscoverySnapshot) this.instance, i);
    }

    /* JADX INFO: renamed from: x */
    public final void m38818x(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12669v((BLEDeviceDiscoverySnapshot) this.instance, str);
    }

    /* JADX INFO: renamed from: y */
    public final void m38819y(String str) {
        copyOnWrite();
        BLEDeviceDiscoverySnapshot.m12670w((BLEDeviceDiscoverySnapshot) this.instance, str);
    }
