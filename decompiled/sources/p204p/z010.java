...
public final class z010 extends AbstractC0268g implements sre0 {
    public z010() {
    ...
    public final void m95003m(CustomData customData) {
        copyOnWrite();
        GenerateUrlRequest.m21013n((GenerateUrlRequest) this.instance, customData);
    }
    ...
    public final void m95004q(LinkPreview linkPreview) {
        copyOnWrite();
        GenerateUrlRequest.m21014o((GenerateUrlRequest) this.instance, linkPreview);
    }

    /* JADX INFO: renamed from: r */
    public final void m95005r(String str) {
        copyOnWrite();
        GenerateUrlRequest.m21015p((GenerateUrlRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m95006s(UtmParameters utmParameters) {
        copyOnWrite();
        GenerateUrlRequest.m21016q((GenerateUrlRequest) this.instance, utmParameters);
    }
