...
import com.spotify.agentgateway.p016v1.UserContext;
import java.io.InputStream;

/* JADX INFO: loaded from: classes4.dex */
public final class w710 extends AbstractC0268g implements sre0 {
    public w710() {
        super(GetConversationStartersRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m87310m(String str) {
        copyOnWrite();
        GetConversationStartersRequest.m2918n((GetConversationStartersRequest) this.instance, str);
    }
    ...
    public final void m87311q(boolean z) {
        copyOnWrite();
        GetConversationStartersRequest.m2919o((GetConversationStartersRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m87312r(UserContext userContext) {
        copyOnWrite();
        GetConversationStartersRequest.m2920p((GetConversationStartersRequest) this.instance, userContext);
    }

    /* JADX INFO: renamed from: s */
    public final void m87313s(String str) {
        copyOnWrite();
        GetConversationStartersRequest.m2921q((GetConversationStartersRequest) this.instance, str);
    }
