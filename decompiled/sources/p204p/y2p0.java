...
public final class y2p0 extends AbstractC0268g implements sre0 {
    ...
    public final void m92710m(p2p0 p2p0Var) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$SetShuffleStateRequest.m17601n((PlaybackSettingsEsperantoService$SetShuffleStateRequest) this.instance, p2p0Var);
    }
    ...
    public final void m92711q(String str) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$SetShuffleStateRequest.m17602o((PlaybackSettingsEsperantoService$SetShuffleStateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m92712r(boolean z) {
        copyOnWrite();
        PlaybackSettingsEsperantoService$SetShuffleStateRequest.m17603p((PlaybackSettingsEsperantoService$SetShuffleStateRequest) this.instance, z);
    }
