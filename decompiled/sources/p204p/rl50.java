...
public final class rl50 extends AbstractC0268g implements sre0 {
    ...
    public final void m75812m(List list) {
        copyOnWrite();
        InvalidateCacheRequest.m13426n((InvalidateCacheRequest) this.instance, list);
    }
    ...
    public final void m75813q(String str) {
        copyOnWrite();
        InvalidateCacheRequest.m13427o((InvalidateCacheRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m75814r(ntx ntxVar) {
        copyOnWrite();
        InvalidateCacheRequest.m13428p((InvalidateCacheRequest) this.instance, ntxVar);
    }
