...
public final class nmq0 extends AbstractC0268g implements sre0 {
    ...
    public final void m65152m(CTAClickEvent cTAClickEvent) {
        copyOnWrite();
        PremiumOfferCTA.m19677n((PremiumOfferCTA) this.instance, cTAClickEvent);
    }
    ...
    public final void m65153q(FlavorPageViewModel flavorPageViewModel) {
        copyOnWrite();
        PremiumOfferCTA.m19678o((PremiumOfferCTA) this.instance, flavorPageViewModel);
    }

    /* JADX INFO: renamed from: r */
    public final void m65154r(LoggingInfo loggingInfo) {
        copyOnWrite();
        PremiumOfferCTA.m19679p((PremiumOfferCTA) this.instance, loggingInfo);
    }

    /* JADX INFO: renamed from: s */
    public final void m65155s(String str) {
        copyOnWrite();
        PremiumOfferCTA.m19680q((PremiumOfferCTA) this.instance, str);
    }
