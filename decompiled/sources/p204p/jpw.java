...
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficConnectionInfo$ConnectionInfo;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficEvents$RequestReadyEvent;
import com.spotify.connectivity.traffic.esperanto.proto.EsTrafficRequestInfo$RequestInfo;
import java.io.InputStream;

/* JADX INFO: loaded from: classes.dex */
public final class jpw extends AbstractC0268g implements sre0 {
    ...
    public final void m53975m(EsTrafficConnectionInfo$ConnectionInfo esTrafficConnectionInfo$ConnectionInfo) {
        copyOnWrite();
        EsTrafficEvents$RequestReadyEvent.m7641n((EsTrafficEvents$RequestReadyEvent) this.instance, esTrafficConnectionInfo$ConnectionInfo);
    }
    ...
    public final void m53976q(EsTrafficRequestInfo$RequestInfo esTrafficRequestInfo$RequestInfo) {
        copyOnWrite();
        EsTrafficEvents$RequestReadyEvent.m7642o((EsTrafficEvents$RequestReadyEvent) this.instance, esTrafficRequestInfo$RequestInfo);
    }
