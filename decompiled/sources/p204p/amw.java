...
public final class amw extends AbstractC0268g implements sre0 {
    ...
    public final void m26448m(List list) {
        copyOnWrite();
        EsOffline$DownloadRequest.m16122n((EsOffline$DownloadRequest) this.instance, list);
    }
    ...
    public final void m26449q(ylw ylwVar) {
        copyOnWrite();
        EsOffline$DownloadRequest.m16123o((EsOffline$DownloadRequest) this.instance, (EsOffline$DeviceKey) ylwVar.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m26450r(String str) {
        copyOnWrite();
        EsOffline$DownloadRequest.m16124p((EsOffline$DownloadRequest) this.instance, str);
    }
