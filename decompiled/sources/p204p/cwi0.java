...
import com.spotify.showcase.showcase.events.proto.NativeAdsShowcaseRenderType;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class cwi0 extends AbstractC0268g implements sre0 {
    ...
    public final void m34136m(String str) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21276n((NativeAdsShowcaseRenderType) this.instance, str);
    }
    ...
    public final void m34137q(String str) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21277o((NativeAdsShowcaseRenderType) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m34138r(String str) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21278p((NativeAdsShowcaseRenderType) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m34139s(boolean z) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21279q((NativeAdsShowcaseRenderType) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m34140t(boolean z) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21280r((NativeAdsShowcaseRenderType) this.instance, z);
    }

    /* JADX INFO: renamed from: u */
    public final void m34141u(boolean z) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21281s((NativeAdsShowcaseRenderType) this.instance, z);
    }

    /* JADX INFO: renamed from: v */
    public final void m34142v(String str) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21282t((NativeAdsShowcaseRenderType) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m34143w() {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21283u((NativeAdsShowcaseRenderType) this.instance);
    }

    /* JADX INFO: renamed from: x */
    public final void m34144x(boolean z) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21284v((NativeAdsShowcaseRenderType) this.instance, z);
    }

    /* JADX INFO: renamed from: y */
    public final void m34145y(fwi0 fwi0Var) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21285w((NativeAdsShowcaseRenderType) this.instance, fwi0Var);
    }

    /* JADX INFO: renamed from: z */
    public final void m34146z(gwi0 gwi0Var) {
        copyOnWrite();
        NativeAdsShowcaseRenderType.m21286x((NativeAdsShowcaseRenderType) this.instance, gwi0Var);
    }
