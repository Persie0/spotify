...
import com.spotify.app.music.scaffolds.events.proto.SavedStateSizeTelemetry;
import java.io.InputStream;
import java.util.LinkedHashMap;

/* JADX INFO: loaded from: classes3.dex */
public final class j9y0 extends AbstractC0268g implements sre0 {
    ...
    public final void m52770m(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        SavedStateSizeTelemetry.m3263n((SavedStateSizeTelemetry) this.instance).putAll(linkedHashMap);
    }
    ...
    public final void m52771q(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        SavedStateSizeTelemetry.m3264o((SavedStateSizeTelemetry) this.instance).putAll(linkedHashMap);
    }

    /* JADX INFO: renamed from: r */
    public final void m52772r(String str) {
        copyOnWrite();
        SavedStateSizeTelemetry.m3265p((SavedStateSizeTelemetry) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m52773s(String str) {
        copyOnWrite();
        SavedStateSizeTelemetry.m3266q((SavedStateSizeTelemetry) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m52774t(long j) {
        copyOnWrite();
        SavedStateSizeTelemetry.m3267r((SavedStateSizeTelemetry) this.instance, j);
    }
