...
public final class x4v0 extends AbstractC0268g implements sre0 {
    ...
    public final void m89908m(String str) {
        copyOnWrite();
        RecentsDataSourceErrorEvent.m20342n((RecentsDataSourceErrorEvent) this.instance, str);
    }
    ...
    public final void m89909q(String str) {
        copyOnWrite();
        RecentsDataSourceErrorEvent.m20343o((RecentsDataSourceErrorEvent) this.instance, str);
    }
