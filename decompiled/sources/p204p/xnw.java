...
public final class xnw extends AbstractC0268g implements sre0 {
    public xnw() {
        super(EsRecaptchaInfo$RecaptchaInfo.DEFAULT_INSTANCE);
    }
    ...
    public final void m91517m(String str) {
        copyOnWrite();
        EsRecaptchaInfo$RecaptchaInfo.m3635n((EsRecaptchaInfo$RecaptchaInfo) this.instance, str);
    }
    ...
    public final void m91518q(String str) {
        copyOnWrite();
        EsRecaptchaInfo$RecaptchaInfo.m3636o((EsRecaptchaInfo$RecaptchaInfo) this.instance, str);
    }
