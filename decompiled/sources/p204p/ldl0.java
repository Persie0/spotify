...
public final class ldl0 extends AbstractC0268g implements sre0 {
    ...
    public final void m58742m(String str) {
        copyOnWrite();
        OnSurfaceAdsEvent.m2815n((OnSurfaceAdsEvent) this.instance, str);
    }
    ...
    public final void m58743q(String str) {
        copyOnWrite();
        OnSurfaceAdsEvent.m2816o((OnSurfaceAdsEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m58744r(String str) {
        copyOnWrite();
        OnSurfaceAdsEvent.m2817p((OnSurfaceAdsEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m58745s(String str) {
        copyOnWrite();
        OnSurfaceAdsEvent.m2818q((OnSurfaceAdsEvent) this.instance, str);
    }
