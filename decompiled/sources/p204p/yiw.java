...
public final class yiw extends AbstractC0268g implements sre0 {
    public yiw() {
        super(EsConnectionAvailability$ConnectionAvailability.DEFAULT_INSTANCE);
    }
    ...
    public final void m93831m(boolean z) {
        copyOnWrite();
        EsConnectionAvailability$ConnectionAvailability.m7549n((EsConnectionAvailability$ConnectionAvailability) this.instance, z);
    }
    ...
    public final void m93832q(boolean z) {
        copyOnWrite();
        EsConnectionAvailability$ConnectionAvailability.m7550o((EsConnectionAvailability$ConnectionAvailability) this.instance, z);
    }
