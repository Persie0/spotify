...
import com.spotify.smartshuffle.loggingimpl.events.proto.SmartShuffleOperationResultAction;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes10.dex */
public final class m231 extends AbstractC0268g implements sre0 {
    ...
    public final void m60562m(ArrayList arrayList) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21418n((SmartShuffleOperationResultAction) this.instance, arrayList);
    }
    ...
    public final void m60563q(String str) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21419o((SmartShuffleOperationResultAction) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m60564r(String str) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21420p((SmartShuffleOperationResultAction) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m60565s(boolean z) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21421q((SmartShuffleOperationResultAction) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m60566t(String str) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21422r((SmartShuffleOperationResultAction) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m60567u(boolean z) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21423s((SmartShuffleOperationResultAction) this.instance, z);
    }

    /* JADX INFO: renamed from: v */
    public final void m60568v() {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21424t((SmartShuffleOperationResultAction) this.instance);
    }

    /* JADX INFO: renamed from: w */
    public final void m60569w(String str) {
        copyOnWrite();
        SmartShuffleOperationResultAction.m21425u((SmartShuffleOperationResultAction) this.instance, str);
    }
