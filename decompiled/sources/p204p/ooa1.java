...
public final class ooa1 extends AbstractC0268g implements sre0 {
    ...
    public final void m67465m(String str) {
        copyOnWrite();
        UserContext.m2990n((UserContext) this.instance, str);
    }
    ...
    public final void m67466q(String str) {
        copyOnWrite();
        UserContext.m2991o((UserContext) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m67467r(String str) {
        copyOnWrite();
        UserContext.m2992p((UserContext) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m67468s(boolean z) {
        copyOnWrite();
        UserContext.m2993q((UserContext) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m67469t(String str) {
        copyOnWrite();
        UserContext.m2994r((UserContext) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m67470u(int i) {
        copyOnWrite();
        UserContext.m2995s((UserContext) this.instance, i);
    }
