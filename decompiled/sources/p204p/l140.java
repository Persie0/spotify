...
public final class l140 extends AbstractC0268g implements sre0 {
    public l140() {
        super(Identity$UserProfileUpdateRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m57863m(juy juyVar) {
        copyOnWrite();
        Identity$UserProfileUpdateRequest.m11954n((Identity$UserProfileUpdateRequest) this.instance, (FieldMask) juyVar.build());
    }
    ...
    public final void m57864q(k140 k140Var) {
        copyOnWrite();
        Identity$UserProfileUpdateRequest.m11955o((Identity$UserProfileUpdateRequest) this.instance, (Identity$UserProfile) k140Var.build());
    }
