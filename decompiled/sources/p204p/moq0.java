...
import com.spotify.premiummarketing.premiumdestinationpage.p130v1.PremiumPageHeader;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class moq0 extends AbstractC0268g implements sre0 {
    ...
    public final void m62409m(String str) {
        copyOnWrite();
        PremiumPageHeader.m19719n((PremiumPageHeader) this.instance, str);
    }
    ...
    public final void m62410q(String str) {
        copyOnWrite();
        PremiumPageHeader.m19720o((PremiumPageHeader) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m62411r(LoggingInfo loggingInfo) {
        copyOnWrite();
        PremiumPageHeader.m19721p((PremiumPageHeader) this.instance, loggingInfo);
    }

    /* JADX INFO: renamed from: s */
    public final void m62412s(String str) {
        copyOnWrite();
        PremiumPageHeader.m19722q((PremiumPageHeader) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m62413t(String str) {
        copyOnWrite();
        PremiumPageHeader.m19723r((PremiumPageHeader) this.instance, str);
    }
