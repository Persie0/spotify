...
import com.spotify.lyrics.fullscreenview.events.proto.LyricsErrorReportingEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class tdb0 extends AbstractC0268g implements sre0 {
    ...
    public final void m80498m(String str) {
        copyOnWrite();
        LyricsErrorReportingEvent.m13311n((LyricsErrorReportingEvent) this.instance, str);
    }
    ...
    public final void m80499q(String str) {
        copyOnWrite();
        LyricsErrorReportingEvent.m13312o((LyricsErrorReportingEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m80500r(String str) {
        copyOnWrite();
        LyricsErrorReportingEvent.m13313p((LyricsErrorReportingEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m80501s(String str) {
        copyOnWrite();
        LyricsErrorReportingEvent.m13314q((LyricsErrorReportingEvent) this.instance, str);
    }
