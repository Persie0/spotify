...
public final class vr6 extends AbstractC0268g implements sre0 {
    ...
    public final void m86275m(String str) {
        copyOnWrite();
        AtvRemoteServiceOuterClass$AtvStartPairingRequest.m3362n((AtvRemoteServiceOuterClass$AtvStartPairingRequest) this.instance, str);
    }
    ...
    public final void m86276q(String str) {
        copyOnWrite();
        AtvRemoteServiceOuterClass$AtvStartPairingRequest.m3363o((AtvRemoteServiceOuterClass$AtvStartPairingRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m86277r(int i) {
        copyOnWrite();
        AtvRemoteServiceOuterClass$AtvStartPairingRequest.m3364p((AtvRemoteServiceOuterClass$AtvStartPairingRequest) this.instance, i);
    }
