...
public final class uvi extends AbstractC0268g implements sre0 {
    ...
    public final void m84060m(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7455n((ConnectSmartControlLifecycleEvent) this.instance, str);
    }
    ...
    public final void m84061q(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7456o((ConnectSmartControlLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m84062r(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7457p((ConnectSmartControlLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m84063s(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7458q((ConnectSmartControlLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m84064t(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7459r((ConnectSmartControlLifecycleEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m84065u(String str) {
        copyOnWrite();
        ConnectSmartControlLifecycleEvent.m7460s((ConnectSmartControlLifecycleEvent) this.instance, str);
    }
