...
import com.spotify.adonappopen.logger.events.proto.AdOnAppOpenClientEvent;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes4.dex */
public final class zq0 extends AbstractC0268g implements sre0 {
    ...
    public final void m96701m(List list) {
        copyOnWrite();
        AdOnAppOpenClientEvent.m2544n((AdOnAppOpenClientEvent) this.instance, list);
    }
    ...
    public final void m96702q(String str) {
        copyOnWrite();
        AdOnAppOpenClientEvent.m2545o((AdOnAppOpenClientEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m96703r(String str) {
        copyOnWrite();
        AdOnAppOpenClientEvent.m2546p((AdOnAppOpenClientEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m96704s(String str) {
        copyOnWrite();
        AdOnAppOpenClientEvent.m2547q((AdOnAppOpenClientEvent) this.instance, str);
    }
