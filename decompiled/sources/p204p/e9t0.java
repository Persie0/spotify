...
import com.spotify.messages.PuffinHeadphonesNotSupportedEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class e9t0 extends AbstractC0268g implements sre0 {
    ...
    public final void m38263m(String str) {
        copyOnWrite();
        PuffinHeadphonesNotSupportedEvent.m14357n((PuffinHeadphonesNotSupportedEvent) this.instance, str);
    }
    ...
    public final void m38264q(String str) {
        copyOnWrite();
        PuffinHeadphonesNotSupportedEvent.m14358o((PuffinHeadphonesNotSupportedEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m38265r(String str) {
        copyOnWrite();
        PuffinHeadphonesNotSupportedEvent.m14359p((PuffinHeadphonesNotSupportedEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m38266s(boolean z) {
        copyOnWrite();
        PuffinHeadphonesNotSupportedEvent.m14360q((PuffinHeadphonesNotSupportedEvent) this.instance, z);
    }
