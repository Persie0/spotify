...
public final class a501 extends AbstractC0268g implements sre0 {
    public a501() {
        super(SetChildAccountSettingsRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m24739m(String str) {
        copyOnWrite();
        SetChildAccountSettingsRequest.m12098n((SetChildAccountSettingsRequest) this.instance, str);
    }
    ...
    public final void m24740q(String str) {
        copyOnWrite();
        SetChildAccountSettingsRequest.m12099o((SetChildAccountSettingsRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m24741r(String str) {
        copyOnWrite();
        SetChildAccountSettingsRequest.m12100p((SetChildAccountSettingsRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m24742s(boolean z) {
        copyOnWrite();
        SetChildAccountSettingsRequest.m12101q((SetChildAccountSettingsRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m24743t(boolean z) {
        copyOnWrite();
        SetChildAccountSettingsRequest.m12102r((SetChildAccountSettingsRequest) this.instance, z);
    }
