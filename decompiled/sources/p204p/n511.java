...
public final class n511 extends AbstractC0268g implements sre0 {
    ...
    public final void m63698m(List list) {
        copyOnWrite();
        ShareStatsRequest.m11313n((ShareStatsRequest) this.instance, list);
    }
    ...
    public final void m63699q(Timestamp timestamp) {
        copyOnWrite();
        ShareStatsRequest.m11314o((ShareStatsRequest) this.instance, timestamp);
    }

    /* JADX INFO: renamed from: r */
    public final void m63700r(String str) {
        copyOnWrite();
        ShareStatsRequest.m11315p((ShareStatsRequest) this.instance, str);
    }
