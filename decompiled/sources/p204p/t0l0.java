...
import com.spotify.betamax.offlinecoordinator.proto.OfflinePlugin$DownloadResponse;
import com.spotify.betamax.offlinecoordinator.proto.OfflinePlugin$IdentifyResponse;
import com.spotify.betamax.offlinecoordinator.proto.OfflinePlugin$PluginResponse;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class t0l0 extends AbstractC0268g implements sre0 {
    public t0l0() {
        super(OfflinePlugin$PluginResponse.DEFAULT_INSTANCE);
    }
    ...
    public final void m79839m(OfflinePlugin$DownloadResponse offlinePlugin$DownloadResponse) {
        copyOnWrite();
        OfflinePlugin$PluginResponse.m4008n((OfflinePlugin$PluginResponse) this.instance, offlinePlugin$DownloadResponse);
    }
    ...
    public final void m79840q() {
        copyOnWrite();
        OfflinePlugin$PluginResponse.m4009o((OfflinePlugin$PluginResponse) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m79841r(OfflinePlugin$IdentifyResponse offlinePlugin$IdentifyResponse) {
        copyOnWrite();
        OfflinePlugin$PluginResponse.m4010p((OfflinePlugin$PluginResponse) this.instance, offlinePlugin$IdentifyResponse);
    }
