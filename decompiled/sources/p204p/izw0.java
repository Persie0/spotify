...
import com.spotify.rcs.resolver.grpc.p141v0.C1274h;
import com.spotify.rcs.resolver.grpc.p141v0.Context;
import com.spotify.rcs.resolver.grpc.p141v0.Fetch;
import com.spotify.rcs.resolver.grpc.p141v0.ResolveRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes2.dex */
public final class izw0 extends AbstractC0268g implements sre0 {
    ...
    public final void m52031m(C1274h c1274h) {
        copyOnWrite();
        ResolveRequest.m20145n((ResolveRequest) this.instance, (Context) c1274h.build());
    }
    ...
    public final void m52032q(Fetch fetch) {
        copyOnWrite();
        ResolveRequest.m20146o((ResolveRequest) this.instance, fetch);
    }

    /* JADX INFO: renamed from: r */
    public final void m52033r() {
        copyOnWrite();
        ResolveRequest.m20147p((ResolveRequest) this.instance);
    }
