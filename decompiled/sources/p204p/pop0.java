...
import com.spotify.playlist.proto.PlaylistRequest$NumberOfItemsForLinkType;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class pop0 extends AbstractC0268g implements qop0 {
    public pop0() {
        super(PlaylistRequest$NumberOfItemsForLinkType.DEFAULT_INSTANCE);
    }
    ...
    public final hn80 mo18610h() {
        return ((PlaylistRequest$NumberOfItemsForLinkType) this.instance).mo18610h();
    }

    @Override // p204p.qop0
    /* JADX INFO: renamed from: i */
    public final int mo18611i() {
        return ((PlaylistRequest$NumberOfItemsForLinkType) this.instance).mo18611i();
    }
