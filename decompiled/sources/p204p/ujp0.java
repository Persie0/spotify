...
public final class ujp0 extends AbstractC0268g implements sre0 {
    ...
    public final void m83290m(Iterable iterable) {
        copyOnWrite();
        PlaylistExtender.m13032n((PlaylistExtender) this.instance, iterable);
    }
    ...
    public final void m83291q(String str) {
        copyOnWrite();
        PlaylistExtender.m13033o((PlaylistExtender) this.instance, str);
    }
