...
public final class now extends AbstractC0268g implements sre0 {
    ...
    public final void m65251m(LinkedHashMap linkedHashMap) {
        copyOnWrite();
        EsSession$ProductStateMap.m7494n((EsSession$ProductStateMap) this.instance).putAll(linkedHashMap);
    }
