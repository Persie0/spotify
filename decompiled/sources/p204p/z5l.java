...
public final class z5l extends AbstractC0268g implements sre0 {
    public z5l() {
        super(CreateDowngradeCheckoutRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m95464m(String str) {
        copyOnWrite();
        CreateDowngradeCheckoutRequest.m10688n((CreateDowngradeCheckoutRequest) this.instance, str);
    }
    ...
    public final void m95465q(boolean z) {
        copyOnWrite();
        CreateDowngradeCheckoutRequest.m10689o((CreateDowngradeCheckoutRequest) this.instance, z);
    }
