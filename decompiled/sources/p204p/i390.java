...
import com.spotify.messages.ListRouting;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class i390 extends AbstractC0268g implements sre0 {
    ...
    public final void m49575m(String str) {
        copyOnWrite();
        ListRouting.m13916n((ListRouting) this.instance, str);
    }
    ...
    public final void m49576q(boolean z) {
        copyOnWrite();
        ListRouting.m13917o((ListRouting) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m49577r(String str) {
        copyOnWrite();
        ListRouting.m13918p((ListRouting) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m49578s(String str) {
        copyOnWrite();
        ListRouting.m13919q((ListRouting) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m49579t(String str) {
        copyOnWrite();
        ListRouting.m13920r((ListRouting) this.instance, str);
    }
