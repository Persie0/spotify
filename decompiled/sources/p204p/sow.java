...
public final class sow extends AbstractC0268g implements sre0 {
    ...
    public final void m78839m(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSetShufflingContext$SetShufflingContextRequest.m17975n((EsSetShufflingContext$SetShufflingContextRequest) this.instance, esLoggingParams$LoggingParams);
    }
    ...
    public final void m78840q(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSetShufflingContext$SetShufflingContextRequest.m17976o((EsSetShufflingContext$SetShufflingContextRequest) this.instance, esCommandOptions$CommandOptions);
    }

    /* JADX INFO: renamed from: r */
    public final void m78841r(boolean z) {
        copyOnWrite();
        EsSetShufflingContext$SetShufflingContextRequest.m17977p((EsSetShufflingContext$SetShufflingContextRequest) this.instance, z);
    }
