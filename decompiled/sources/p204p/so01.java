...
public final class so01 extends AbstractC0268g implements sre0 {
    ...
    public final void m78602m(int i) {
        copyOnWrite();
        ShareDebugError.m21091n((ShareDebugError) this.instance, i);
    }
    ...
    public final void m78603q(String str) {
        copyOnWrite();
        ShareDebugError.m21092o((ShareDebugError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m78604r(String str) {
        copyOnWrite();
        ShareDebugError.m21093p((ShareDebugError) this.instance, str);
    }
