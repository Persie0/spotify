...
public final class sos0 extends AbstractC0268g implements sre0 {
    ...
    public final void m78836m(Promptableplaylist$AttributeUpdate promptableplaylist$AttributeUpdate) {
        copyOnWrite();
        Promptableplaylist$EditPromptablePlaylistRequest.m98021n((Promptableplaylist$EditPromptablePlaylistRequest) this.instance, promptableplaylist$AttributeUpdate);
    }
    ...
    public final void m78837q(boolean z) {
        copyOnWrite();
        Promptableplaylist$EditPromptablePlaylistRequest.m98022o((Promptableplaylist$EditPromptablePlaylistRequest) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m78838r(String str) {
        copyOnWrite();
        Promptableplaylist$EditPromptablePlaylistRequest.m98023p((Promptableplaylist$EditPromptablePlaylistRequest) this.instance, str);
    }
