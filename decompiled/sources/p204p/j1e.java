...
import com.spotify.payment.paymentimpl.events.proto.CheckoutViewJS;
import java.io.InputStream;
import java.util.ArrayList;

/* JADX INFO: loaded from: classes9.dex */
public final class j1e extends AbstractC0268g implements sre0 {
    ...
    public final void m52127m(ArrayList arrayList) {
        copyOnWrite();
        CheckoutViewJS.m16946n((CheckoutViewJS) this.instance, arrayList);
    }
    ...
    public final void m52128q(ArrayList arrayList) {
        copyOnWrite();
        CheckoutViewJS.m16947o((CheckoutViewJS) this.instance, arrayList);
    }

    /* JADX INFO: renamed from: r */
    public final void m52129r(String str) {
        copyOnWrite();
        CheckoutViewJS.m16948p((CheckoutViewJS) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m52130s(String str) {
        copyOnWrite();
        CheckoutViewJS.m16949q((CheckoutViewJS) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m52131t(String str) {
        copyOnWrite();
        CheckoutViewJS.m16950r((CheckoutViewJS) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m52132u(String str) {
        copyOnWrite();
        CheckoutViewJS.m16951s((CheckoutViewJS) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m52133v(boolean z) {
        copyOnWrite();
        CheckoutViewJS.m16952t((CheckoutViewJS) this.instance, z);
    }

    /* JADX INFO: renamed from: w */
    public final void m52134w(int i) {
        copyOnWrite();
        CheckoutViewJS.m16953u((CheckoutViewJS) this.instance, i);
    }

    /* JADX INFO: renamed from: x */
    public final void m52135x(String str) {
        copyOnWrite();
        CheckoutViewJS.m16954v((CheckoutViewJS) this.instance, str);
    }

    /* JADX INFO: renamed from: y */
    public final void m52136y(String str) {
        copyOnWrite();
        CheckoutViewJS.m16955w((CheckoutViewJS) this.instance, str);
    }
