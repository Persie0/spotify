...
public final class r50 extends AbstractC0268g implements sre0 {
    public r50() {
        super(ActionRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m74779m(C2318qy c2318qy) {
        copyOnWrite();
        ActionRequest.m9123n((ActionRequest) this.instance, (Action) c2318qy.build());
    }
    ...
    public final void m74780q(String str) {
        copyOnWrite();
        ActionRequest.m9124o((ActionRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m74781r(String str) {
        copyOnWrite();
        ActionRequest.m9125p((ActionRequest) this.instance, str);
    }
