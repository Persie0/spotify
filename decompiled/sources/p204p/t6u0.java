...
public final class t6u0 extends AbstractC0268g implements sre0 {
    ...
    public final void m80166m() {
        copyOnWrite();
        RateQuestionRequest.m15906n((RateQuestionRequest) this.instance);
    }
    ...
    public final void m80167q(ijt0 ijt0Var) {
        copyOnWrite();
        RateQuestionRequest.m15907o((RateQuestionRequest) this.instance, (QuestionFeedback) ijt0Var.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m80168r(String str) {
        copyOnWrite();
        RateQuestionRequest.m15908p((RateQuestionRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m80169s(String str) {
        copyOnWrite();
        RateQuestionRequest.m15909q((RateQuestionRequest) this.instance, str);
    }
