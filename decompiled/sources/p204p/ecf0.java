...
import com.spotify.messages.MetricMeasurement;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes8.dex */
public final class ecf0 extends AbstractC0268g implements sre0 {
    ...
    public final void m38494m(Map map) {
        copyOnWrite();
        MetricMeasurement.m14237n((MetricMeasurement) this.instance).putAll(map);
    }
    ...
    public final void m38495q(Map map) {
        copyOnWrite();
        MetricMeasurement.m14238o((MetricMeasurement) this.instance).putAll(map);
    }

    /* JADX INFO: renamed from: r */
    public final void m38496r(Map map) {
        copyOnWrite();
        MetricMeasurement.m14239p((MetricMeasurement) this.instance).putAll(map);
    }

    /* JADX INFO: renamed from: s */
    public final void m38497s() {
        copyOnWrite();
        MetricMeasurement.m14240q((MetricMeasurement) this.instance);
    }

    /* JADX INFO: renamed from: t */
    public final void m38498t() {
        copyOnWrite();
        MetricMeasurement.m14241r((MetricMeasurement) this.instance);
    }

    /* JADX INFO: renamed from: u */
    public final void m38499u(String str) {
        copyOnWrite();
        MetricMeasurement.m14242s((MetricMeasurement) this.instance, str);
    }
