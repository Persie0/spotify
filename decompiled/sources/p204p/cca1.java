...
public final class cca1 extends AbstractC0268g implements sre0 {
    public cca1() {
        super(UpdateNotificationStateRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m32236m(List list) {
        copyOnWrite();
        UpdateNotificationStateRequest.m11132n((UpdateNotificationStateRequest) this.instance, list);
    }
    ...
    public final void m32237q(String str) {
        copyOnWrite();
        UpdateNotificationStateRequest.m11133o((UpdateNotificationStateRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m32238r(dca1 dca1Var) {
        copyOnWrite();
        UpdateNotificationStateRequest.m11134p((UpdateNotificationStateRequest) this.instance, dca1Var);
    }
