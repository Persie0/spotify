...
public final class jjw extends AbstractC0268g implements sre0 {
    ...
    public final void m53575m(ArrayList arrayList) {
        copyOnWrite();
        EsContextPage$ContextPage.m17676n((EsContextPage$ContextPage) this.instance, arrayList);
    }
    ...
    public final void m53576q(xf40 xf40Var) {
        copyOnWrite();
        EsContextPage$ContextPage.m17677o((EsContextPage$ContextPage) this.instance).putAll(xf40Var);
    }

    /* JADX INFO: renamed from: r */
    public final void m53577r(boolean z) {
        copyOnWrite();
        EsContextPage$ContextPage.m17678p((EsContextPage$ContextPage) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m53578s(String str) {
        copyOnWrite();
        EsContextPage$ContextPage.m17679q((EsContextPage$ContextPage) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m53579t(String str) {
        copyOnWrite();
        EsContextPage$ContextPage.m17680r((EsContextPage$ContextPage) this.instance, str);
    }
