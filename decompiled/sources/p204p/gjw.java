...
public final class gjw extends AbstractC0268g implements sre0 {
    ...
    public final void m44978m(fjw fjwVar) {
        copyOnWrite();
        EsConnectionType$ConnectionType.m7568n((EsConnectionType$ConnectionType) this.instance, fjwVar);
    }
    ...
    public final void m44979q(Empty empty) {
        copyOnWrite();
        EsConnectionType$ConnectionType.m7569o((EsConnectionType$ConnectionType) this.instance, empty);
    }

    /* JADX INFO: renamed from: r */
    public final void m44980r(Empty empty) {
        copyOnWrite();
        EsConnectionType$ConnectionType.m7570p((EsConnectionType$ConnectionType) this.instance, empty);
    }
