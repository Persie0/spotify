...
public final class tfa1 extends AbstractC0268g implements sre0 {
    ...
    public final void m80637m(ImageBytes imageBytes) {
        copyOnWrite();
        UploadImage.m20993n((UploadImage) this.instance, imageBytes);
    }
    ...
    public final void m80638q(Image image) {
        copyOnWrite();
        UploadImage.m20994o((UploadImage) this.instance, image);
    }
