...
import com.spotify.canvaslogger.events.proto.CanvasState;
import java.io.InputStream;

/* JADX INFO: loaded from: classes5.dex */
public final class msb extends AbstractC0268g implements sre0 {
    ...
    public final void m62732m() {
        copyOnWrite();
        CanvasState.m5526n((CanvasState) this.instance);
    }
    ...
    public final void m62733q(String str) {
        copyOnWrite();
        CanvasState.m5527o((CanvasState) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m62734r(String str) {
        copyOnWrite();
        CanvasState.m5528p((CanvasState) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m62735s(String str) {
        copyOnWrite();
        CanvasState.m5529q((CanvasState) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m62736t(String str) {
        copyOnWrite();
        CanvasState.m5530r((CanvasState) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m62737u() {
        copyOnWrite();
        CanvasState.m5531s((CanvasState) this.instance);
    }

    /* JADX INFO: renamed from: v */
    public final void m62738v(cva cvaVar) {
        copyOnWrite();
        CanvasState.m5532t((CanvasState) this.instance, cvaVar);
    }

    /* JADX INFO: renamed from: w */
    public final void m62739w(double d) {
        copyOnWrite();
        CanvasState.m5533u((CanvasState) this.instance, d);
    }

    /* JADX INFO: renamed from: x */
    public final void m62740x() {
        copyOnWrite();
        CanvasState.m5534v((CanvasState) this.instance);
    }
