...
public final class fc10 extends AbstractC0268g implements sre0 {
    ...
    public final void m41273m(int i) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21209n((GetUnfinishedEpisodesRequest) this.instance, i);
    }
    ...
    public final void m41274q(String str) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21210o((GetUnfinishedEpisodesRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m41275r(ListPolicy listPolicy) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21211p((GetUnfinishedEpisodesRequest) this.instance, listPolicy);
    }

    /* JADX INFO: renamed from: s */
    public final void m41276s(int i) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21212q((GetUnfinishedEpisodesRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: t */
    public final void m41277t(int i) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21213r((GetUnfinishedEpisodesRequest) this.instance, i);
    }

    /* JADX INFO: renamed from: u */
    public final void m41278u(double d) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21214s((GetUnfinishedEpisodesRequest) this.instance, d);
    }

    /* JADX INFO: renamed from: v */
    public final void m41279v(String str) {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21215t((GetUnfinishedEpisodesRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m41280w() {
        copyOnWrite();
        GetUnfinishedEpisodesRequest.m21216u((GetUnfinishedEpisodesRequest) this.instance);
    }
