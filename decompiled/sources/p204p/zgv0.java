...
public final class zgv0 extends AbstractC0268g implements sre0 {
    public zgv0() {
        super(RecordHardCapImpressionRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m96106m(String str) {
        copyOnWrite();
        RecordHardCapImpressionRequest.m20378n((RecordHardCapImpressionRequest) this.instance, str);
    }
    ...
    public final void m96107q(ahv0 ahv0Var) {
        copyOnWrite();
        RecordHardCapImpressionRequest.m20379o((RecordHardCapImpressionRequest) this.instance, ahv0Var);
    }

    /* JADX INFO: renamed from: r */
    public final void m96108r(String str) {
        copyOnWrite();
        RecordHardCapImpressionRequest.m20380p((RecordHardCapImpressionRequest) this.instance, str);
    }
