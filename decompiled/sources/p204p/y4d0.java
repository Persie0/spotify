...
public final class y4d0 extends AbstractC0268g implements sre0 {
    ...
    public final void m92811m(z4d0 z4d0Var) {
        copyOnWrite();
        Mdata$LocalBatchedEntityRequest.m97626n((Mdata$LocalBatchedEntityRequest) this.instance, (Mdata$LocalExtensionQuery) z4d0Var.build());
    }
    ...
    public final void m92812q(Mdata$LocalExtensionQuery mdata$LocalExtensionQuery) {
        copyOnWrite();
        Mdata$LocalBatchedEntityRequest.m97626n((Mdata$LocalBatchedEntityRequest) this.instance, mdata$LocalExtensionQuery);
    }
