...
import spotify.playlist.esperanto.proto.PlaylistMultiGetSingleResponse;

/* JADX INFO: loaded from: classes11.dex */
public final class bnp0 extends AbstractC0268g implements cnp0 {
    public bnp0() {
        super(PlaylistMultiGetSingleResponse.DEFAULT_INSTANCE);
    }
    ...
    public final String getId() {
        return ((PlaylistMultiGetSingleResponse) this.instance).getId();
    }

    @Override // p204p.cnp0
    public final String getUri() {
        return ((PlaylistMultiGetSingleResponse) this.instance).getUri();
    }
    ...
    public final PlaylistGetResponse mo30067j() {
        return ((PlaylistMultiGetSingleResponse) this.instance).mo30067j();
    }
