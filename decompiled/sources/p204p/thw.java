...
public final class thw extends AbstractC0268g implements sre0 {
    public thw() {
        super(EsAuthenticateCredentials$FacebookAccessToken.DEFAULT_INSTANCE);
    }
    ...
    public final void m80865m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$FacebookAccessToken.m3515n((EsAuthenticateCredentials$FacebookAccessToken) this.instance, str);
    }
    ...
    public final void m80866q(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$FacebookAccessToken.m3516o((EsAuthenticateCredentials$FacebookAccessToken) this.instance, str);
    }
