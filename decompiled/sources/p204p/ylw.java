...
public final class ylw extends AbstractC0268g implements sre0 {
    public ylw() {
        super(EsOffline$DeviceKey.DEFAULT_INSTANCE);
    }
    ...
    public final void m94174m(String str) {
        copyOnWrite();
        EsOffline$DeviceKey.m16110n((EsOffline$DeviceKey) this.instance, str);
    }
    ...
    public final void m94175q(String str) {
        copyOnWrite();
        EsOffline$DeviceKey.m16111o((EsOffline$DeviceKey) this.instance, str);
    }
