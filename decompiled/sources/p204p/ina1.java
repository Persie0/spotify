...
public final class ina1 extends AbstractC0268g implements sre0 {
    ...
    public final void m51126m(String str) {
        copyOnWrite();
        UserAuthorMetadata.m22263n((UserAuthorMetadata) this.instance, str);
    }
    ...
    public final void m51127q(String str) {
        copyOnWrite();
        UserAuthorMetadata.m22264o((UserAuthorMetadata) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m51128r(String str) {
        copyOnWrite();
        UserAuthorMetadata.m22265p((UserAuthorMetadata) this.instance, str);
    }
