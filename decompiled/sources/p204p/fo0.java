...
import com.spotify.adsdisplay.elementimpl.feedback.events.proto.AdFeedbackEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes4.dex */
public final class fo0 extends AbstractC0268g implements sre0 {
    ...
    public final void m42244m(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2770n((AdFeedbackEvent) this.instance, str);
    }
    ...
    public final void m42245q(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2771o((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m42246r(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2772p((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m42247s(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2773q((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m42248t(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2774r((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m42249u(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2775s((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m42250v(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2776t((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m42251w(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2777u((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m42252x(long j) {
        copyOnWrite();
        AdFeedbackEvent.m2778v((AdFeedbackEvent) this.instance, j);
    }

    /* JADX INFO: renamed from: y */
    public final void m42253y(String str) {
        copyOnWrite();
        AdFeedbackEvent.m2779w((AdFeedbackEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: z */
    public final void m42254z(double d) {
        copyOnWrite();
        AdFeedbackEvent.m2780x((AdFeedbackEvent) this.instance, d);
    }
