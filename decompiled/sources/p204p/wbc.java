...
import com.spotify.libs.connect.events.proto.CastTransferErrors;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class wbc extends AbstractC0268g implements sre0 {
    ...
    public final void m87634m(String str) {
        copyOnWrite();
        CastTransferErrors.m12672n((CastTransferErrors) this.instance, str);
    }
    ...
    public final void m87635q(String str) {
        copyOnWrite();
        CastTransferErrors.m12673o((CastTransferErrors) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m87636r(String str) {
        copyOnWrite();
        CastTransferErrors.m12674p((CastTransferErrors) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m87637s(String str) {
        copyOnWrite();
        CastTransferErrors.m12675q((CastTransferErrors) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m87638t(String str) {
        copyOnWrite();
        CastTransferErrors.m12676r((CastTransferErrors) this.instance, str);
    }
