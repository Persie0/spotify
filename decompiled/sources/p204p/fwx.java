...
public final class fwx extends AbstractC0268g implements sre0 {
    ...
    public final void m42983m(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m5539n((ExternalAccessoryRemoteError) this.instance, str);
    }
    ...
    public final void m42984q(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m5540o((ExternalAccessoryRemoteError) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m42985r() {
        copyOnWrite();
        ExternalAccessoryRemoteError.m5541p((ExternalAccessoryRemoteError) this.instance);
    }

    /* JADX INFO: renamed from: s */
    public final void m42986s(String str) {
        copyOnWrite();
        ExternalAccessoryRemoteError.m5542q((ExternalAccessoryRemoteError) this.instance, str);
    }
