...
public final class phw extends AbstractC0268g implements sre0 {
    ...
    public final void m70051m(EsUnencryptedStoredCredentials$UnencryptedStoredCredentials esUnencryptedStoredCredentials$UnencryptedStoredCredentials) {
        copyOnWrite();
        EsAuthBlob$AuthBlob.m7478n((EsAuthBlob$AuthBlob) this.instance, esUnencryptedStoredCredentials$UnencryptedStoredCredentials);
    }
