...
import com.spotify.libs.connect.events.proto.BLECharacteristicState;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class wc8 extends AbstractC0268g implements sre0 {
    ...
    public final void m87692m() {
        copyOnWrite();
        BLECharacteristicState.m12650n((BLECharacteristicState) this.instance);
    }
    ...
    public final void m87693q() {
        copyOnWrite();
        BLECharacteristicState.m12651o((BLECharacteristicState) this.instance);
    }

    /* JADX INFO: renamed from: r */
    public final void m87694r(int i) {
        copyOnWrite();
        BLECharacteristicState.m12652p((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: s */
    public final void m87695s(int i) {
        copyOnWrite();
        BLECharacteristicState.m12653q((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: t */
    public final void m87696t(String str) {
        copyOnWrite();
        BLECharacteristicState.m12654r((BLECharacteristicState) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m87697u(int i) {
        copyOnWrite();
        BLECharacteristicState.m12655s((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: v */
    public final void m87698v(int i) {
        copyOnWrite();
        BLECharacteristicState.m12656t((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: w */
    public final void m87699w(int i) {
        copyOnWrite();
        BLECharacteristicState.m12657u((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: x */
    public final void m87700x(int i) {
        copyOnWrite();
        BLECharacteristicState.m12658v((BLECharacteristicState) this.instance, i);
    }

    /* JADX INFO: renamed from: y */
    public final void m87701y(String str) {
        copyOnWrite();
        BLECharacteristicState.m12659w((BLECharacteristicState) this.instance, str);
    }
