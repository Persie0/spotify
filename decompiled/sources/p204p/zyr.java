...
import com.spotify.messages.DjInteractivityConnectionClosed;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class zyr extends AbstractC0268g implements sre0 {
    ...
    public final void m97240m(String str) {
        copyOnWrite();
        DjInteractivityConnectionClosed.m13841n((DjInteractivityConnectionClosed) this.instance, str);
    }
    ...
    public final void m97241q(boolean z) {
        copyOnWrite();
        DjInteractivityConnectionClosed.m13842o((DjInteractivityConnectionClosed) this.instance, z);
    }

    /* JADX INFO: renamed from: r */
    public final void m97242r(String str) {
        copyOnWrite();
        DjInteractivityConnectionClosed.m13843p((DjInteractivityConnectionClosed) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m97243s(int i) {
        copyOnWrite();
        DjInteractivityConnectionClosed.m13844q((DjInteractivityConnectionClosed) this.instance, i);
    }
