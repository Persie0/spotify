...
import com.spotify.connect.esperanto.proto.VolumeMessages$VolumeSetRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes6.dex */
public final class gyc1 extends AbstractC0268g implements sre0 {
    ...
    public final void m46127m(String str) {
        copyOnWrite();
        VolumeMessages$VolumeSetRequest.m7448n((VolumeMessages$VolumeSetRequest) this.instance, str);
    }
    ...
    public final void m46128q(CommonMessages$LoggingParams commonMessages$LoggingParams) {
        copyOnWrite();
        VolumeMessages$VolumeSetRequest.m7449o((VolumeMessages$VolumeSetRequest) this.instance, commonMessages$LoggingParams);
    }

    /* JADX INFO: renamed from: r */
    public final void m46129r(int i) {
        copyOnWrite();
        VolumeMessages$VolumeSetRequest.m7450p((VolumeMessages$VolumeSetRequest) this.instance, i);
    }
