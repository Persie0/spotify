...
import com.spotify.rcs.resolver.grpc.p141v0.proto.C1282g;
import com.spotify.rcs.resolver.grpc.p141v0.proto.Resolve$Context;
import com.spotify.rcs.resolver.grpc.p141v0.proto.Resolve$Fetch;
import com.spotify.rcs.resolver.grpc.p141v0.proto.Resolve$ResolveRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes2.dex */
public final class vyw0 extends AbstractC0268g implements sre0 {
    ...
    public final void m86862m(C1282g c1282g) {
        copyOnWrite();
        Resolve$ResolveRequest.m20170n((Resolve$ResolveRequest) this.instance, (Resolve$Context) c1282g.build());
    }
    ...
    public final void m86863q(tyw0 tyw0Var) {
        copyOnWrite();
        Resolve$ResolveRequest.m20171o((Resolve$ResolveRequest) this.instance, (Resolve$Fetch) tyw0Var.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m86864r() {
        copyOnWrite();
        Resolve$ResolveRequest.m20172p((Resolve$ResolveRequest) this.instance);
    }
