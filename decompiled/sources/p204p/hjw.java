...
public final class hjw extends AbstractC0268g implements sre0 {
    ...
    public final void m47723m(ArrayList arrayList) {
        copyOnWrite();
        EsContext$Context.m17669n((EsContext$Context) this.instance, arrayList);
    }
    ...
    public final void m47724q(Map map) {
        copyOnWrite();
        EsContext$Context.m17670o((EsContext$Context) this.instance).putAll(map);
    }

    /* JADX INFO: renamed from: r */
    public final void m47725r(boolean z) {
        copyOnWrite();
        EsContext$Context.m17671p((EsContext$Context) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m47726s(EsRestrictions$Restrictions esRestrictions$Restrictions) {
        copyOnWrite();
        EsContext$Context.m17672q((EsContext$Context) this.instance, esRestrictions$Restrictions);
    }

    /* JADX INFO: renamed from: t */
    public final void m47727t(String str) {
        copyOnWrite();
        EsContext$Context.m17673r((EsContext$Context) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m47728u(String str) {
        copyOnWrite();
        EsContext$Context.m17674s((EsContext$Context) this.instance, str);
    }
