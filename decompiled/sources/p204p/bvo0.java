...
import com.spotify.playlist.policy.proto.PlaylistAllowsDecorationPolicy;
import java.io.InputStream;
import spotify.playlist.esperanto.proto.PlaylistGetResponse;
import spotify.playlist.esperanto.proto.PlaylistLensResponse;

/* JADX INFO: loaded from: classes6.dex */
public final class bvo0 extends AbstractC0268g implements sre0 {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ int f31410a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ bvo0(AbstractC0269h abstractC0269h, int i) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public bvo0(int i) {
        super(PlaybackSettingsEsperantoService$GetSettingsResponse.DEFAULT_INSTANCE);
        this.f31410a = i;
        switch (i) {
            case 16:
                super(PlaylistAllowsDecorationPolicy.DEFAULT_INSTANCE);
                break;
            case 23:
                super(PlaylistGetResponse.DEFAULT_INSTANCE);
                break;
            case 26:
                super(PlaylistLensResponse.DEFAULT_INSTANCE);
                break;
            default:
                break;
        }
