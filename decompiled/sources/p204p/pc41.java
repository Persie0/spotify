...
public final class pc41 extends AbstractC0268g implements sre0 {
    ...
    public final void m69543m(cva cvaVar) {
        copyOnWrite();
        SpotifyGoCommandError.m21785n((SpotifyGoCommandError) this.instance, cvaVar);
    }
    ...
    public final void m69544q(String str) {
        copyOnWrite();
        SpotifyGoCommandError.m21786o((SpotifyGoCommandError) this.instance, str);
    }
