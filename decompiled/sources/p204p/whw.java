...
public final class whw extends AbstractC0268g implements sre0 {
    public whw() {
        super(EsAuthenticateCredentials$NativePassword.DEFAULT_INSTANCE);
    }
    ...
    public final void m88175m(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$NativePassword.m3527n((EsAuthenticateCredentials$NativePassword) this.instance, str);
    }
    ...
    public final void m88176q(String str) {
        copyOnWrite();
        EsAuthenticateCredentials$NativePassword.m3528o((EsAuthenticateCredentials$NativePassword) this.instance, str);
    }
