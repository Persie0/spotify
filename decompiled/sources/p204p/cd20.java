...
public final class cd20 extends AbstractC0268g implements sre0 {
    ...
    public final void m32334m(Chains chains) {
        copyOnWrite();
        HarmonizeSaveRequestBody.m19400n((HarmonizeSaveRequestBody) this.instance, chains);
    }
    ...
    public final void m32335q(String str) {
        copyOnWrite();
        HarmonizeSaveRequestBody.m19401o((HarmonizeSaveRequestBody) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m32336r(Exclusions exclusions) {
        copyOnWrite();
        HarmonizeSaveRequestBody.m19402p((HarmonizeSaveRequestBody) this.instance, exclusions);
    }

    /* JADX INFO: renamed from: s */
    public final void m32337s(ManualOps manualOps) {
        copyOnWrite();
        HarmonizeSaveRequestBody.m19403q((HarmonizeSaveRequestBody) this.instance, manualOps);
    }

    /* JADX INFO: renamed from: t */
    public final void m32338t(String str) {
        copyOnWrite();
        HarmonizeSaveRequestBody.m19404r((HarmonizeSaveRequestBody) this.instance, str);
    }
