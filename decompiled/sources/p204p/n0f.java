...
public final class n0f extends AbstractC0268g implements sre0 {
    public n0f() {
    ...
    public final void m63450m(ArtistDecorationPolicy artistDecorationPolicy) {
        copyOnWrite();
        CollectionArtistDecorationPolicy.m97455n((CollectionArtistDecorationPolicy) this.instance, artistDecorationPolicy);
    }
    ...
    public final void m63451q(ArtistCollectionDecorationPolicy artistCollectionDecorationPolicy) {
        copyOnWrite();
        CollectionArtistDecorationPolicy.m97456o((CollectionArtistDecorationPolicy) this.instance, artistCollectionDecorationPolicy);
    }

    /* JADX INFO: renamed from: r */
    public final void m63452r(ArtistSyncDecorationPolicy artistSyncDecorationPolicy) {
        copyOnWrite();
        CollectionArtistDecorationPolicy.m97457p((CollectionArtistDecorationPolicy) this.instance, artistSyncDecorationPolicy);
    }
