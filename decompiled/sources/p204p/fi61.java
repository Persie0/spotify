...
import com.spotify.libs.connect.events.proto.SystemVolumeControl;
import java.io.InputStream;

/* JADX INFO: loaded from: classes2.dex */
public final class fi61 extends AbstractC0268g implements sre0 {
    ...
    public final void m41697m(String str) {
        copyOnWrite();
        SystemVolumeControl.m12771n((SystemVolumeControl) this.instance, str);
    }
    ...
    public final void m41698q(float f) {
        copyOnWrite();
        SystemVolumeControl.m12772o((SystemVolumeControl) this.instance, f);
    }

    /* JADX INFO: renamed from: r */
    public final void m41699r(String str) {
        copyOnWrite();
        SystemVolumeControl.m12773p((SystemVolumeControl) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m41700s(float f) {
        copyOnWrite();
        SystemVolumeControl.m12774q((SystemVolumeControl) this.instance, f);
    }
