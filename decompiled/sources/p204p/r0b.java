...
import com.spotify.gpb.trackingimpl.events.proto.CPBillingChoiceLoaded;
import java.io.InputStream;
import java.util.List;

/* JADX INFO: loaded from: classes7.dex */
public final class r0b extends AbstractC0268g implements sre0 {
    ...
    public final void m74367m(List list) {
        copyOnWrite();
        CPBillingChoiceLoaded.m11181n((CPBillingChoiceLoaded) this.instance, list);
    }
    ...
    public final void m74368q(String str) {
        copyOnWrite();
        CPBillingChoiceLoaded.m11182o((CPBillingChoiceLoaded) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m74369r(String str) {
        copyOnWrite();
        CPBillingChoiceLoaded.m11183p((CPBillingChoiceLoaded) this.instance, str);
    }
