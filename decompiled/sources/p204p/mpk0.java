...
public final class mpk0 extends AbstractC0268g implements sre0 {
    public mpk0() {
        super(ObservePartyRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m62495m(String str) {
        copyOnWrite();
        ObservePartyRequest.m13077n((ObservePartyRequest) this.instance, str);
    }
    ...
    public final void m62496q(String str) {
        copyOnWrite();
        ObservePartyRequest.m13078o((ObservePartyRequest) this.instance, str);
    }
