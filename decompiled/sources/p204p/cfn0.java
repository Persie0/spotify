...
import com.spotify.payment.endpoint.proto.PaymentSdkNativeServiceProto$CallbackProceedData;
import com.spotify.payment.endpoint.proto.PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest;
import java.io.InputStream;

/* JADX INFO: loaded from: classes9.dex */
public final class cfn0 extends AbstractC0268g implements sre0 {
    ...
    public final void m32657m(int i) {
        copyOnWrite();
        PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest.m16698n((PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest) this.instance, i);
    }
    ...
    public final void m32658q(String str) {
        copyOnWrite();
        PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest.m16699o((PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m32659r(String str) {
        copyOnWrite();
        PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest.m16700p((PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m32660s(PaymentSdkNativeServiceProto$CallbackProceedData paymentSdkNativeServiceProto$CallbackProceedData) {
        copyOnWrite();
        PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest.m16701q((PaymentSdkNativeServiceProto$CallbackProceedPaymentRequest) this.instance, paymentSdkNativeServiceProto$CallbackProceedData);
    }
