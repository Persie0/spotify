...
import com.spotify.gpb.trackingimpl.events.proto.GpbOperation;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes7.dex */
public final class tp10 extends AbstractC0268g implements sre0 {
    ...
    public final void m81230m(Map map) {
        copyOnWrite();
        GpbOperation.m11218o((GpbOperation) this.instance).putAll(map);
    }
    ...
    public final void m81231q(String str, String str2) {
        str2.getClass();
        copyOnWrite();
        GpbOperation.m11217n((GpbOperation) this.instance).put(str, str2);
    }

    /* JADX INFO: renamed from: r */
    public final void m81232r(String str) {
        copyOnWrite();
        GpbOperation.m11219p((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m81233s(String str) {
        copyOnWrite();
        GpbOperation.m11220q((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m81234t(String str) {
        copyOnWrite();
        GpbOperation.m11221r((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: u */
    public final void m81235u(String str) {
        copyOnWrite();
        GpbOperation.m11222s((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: v */
    public final void m81236v(String str) {
        copyOnWrite();
        GpbOperation.m11223t((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: w */
    public final void m81237w(String str) {
        copyOnWrite();
        GpbOperation.m11224u((GpbOperation) this.instance, str);
    }

    /* JADX INFO: renamed from: x */
    public final void m81238x(String str) {
        copyOnWrite();
        GpbOperation.m11225v((GpbOperation) this.instance, str);
    }
