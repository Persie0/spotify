...
public final class mgp0 extends AbstractC0268g implements sre0 {
    ...
    public final void m61727m(tcj tcjVar) {
        copyOnWrite();
        PlaylistContainsRequest.m97655n((PlaylistContainsRequest) this.instance, (ContainsRequest) tcjVar.build());
    }
    ...
    public final void m61728q(String str) {
        copyOnWrite();
        PlaylistContainsRequest.m97656o((PlaylistContainsRequest) this.instance, str);
    }
