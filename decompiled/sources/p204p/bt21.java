...
import com.spotify.home.slotloading.events.proto.SlotContentLoadingErrorEvent;
import java.io.InputStream;

/* JADX INFO: loaded from: classes7.dex */
public final class bt21 extends AbstractC0268g implements sre0 {
    ...
    public final void m30450m(String str) {
        copyOnWrite();
        SlotContentLoadingErrorEvent.m11822n((SlotContentLoadingErrorEvent) this.instance, str);
    }
    ...
    public final void m30451q(String str) {
        copyOnWrite();
        SlotContentLoadingErrorEvent.m11823o((SlotContentLoadingErrorEvent) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m30452r(int i) {
        copyOnWrite();
        SlotContentLoadingErrorEvent.m11824p((SlotContentLoadingErrorEvent) this.instance, i);
    }

    /* JADX INFO: renamed from: s */
    public final void m30453s(boolean z) {
        copyOnWrite();
        SlotContentLoadingErrorEvent.m11825q((SlotContentLoadingErrorEvent) this.instance, z);
    }

    /* JADX INFO: renamed from: t */
    public final void m30454t(String str) {
        copyOnWrite();
        SlotContentLoadingErrorEvent.m11826r((SlotContentLoadingErrorEvent) this.instance, str);
    }
