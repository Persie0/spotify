...
public final class f4f extends AbstractC0268g implements sre0 {
    public f4f() {
        super(CollectionItemdata$ItemData.DEFAULT_INSTANCE);
    }
    ...
    public final void m40729m(g4f g4fVar) {
        copyOnWrite();
        CollectionItemdata$ItemData.m6818n((CollectionItemdata$ItemData) this.instance, (CollectionItemdata$PageMatchItemData) g4fVar.build());
    }
    ...
    public final void m40730q(f7y0 f7y0Var) {
        copyOnWrite();
        CollectionItemdata$ItemData.m6819o((CollectionItemdata$ItemData) this.instance, (SaveSource) f7y0Var.build());
    }
