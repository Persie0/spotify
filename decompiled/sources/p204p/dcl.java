...
public final class dcl extends AbstractC0268g implements sre0 {
    public dcl() {
        super(CreateReplyRequest.DEFAULT_INSTANCE);
    }
    ...
    public final void m35658m(List list) {
        copyOnWrite();
        CreateReplyRequest.m22157n((CreateReplyRequest) this.instance, list);
    }
    ...
    public final void m35659q(String str) {
        copyOnWrite();
        CreateReplyRequest.m22158o((CreateReplyRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m35660r(String str) {
        copyOnWrite();
        CreateReplyRequest.m22159p((CreateReplyRequest) this.instance, str);
    }
