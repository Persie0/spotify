...
import com.spotify.messages.ListeningPartyPlayedTalkTrack;
import java.io.InputStream;

/* JADX INFO: loaded from: classes8.dex */
public final class oi90 extends AbstractC0268g implements sre0 {
    ...
    public final void m67006m(long j) {
        copyOnWrite();
        ListeningPartyPlayedTalkTrack.m13946n((ListeningPartyPlayedTalkTrack) this.instance, j);
    }
    ...
    public final void m67007q(long j) {
        copyOnWrite();
        ListeningPartyPlayedTalkTrack.m13947o((ListeningPartyPlayedTalkTrack) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m67008r(String str) {
        copyOnWrite();
        ListeningPartyPlayedTalkTrack.m13948p((ListeningPartyPlayedTalkTrack) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m67009s(String str) {
        copyOnWrite();
        ListeningPartyPlayedTalkTrack.m13949q((ListeningPartyPlayedTalkTrack) this.instance, str);
    }
