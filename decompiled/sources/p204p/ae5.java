...
import com.spotify.agesignal.agesignalverifierimpl.proto.AppStoreAgeSignalGeneric;
import java.io.InputStream;
import java.util.Map;

/* JADX INFO: loaded from: classes4.dex */
public final class ae5 extends AbstractC0268g implements sre0 {
    ...
    public final void m25684m(Map map) {
        copyOnWrite();
        AppStoreAgeSignalGeneric.m3027n((AppStoreAgeSignalGeneric) this.instance).putAll(map);
    }
    ...
    public final void m25685q(String str) {
        copyOnWrite();
        AppStoreAgeSignalGeneric.m3028o((AppStoreAgeSignalGeneric) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m25686r(String str) {
        copyOnWrite();
        AppStoreAgeSignalGeneric.m3029p((AppStoreAgeSignalGeneric) this.instance, str);
    }
