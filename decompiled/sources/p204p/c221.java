...
import com.spotify.smartshuffle.signalsimpl.proto.SignalPayloadProto$CurrentItem;
import java.io.InputStream;

/* JADX INFO: loaded from: classes10.dex */
public final class c221 extends AbstractC0268g implements sre0 {
    ...
    public final void m31292m(gva gvaVar) {
        copyOnWrite();
        SignalPayloadProto$CurrentItem.m21427n((SignalPayloadProto$CurrentItem) this.instance, gvaVar);
    }
    ...
    public final void m31293q(long j) {
        copyOnWrite();
        SignalPayloadProto$CurrentItem.m21428o((SignalPayloadProto$CurrentItem) this.instance, j);
    }

    /* JADX INFO: renamed from: r */
    public final void m31294r(long j) {
        copyOnWrite();
        SignalPayloadProto$CurrentItem.m21429p((SignalPayloadProto$CurrentItem) this.instance, j);
    }

    /* JADX INFO: renamed from: s */
    public final void m31295s(long j) {
        copyOnWrite();
        SignalPayloadProto$CurrentItem.m21430q((SignalPayloadProto$CurrentItem) this.instance, j);
    }

    /* JADX INFO: renamed from: t */
    public final void m31296t(String str) {
        copyOnWrite();
        SignalPayloadProto$CurrentItem.m21431r((SignalPayloadProto$CurrentItem) this.instance, str);
    }
