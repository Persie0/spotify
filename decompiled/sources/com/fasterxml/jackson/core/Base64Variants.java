...
public abstract class Base64Variants {
    ...
    static {
        ...
        MIME = base64Variant;
        MIME_NO_LINEFEEDS = new Base64Variant(base64Variant, "MIME-NO-LINEFEEDS", Alert.DURATION_SHOW_INDEFINITELY);
        PEM = new Base64Variant(base64Variant, "PEM", true, '=', 64);
        StringBuilder sb = new StringBuilder("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/");
        sb.setCharAt(sb.indexOf("+"), '-');
        sb.setCharAt(sb.indexOf("/"), '_');
        MODIFIED_FOR_URL = new Base64Variant("MODIFIED-FOR-URL", sb.toString(), false, (char) 0, Alert.DURATION_SHOW_INDEFINITELY);
    }
    ...
    public static Base64Variant valueOf(String str) {
        ...
        throw new IllegalArgumentException(edb.m38564m("No Base64Variant with name ", str == null ? "<null>" : s571.m77251j("'", str, "'")));
    }
}
