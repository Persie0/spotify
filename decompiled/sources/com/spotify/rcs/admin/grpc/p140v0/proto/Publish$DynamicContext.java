...
public final class Publish$DynamicContext extends AbstractC0269h implements sre0 {
    ...
    private ae50 contextDefinition_ = AbstractC0269h.emptyProtobufList();

    public static final class ContextDefinition extends AbstractC0269h implements sre0 {
        ...
        static {
            ...
            AbstractC0269h.registerDefaultInstance(ContextDefinition.class, contextDefinition);
        }
        ...
        public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
            ...
            if (iOrdinal == 2) {
                return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0001\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001?\u0000", new Object[]{"context_", "contextCase_"});
            }
            if (iOrdinal == 3) {
                return new ContextDefinition();
            }
            if (iOrdinal == 4) {
                return new C1262e(DEFAULT_INSTANCE);
            }
            if (iOrdinal == 5) {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(Publish$DynamicContext.class, publish$DynamicContext);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"contextDefinition_", ContextDefinition.class});
        }
        if (iOrdinal == 3) {
            return new Publish$DynamicContext();
        }
        if (iOrdinal == 4) {
            return new C1261d(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
