...
public final class Resolve$Fetch extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(Resolve$Fetch.class, resolve$Fetch);
    }
    ...
    public static void m20168n(Resolve$Fetch resolve$Fetch) {
        resolve$Fetch.getClass();
        resolve$Fetch.type_ = uyw0.BLOCKING.getNumber();
    }

    /* JADX INFO: renamed from: o */
    public static tyw0 m20169o() {
        return (tyw0) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new tyw0(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
