...
/* JADX INFO: renamed from: com.spotify.rcs.resolver.grpc.v0.i */
/* JADX INFO: loaded from: classes2.dex */
public final class C1275i extends AbstractC0268g implements sre0 {
    ...
    public final void m20153m(boolean z) {
        copyOnWrite();
        Context.ContextEntry.m20139n((Context.ContextEntry) this.instance, z);
    }
    ...
    public final void m20154q(String str) {
        copyOnWrite();
        Context.ContextEntry.m20140o((Context.ContextEntry) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m20155r(String str) {
        copyOnWrite();
        Context.ContextEntry.m20141p((Context.ContextEntry) this.instance, str);
    }
