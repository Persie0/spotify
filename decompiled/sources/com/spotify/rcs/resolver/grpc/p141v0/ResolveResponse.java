...
public final class ResolveResponse extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(ResolveResponse.class, resolveResponse);
    }
    ...
    public static ResolveResponse m20149o() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new i8w0(DEFAULT_INSTANCE, 16);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final Configuration m20150n() {
        Configuration configuration = this.configuration_;
        return configuration == null ? Configuration.m20120p() : configuration;
    }
