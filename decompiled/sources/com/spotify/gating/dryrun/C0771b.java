...
/* JADX INFO: renamed from: com.spotify.gating.dryrun.b */
/* JADX INFO: loaded from: classes7.dex */
public final class C0771b extends AbstractC0268g implements sre0 {
    ...
    public final void m11159m(String str) {
        copyOnWrite();
        GatingDryRunMismatchEvent.Mismatches.m11152n((GatingDryRunMismatchEvent.Mismatches) this.instance, str);
    }
    ...
    public final void m11160q(String str) {
        copyOnWrite();
        GatingDryRunMismatchEvent.Mismatches.m11153o((GatingDryRunMismatchEvent.Mismatches) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m11161r(boolean z) {
        copyOnWrite();
        GatingDryRunMismatchEvent.Mismatches.m11154p((GatingDryRunMismatchEvent.Mismatches) this.instance, z);
    }

    /* JADX INFO: renamed from: s */
    public final void m11162s(boolean z) {
        copyOnWrite();
        GatingDryRunMismatchEvent.Mismatches.m11155q((GatingDryRunMismatchEvent.Mismatches) this.instance, z);
    }
