...
public final class SectionContent extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0001\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001<\u0000", new Object[]{"contentType_", "contentTypeCase_", Summary.class});
        }
        if (iOrdinal == 3) {
            return new SectionContent();
        }
        if (iOrdinal == 4) {
            return new i2z0(DEFAULT_INSTANCE, 20);
        }
        if (iOrdinal == 5) {
    ...
    public final Summary m21570n() {
        return this.contentTypeCase_ == 1 ? (Summary) this.contentType_ : Summary.m21572n();
    }
