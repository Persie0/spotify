...
public final class ExternalAccessoryRemoteError extends AbstractC0269h implements sre0 {
    ...
    public static void m5539n(ExternalAccessoryRemoteError externalAccessoryRemoteError, String str) {
    ...
    public static void m5540o(ExternalAccessoryRemoteError externalAccessoryRemoteError, String str) {
        externalAccessoryRemoteError.getClass();
        str.getClass();
    ...
    public static void m5541p(ExternalAccessoryRemoteError externalAccessoryRemoteError) {
        externalAccessoryRemoteError.getClass();
        externalAccessoryRemoteError.bitField0_ |= 128;
        externalAccessoryRemoteError.integration_ = "android_auto";
    }
    ...
    public static void m5542q(ExternalAccessoryRemoteError externalAccessoryRemoteError, String str) {
        externalAccessoryRemoteError.getClass();
        str.getClass();
    ...
    public static fwx m5543r() {
        return (fwx) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new fwx(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
