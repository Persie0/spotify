...
public final class RecentsDataSourceErrorEvent extends AbstractC0269h implements sre0 {
    ...
    public static void m20342n(RecentsDataSourceErrorEvent recentsDataSourceErrorEvent, String str) {
    ...
    public static void m20343o(RecentsDataSourceErrorEvent recentsDataSourceErrorEvent, String str) {
        recentsDataSourceErrorEvent.getClass();
    ...
    public static x4v0 m20344p() {
        return (x4v0) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new x4v0(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
