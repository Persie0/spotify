...
public final class DebugInfo extends AbstractC0269h implements sre0 {
    ...
    public static final int HOME_LOGGING_SPAN_ID_FIELD_NUMBER = 1;
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001Ȉ", new Object[]{"homeLoggingSpanId_"});
        }
        if (iOrdinal == 3) {
            return new DebugInfo();
        }
        if (iOrdinal == 4) {
            return new wzl(DEFAULT_INSTANCE, 19);
        }
        if (iOrdinal == 5) {
