...
public final class Credits extends AbstractC0269h implements sre0 {
    ...
    public static Credits m21476o(byte[] bArr) {
        return (Credits) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"contributors_", Contributor.class});
        }
        if (iOrdinal == 3) {
            return new Credits();
        }
        if (iOrdinal == 4) {
            return new xbl(DEFAULT_INSTANCE, 17);
        }
        if (iOrdinal == 5) {
