...
public final class InlineEntityExplorerRowComponent extends AbstractC0269h implements sre0 {
    public static final int ACCESSIBILITY_TEXT_FIELD_NUMBER = 5;
    private static final InlineEntityExplorerRowComponent DEFAULT_INSTANCE;
    ...
    static {
        InlineEntityExplorerRowComponent inlineEntityExplorerRowComponent = new InlineEntityExplorerRowComponent();
        DEFAULT_INSTANCE = inlineEntityExplorerRowComponent;
        AbstractC0269h.registerDefaultInstance(InlineEntityExplorerRowComponent.class, inlineEntityExplorerRowComponent);
    }

    private InlineEntityExplorerRowComponent() {
    }

    /* JADX INFO: renamed from: o */
    public static InlineEntityExplorerRowComponent m23014o() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 3) {
            return new InlineEntityExplorerRowComponent();
        }
        if (iOrdinal == 4) {
            return new zc40(DEFAULT_INSTANCE, 11);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
        ...
        synchronized (InlineEntityExplorerRowComponent.class) {
            try {
                r110Var = PARSER;
                if (r110Var == null) {
    ...
    public final ColorSetContrastOptions m23016p() {
