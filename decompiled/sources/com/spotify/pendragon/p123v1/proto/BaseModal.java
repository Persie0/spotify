...
public final class BaseModal extends AbstractC0269h implements sre0 {
    ...
    private static final BaseModal DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = baseModal;
        AbstractC0269h.registerDefaultInstance(BaseModal.class, baseModal);
    }
    ...
    public static BaseModal m17067s() {
        return DEFAULT_INSTANCE;
    }

    /* JADX INFO: renamed from: A */
    public final boolean m17068A() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new az8(DEFAULT_INSTANCE, 2);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final AccessoryContent m17069n() {
    ...
    public final EnumC2613yh m17070o() {
    ...
    public final Text m17075u() {
        Text text = this.headline_;
        return text == null ? Text.m17299n() : text;
    }

    /* JADX INFO: renamed from: v */
    public final Button m17076v() {
        Button button = this.primaryButton_;
        return button == null ? Button.m17122p() : button;
    }

    /* JADX INFO: renamed from: w */
    public final Button m17077w() {
        Button button = this.secondaryButton_;
        return button == null ? Button.m17122p() : button;
    }

    /* JADX INFO: renamed from: x */
    public final boolean m17078x() {
        return (this.bitField0_ & 2) != 0;
    }

    /* JADX INFO: renamed from: y */
    public final boolean m17079y() {
        return (this.bitField0_ & 64) != 0;
    }

    /* JADX INFO: renamed from: z */
    public final boolean m17080z() {
