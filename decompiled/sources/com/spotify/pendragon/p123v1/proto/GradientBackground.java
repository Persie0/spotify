...
public final class GradientBackground extends AbstractC0269h implements sre0 {
    private static final GradientBackground DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = gradientBackground;
        AbstractC0269h.registerDefaultInstance(GradientBackground.class, gradientBackground);
    }
    ...
    public static GradientBackground m17195n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new qb10(DEFAULT_INSTANCE, 27);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
        ...
        synchronized (GradientBackground.class) {
            try {
                r110Var = PARSER;
                if (r110Var == null) {
    ...
    public final double m17196o() {
        return this.degrees_;
    }

    /* JADX INFO: renamed from: p */
    public final String m17197p() {
        return this.endColor_;
    }

    /* JADX INFO: renamed from: q */
    public final String m17198q() {
