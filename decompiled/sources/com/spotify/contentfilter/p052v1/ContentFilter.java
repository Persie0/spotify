package com.spotify.contentfilter.p052v1;
...
public final class ContentFilter extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ", new Object[]{"title_", "query_"});
        }
        if (iOrdinal == 3) {
            return new ContentFilter();
        }
        if (iOrdinal == 4) {
            return new saj(DEFAULT_INSTANCE, 14);
        }
        if (iOrdinal == 5) {
