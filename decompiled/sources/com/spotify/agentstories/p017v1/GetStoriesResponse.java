...
public final class GetStoriesResponse extends AbstractC0269h implements sre0 {
    ...
    public static final int STORY_FRAMES_FIELD_NUMBER = 1;
    private ae50 storyFrames_ = AbstractC0269h.emptyProtobufList();
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"storyFrames_", StoryFrame.class});
        }
        if (iOrdinal == 3) {
            return new GetStoriesResponse();
        }
        if (iOrdinal == 4) {
            return new qb10(DEFAULT_INSTANCE, 3);
        }
        if (iOrdinal == 5) {
    ...
    public final ae50 m3016n() {
        return this.storyFrames_;
    }
