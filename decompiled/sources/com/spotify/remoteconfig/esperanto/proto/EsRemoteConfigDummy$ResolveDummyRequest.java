...
public final class EsRemoteConfigDummy$ResolveDummyRequest extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(EsRemoteConfigDummy$ResolveDummyRequest.class, esRemoteConfigDummy$ResolveDummyRequest);
    }
    ...
    public static EsRemoteConfigDummy$ResolveDummyRequest m20403n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new vnw(DEFAULT_INSTANCE, 3);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
