...
public final class OnDemand extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(OnDemand.class, onDemand);
    }
    ...
    public static OnDemand m20874n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ", new Object[]{"trackUri_", "playlistUri_"});
        }
        if (iOrdinal == 3) {
            return new OnDemand();
        }
        if (iOrdinal == 4) {
            return new y7l0(DEFAULT_INSTANCE, 0);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
