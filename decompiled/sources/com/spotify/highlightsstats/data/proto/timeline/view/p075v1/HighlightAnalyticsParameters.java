...
public final class HighlightAnalyticsParameters extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(HighlightAnalyticsParameters.class, highlightAnalyticsParameters);
    }
    ...
    public static HighlightAnalyticsParameters m11353n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ", new Object[]{"reason_", "entityUris_"});
        }
        if (iOrdinal == 3) {
            return new HighlightAnalyticsParameters();
        }
        if (iOrdinal == 4) {
            return new og20(DEFAULT_INSTANCE, 16);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final String m11354o() {
        return this.entityUris_;
    }

    /* JADX INFO: renamed from: p */
    public final String m11355p() {
        return this.reason_;
    }
