...
public final class PositionChangeLabel extends AbstractC0269h implements sre0 {
    ...
    public static PositionChangeLabel m11398o() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\u000b\u0002\f\u0003Ȉ", new Object[]{"positionChange_", "changeFromPreviousPeriod_", "backgroundColour_"});
        }
        if (iOrdinal == 3) {
            return new PositionChangeLabel();
        }
        if (iOrdinal == 4) {
            return new x2q0(DEFAULT_INSTANCE, 10);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
