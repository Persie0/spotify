...
public final class EpisodeDecorationPolicy extends AbstractC0269h implements EpisodeDecorationPolicyOrBuilder {
    ...
    public static final int PODCAST_SUBSCRIPTION_FIELD_NUMBER = 20;
    ...
    public static final class Builder extends AbstractC0268g implements EpisodeDecorationPolicyOrBuilder {
        ...
        public Builder clearPodcastSubscription() {
            copyOnWrite();
            ((EpisodeDecorationPolicy) this.instance).clearPodcastSubscription();
            return this;
        }
        ...
        @Override // com.spotify.cosmos.util.libs.proto.EpisodeDecorationPolicyOrBuilder
        ...
        @Override // com.spotify.cosmos.util.libs.proto.EpisodeDecorationPolicyOrBuilder
        public boolean getPodcastSubscription() {
            return ((EpisodeDecorationPolicy) this.instance).getPodcastSubscription();
        }
        ...
        public Builder setPodcastSubscription(boolean z) {
            copyOnWrite();
            ((EpisodeDecorationPolicy) this.instance).setPodcastSubscription(z);
            return this;
        }
        ...
        public Builder setPodcastSegments(PodcastSegmentsPolicy.Builder builder) {
            copyOnWrite();
            ((EpisodeDecorationPolicy) this.instance).setPodcastSegments((PodcastSegmentsPolicy) builder.build());
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearPodcastSegments() {
        this.podcastSegments_ = null;
        this.bitField0_ &= -2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void clearPodcastSubscription() {
        this.podcastSubscription_ = false;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void mergePodcastSegments(PodcastSegmentsPolicy podcastSegmentsPolicy) {
        ...
        if (podcastSegmentsPolicy2 == null || podcastSegmentsPolicy2 == PodcastSegmentsPolicy.getDefaultInstance()) {
            ...
            this.podcastSegments_ = (PodcastSegmentsPolicy) ((PodcastSegmentsPolicy.Builder) PodcastSegmentsPolicy.newBuilder(this.podcastSegments_).mergeFrom((AbstractC0269h) podcastSegmentsPolicy)).buildPartial();
        }
        this.bitField0_ |= 1;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setPodcastSegments(PodcastSegmentsPolicy podcastSegmentsPolicy) {
        podcastSegmentsPolicy.getClass();
        this.podcastSegments_ = podcastSegmentsPolicy;
        this.bitField0_ |= 1;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setPodcastSubscription(boolean z) {
        this.podcastSubscription_ = z;
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0018\u0000\u0001\u0001\u0019\u0018\u0000\u0000\u0000\u0001\u0007\u0002\u0007\u0003\u0007\u0004\u0007\u0005\u0007\u0006\u0007\u0007\u0007\b\u0007\t\u0007\n\u0007\u000b\u0007\f\u0007\r\u0007\u000e\u0007\u000f\u0007\u0010\u0007\u0011\u0007\u0012\u0007\u0013ဉ\u0000\u0014\u0007\u0016\u0007\u0017\u0007\u0018\u0007\u0019\u0007", new Object[]{"bitField0_", "link_", "length_", "name_", "manifestId_", "previewId_", "previewManifestId_", "description_", "publishDate_", "covers_", "freezeFrames_", "language_", "available_", "mediaTypeEnum_", "number_", "backgroundable_", "isExplicit_", "type_", "isMusicAndTalk_", "podcastSegments_", "podcastSubscription_", "is19PlusOnly_", "isBookChapter_", "isPodcastShort_", "isCurated_"});
        }
        if (iOrdinal == 3) {
    ...
    @Override // com.spotify.cosmos.util.libs.proto.EpisodeDecorationPolicyOrBuilder
    public boolean getPodcastSubscription() {
        return this.podcastSubscription_;
    }
