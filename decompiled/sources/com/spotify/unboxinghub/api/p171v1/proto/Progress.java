...
public final class Progress extends AbstractC0269h implements sre0 {
    ...
    public static Progress m21992o() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u0004\u0002\u0004", new Object[]{"current_", "max_"});
        }
        if (iOrdinal == 3) {
            return new Progress();
        }
        if (iOrdinal == 4) {
            return new t3r0(DEFAULT_INSTANCE, 24);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
