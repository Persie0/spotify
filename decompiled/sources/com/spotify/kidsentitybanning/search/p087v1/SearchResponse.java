...
public final class SearchResponse extends AbstractC0269h implements sre0 {
    ...
    public static final int IS_EXPLICIT_ALLOWED_FIELD_NUMBER = 3;
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0001\u0000\u0001\u001b\u0002ለ\u0000\u0003\u0007", new Object[]{"bitField0_", "entities_", SearchEntity.class, "nextPageToken_", "isExplicitAllowed_"});
        }
        if (iOrdinal == 3) {
            return new SearchResponse();
        }
        if (iOrdinal == 4) {
            return new six0(DEFAULT_INSTANCE, 27);
        }
        if (iOrdinal == 5) {
