...
public final class EpisodeMetadata extends AbstractC0269h implements sre0 {
    private static final EpisodeMetadata DEFAULT_INSTANCE;
    public static final int EPISODE_IMAGE_URI_FIELD_NUMBER = 1;
    ...
    public static EpisodeMetadata m15730n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001Ȉ", new Object[]{"episodeImageUri_"});
        }
        if (iOrdinal == 3) {
            return new EpisodeMetadata();
        }
        if (iOrdinal == 4) {
            return new ugv(DEFAULT_INSTANCE, 17);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
