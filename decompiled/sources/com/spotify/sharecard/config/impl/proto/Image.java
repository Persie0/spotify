...
public final class Image extends AbstractC0269h implements sre0 {
    ...
    public static void m21146n(Image image, String str) {
        image.getClass();
        str.getClass();
        image.url_ = str;
    }
    ...
    public static Image m21147o() {
        return DEFAULT_INSTANCE;
    }

    /* JADX INFO: renamed from: p */
    public static u240 m21148p() {
        return (u240) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new u240(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
