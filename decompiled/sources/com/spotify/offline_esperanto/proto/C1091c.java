...
/* JADX INFO: renamed from: com.spotify.offline_esperanto.proto.c */
/* JADX INFO: loaded from: classes2.dex */
public final class C1091c extends AbstractC0268g implements sre0 {
    ...
    public final void m16213m(Iterable iterable) {
        copyOnWrite();
        EsOffline$GetContextsRequest.m16131n((EsOffline$GetContextsRequest) this.instance, iterable);
    }
    ...
    public final void m16214q(String str) {
        copyOnWrite();
        EsOffline$GetContextsRequest.m16132o((EsOffline$GetContextsRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m16215r(ylw ylwVar) {
        copyOnWrite();
        EsOffline$GetContextsRequest.m16133p((EsOffline$GetContextsRequest) this.instance, (EsOffline$DeviceKey) ylwVar.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m16216s(C1092d c1092d) {
        copyOnWrite();
        EsOffline$GetContextsRequest.m16134q((EsOffline$GetContextsRequest) this.instance, (EsOffline$GetContextsRequest.Filtering) c1092d.build());
    }

    /* JADX INFO: renamed from: t */
    public final void m16217t(xlw xlwVar) {
        copyOnWrite();
        EsOffline$GetContextsRequest.m16135r((EsOffline$GetContextsRequest) this.instance, (EsOffline$ContextInfoPolicy) xlwVar.build());
    }
