...
public final class ArtistlistResponse$ArtistList extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(ArtistlistResponse$ArtistList.class, artistlistResponse$ArtistList);
    }
    ...
    public static ArtistlistResponse$ArtistList m19798n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"artists_", ArtistlistResponse$Artist.class});
        }
        if (iOrdinal == 3) {
            return new ArtistlistResponse$ArtistList();
        }
        if (iOrdinal == 4) {
            return new qw5(DEFAULT_INSTANCE, 10);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
