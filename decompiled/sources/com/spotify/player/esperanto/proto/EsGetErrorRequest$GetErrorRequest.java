...
public final class EsGetErrorRequest$GetErrorRequest extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(EsGetErrorRequest$GetErrorRequest.class, esGetErrorRequest$GetErrorRequest);
    }
    ...
    public static EsGetErrorRequest$GetErrorRequest m17757n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new qjw(DEFAULT_INSTANCE, 10);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
