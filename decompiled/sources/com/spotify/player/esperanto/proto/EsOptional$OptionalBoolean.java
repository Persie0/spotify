...
public final class EsOptional$OptionalBoolean extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(EsOptional$OptionalBoolean.class, esOptional$OptionalBoolean);
    }
    ...
    public static void m17770n(EsOptional$OptionalBoolean esOptional$OptionalBoolean, boolean z) {
        esOptional$OptionalBoolean.value_ = z;
    }

    /* JADX INFO: renamed from: o */
    public static tmw m17771o() {
        return (tmw) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new tmw(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
