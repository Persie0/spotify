...
/* JADX INFO: renamed from: com.spotify.player.esperanto.proto.a */
/* JADX INFO: loaded from: classes9.dex */
public final class C1164a extends AbstractC0268g implements sre0 {
    ...
    public final void m18023m(EsSetSleepTimerRequest$SetSleepTimerRequest.Clear clear) {
        copyOnWrite();
        EsSetSleepTimerRequest$SetSleepTimerRequest.m17979n((EsSetSleepTimerRequest$SetSleepTimerRequest) this.instance, clear);
    }
    ...
    public final void m18024q(C1166c c1166c) {
        copyOnWrite();
        EsSetSleepTimerRequest$SetSleepTimerRequest.m17980o((EsSetSleepTimerRequest$SetSleepTimerRequest) this.instance, (EsSetSleepTimerRequest$SetSleepTimerRequest.Duration) c1166c.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m18025r(EsSetSleepTimerRequest$SetSleepTimerRequest.EndOfTrack endOfTrack) {
        copyOnWrite();
        EsSetSleepTimerRequest$SetSleepTimerRequest.m17981p((EsSetSleepTimerRequest$SetSleepTimerRequest) this.instance, endOfTrack);
    }

    /* JADX INFO: renamed from: s */
    public final void m18026s(EsLoggingParams$LoggingParams esLoggingParams$LoggingParams) {
        copyOnWrite();
        EsSetSleepTimerRequest$SetSleepTimerRequest.m17982q((EsSetSleepTimerRequest$SetSleepTimerRequest) this.instance, esLoggingParams$LoggingParams);
    }

    /* JADX INFO: renamed from: t */
    public final void m18027t(EsCommandOptions$CommandOptions esCommandOptions$CommandOptions) {
        copyOnWrite();
        EsSetSleepTimerRequest$SetSleepTimerRequest.m17983r((EsSetSleepTimerRequest$SetSleepTimerRequest) this.instance, esCommandOptions$CommandOptions);
    }
