...
public enum ErrorType {
    ...
    PLAYBACK_STUCK_TIMEOUT,
    PLAYBACK_CLIENT_VERSION_IS_SUNSETTED,
    PLAYBACK_ERROR,
    LICENSE_CHANGE,
    ...
    PICK_AND_SHUFFLE_CAPPED,
    PICK_AND_SHUFFLE_CONNECT_RESTRICTED,
    CONTEXT_LOADING_FAILED,
    AUDIOBOOK_NOT_PLAYABLE,
    SIGNAL_NOT_AVAILABLE,
    SET_SLEEP_TIMER_RESTRICTED,
    TIMEOUT,
    INVALID,
    UNKNOWN
}
