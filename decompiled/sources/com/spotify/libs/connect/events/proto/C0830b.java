...
/* JADX INFO: renamed from: com.spotify.libs.connect.events.proto.b */
/* JADX INFO: loaded from: classes7.dex */
public final class C0830b extends AbstractC0268g implements sre0 {
    public C0830b() {
        super(ConnectDeviceDiscoverySnapshot.GroupDevices.DEFAULT_INSTANCE);
    }
    ...
    public final void m12818m(String str) {
        copyOnWrite();
        ConnectDeviceDiscoverySnapshot.GroupDevices.m12731n((ConnectDeviceDiscoverySnapshot.GroupDevices) this.instance, str);
    }
    ...
    public final void m12819q(String str) {
        copyOnWrite();
        ConnectDeviceDiscoverySnapshot.GroupDevices.m12732o((ConnectDeviceDiscoverySnapshot.GroupDevices) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m12820r(String str) {
        copyOnWrite();
        ConnectDeviceDiscoverySnapshot.GroupDevices.m12733p((ConnectDeviceDiscoverySnapshot.GroupDevices) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m12821s(String str) {
        copyOnWrite();
        ConnectDeviceDiscoverySnapshot.GroupDevices.m12734q((ConnectDeviceDiscoverySnapshot.GroupDevices) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m12822t(String str) {
        copyOnWrite();
        ConnectDeviceDiscoverySnapshot.GroupDevices.m12735r((ConnectDeviceDiscoverySnapshot.GroupDevices) this.instance, str);
    }
