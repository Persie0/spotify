...
public final class EsStorage$GetStatsParams extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(EsStorage$GetStatsParams.class, esStorage$GetStatsParams);
    }
    ...
    public static EsStorage$GetStatsParams m21603n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new vnw(DEFAULT_INSTANCE, 11);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
