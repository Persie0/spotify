...
public final class Action extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0000\u0000\u0001\f\u0002ဉ\u0000", new Object[]{"bitField0_", "type_", "link_"});
        }
        if (iOrdinal == 3) {
            return new Action();
        }
        if (iOrdinal == 4) {
            return new C1997j(DEFAULT_INSTANCE, 11);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final s00 m3177p() {
        ...
        if (i == 0) {
            ...
            s00Var = i != 3 ? null : s00.NO_ACTION;
        } else {
            s00Var = s00.DISMISS;
        }
        return s00Var == null ? s00.UNRECOGNIZED : s00Var;
    }
