...
/* JADX INFO: renamed from: com.spotify.watchfeed.api.v1.d */
/* JADX INFO: loaded from: classes11.dex */
public final class C1336d extends AbstractC0268g implements sre0 {
    ...
    public final void m22483m(ArrayList arrayList) {
        copyOnWrite();
        WatchFeedRequest.m22471n((WatchFeedRequest) this.instance, arrayList);
    }
    ...
    public final void m22484q(Map map) {
        copyOnWrite();
        WatchFeedRequest.m22472o((WatchFeedRequest) this.instance).putAll(map);
    }

    /* JADX INFO: renamed from: r */
    public final void m22485r(String str) {
        copyOnWrite();
        WatchFeedRequest.m22473p((WatchFeedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m22486s(String str) {
        copyOnWrite();
        WatchFeedRequest.m22474q((WatchFeedRequest) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m22487t(C1337e c1337e) {
        copyOnWrite();
        WatchFeedRequest.m22475r((WatchFeedRequest) this.instance, (WatchFeedRequest.Pagination) c1337e.build());
    }
