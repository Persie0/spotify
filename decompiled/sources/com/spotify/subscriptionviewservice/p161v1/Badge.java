...
public final class Badge extends AbstractC0269h implements sre0 {
    ...
    public static final int LEADING_ICON_FIELD_NUMBER = 2;
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0000\u0000\u0001Ȉ\u0002ဉ\u0000\u0003ဉ\u0001", new Object[]{"bitField0_", "text_", "leadingIcon_", "colors_"});
        }
        if (iOrdinal == 3) {
            return new Badge();
        }
        if (iOrdinal == 4) {
            return new na8(DEFAULT_INSTANCE, 12);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
