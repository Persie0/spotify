...
public final class Item extends AbstractC0269h implements ItemOrBuilder {
    ...
    /* JADX INFO: renamed from: com.spotify.playlist.ai.creation.v2.Item$1 */
    public static /* synthetic */ class C11861 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f6441xa1df5c61;
    ...
    public static final class Builder extends AbstractC0268g implements ItemOrBuilder {
        ...
        @Override // com.spotify.playlist.p126ai.creation.p127v2.ItemOrBuilder
        public final String getNote() {
            return ((Item) this.instance).getNote();
        }

        @Override // com.spotify.playlist.p126ai.creation.p127v2.ItemOrBuilder
        public final gva getNoteBytes() {
        ...
        public final Builder setNoteBytes(gva gvaVar) {
            copyOnWrite();
            ((Item) this.instance).setNoteBytes(gvaVar);
            return this;
        }
        ...
        public final Builder setUriBytes(gva gvaVar) {
            copyOnWrite();
            ((Item) this.instance).setUriBytes(gvaVar);
            return this;
        }
    ...
    public static Item parseDelimitedFrom(InputStream inputStream) {
        return (Item) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Item parseFrom(ByteBuffer byteBuffer) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setNoteBytes(gva gvaVar) {
        AbstractC2118m8.checkByteStringIsUtf8(gvaVar);
        this.note_ = gvaVar.m45892u();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ", new Object[]{"uri_", "note_"});
        }
        if (iOrdinal == 3) {
            return new Item();
        }
    ...
    public static Item parseDelimitedFrom(InputStream inputStream, aux auxVar) {
        return (Item) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static Item parseFrom(ByteBuffer byteBuffer, aux auxVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer, auxVar);
    }

    public static Item parseFrom(gva gvaVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar);
    }

    public static Item parseFrom(gva gvaVar, aux auxVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar, auxVar);
    }

    public static Item parseFrom(byte[] bArr) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static Item parseFrom(byte[] bArr, aux auxVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr, auxVar);
    }

    public static Item parseFrom(InputStream inputStream) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Item parseFrom(InputStream inputStream, aux auxVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static Item parseFrom(owe oweVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar);
    }

    public static Item parseFrom(owe oweVar, aux auxVar) {
        return (Item) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar, auxVar);
    }
}
