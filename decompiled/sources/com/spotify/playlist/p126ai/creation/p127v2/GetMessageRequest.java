...
public final class GetMessageRequest extends AbstractC0269h implements GetMessageRequestOrBuilder {
    ...
    /* JADX INFO: renamed from: com.spotify.playlist.ai.creation.v2.GetMessageRequest$1 */
    public static /* synthetic */ class C11801 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f6435xa1df5c61;
    ...
    public static final class Builder extends AbstractC0268g implements GetMessageRequestOrBuilder {
        ...
        public final Builder clearMessageId() {
            copyOnWrite();
            ((GetMessageRequest) this.instance).clearMessageId();
            return this;
        }

        public final Builder clearSessionId() {
            copyOnWrite();
            ((GetMessageRequest) this.instance).clearSessionId();
            return this;
        }
        ...
        @Override // com.spotify.playlist.p126ai.creation.p127v2.GetMessageRequestOrBuilder
        public final String getMessageId() {
            return ((GetMessageRequest) this.instance).getMessageId();
        }

        @Override // com.spotify.playlist.p126ai.creation.p127v2.GetMessageRequestOrBuilder
        public final gva getMessageIdBytes() {
            return ((GetMessageRequest) this.instance).getMessageIdBytes();
        }

        @Override // com.spotify.playlist.p126ai.creation.p127v2.GetMessageRequestOrBuilder
        public final String getSessionId() {
            return ((GetMessageRequest) this.instance).getSessionId();
        }

        @Override // com.spotify.playlist.p126ai.creation.p127v2.GetMessageRequestOrBuilder
        public final gva getSessionIdBytes() {
            return ((GetMessageRequest) this.instance).getSessionIdBytes();
        }
        ...
        public final Builder setMessageId(String str) {
            copyOnWrite();
            ((GetMessageRequest) this.instance).setMessageId(str);
            return this;
        }

        public final Builder setMessageIdBytes(gva gvaVar) {
            copyOnWrite();
            ((GetMessageRequest) this.instance).setMessageIdBytes(gvaVar);
            return this;
        }

        public final Builder setSessionId(String str) {
            copyOnWrite();
            ((GetMessageRequest) this.instance).setSessionId(str);
            return this;
        }

        public final Builder setSessionIdBytes(gva gvaVar) {
            copyOnWrite();
            ((GetMessageRequest) this.instance).setSessionIdBytes(gvaVar);
            return this;
        }

        private Builder() {
            super(GetMessageRequest.DEFAULT_INSTANCE);
        }
    ...
    public static GetMessageRequest parseDelimitedFrom(InputStream inputStream) {
        return (GetMessageRequest) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static GetMessageRequest parseFrom(ByteBuffer byteBuffer) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public static Builder newBuilder(GetMessageRequest getMessageRequest) {
        return (Builder) DEFAULT_INSTANCE.createBuilder(getMessageRequest);
    }

    public static GetMessageRequest parseDelimitedFrom(InputStream inputStream, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static GetMessageRequest parseFrom(ByteBuffer byteBuffer, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer, auxVar);
    }

    public static GetMessageRequest parseFrom(gva gvaVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar);
    }

    public static GetMessageRequest parseFrom(gva gvaVar, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar, auxVar);
    }

    public static GetMessageRequest parseFrom(byte[] bArr) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static GetMessageRequest parseFrom(byte[] bArr, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr, auxVar);
    }

    public static GetMessageRequest parseFrom(InputStream inputStream) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static GetMessageRequest parseFrom(InputStream inputStream, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static GetMessageRequest parseFrom(owe oweVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar);
    }

    public static GetMessageRequest parseFrom(owe oweVar, aux auxVar) {
        return (GetMessageRequest) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar, auxVar);
    }
}
