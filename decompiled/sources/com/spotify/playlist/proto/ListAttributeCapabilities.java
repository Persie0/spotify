...
public final class ListAttributeCapabilities extends AbstractC0269h implements sre0 {
    ...
    public static ListAttributeCapabilities m18479n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new sj80(DEFAULT_INSTANCE, 3);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final AttributeCapabilities m18480o() {
        AttributeCapabilities attributeCapabilities = this.description_;
        return attributeCapabilities == null ? AttributeCapabilities.m18453o() : attributeCapabilities;
    }

    /* JADX INFO: renamed from: p */
    public final AttributeCapabilities m18481p() {
        AttributeCapabilities attributeCapabilities = this.name_;
        return attributeCapabilities == null ? AttributeCapabilities.m18453o() : attributeCapabilities;
    }

    /* JADX INFO: renamed from: q */
    public final AttributeCapabilities m18482q() {
