...
public final class SecondaryButtonView extends o20 {
    ...
    public SecondaryButtonView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        float f = 255;
        ((GradientDrawable) children[0]).setStroke(context.getResources().getDimensionPixelSize(R.dimen.encore_action_button_border_width), m9f.m61224l(vtg1.m86387n(this, R.attr.baseEssentialSubdued), (int) (u1x0.m82232a(R.dimen.opacity_30, getResources()) * f)));
        ((GradientDrawable) children[1]).setStroke(context.getResources().getDimensionPixelSize(R.dimen.encore_action_button_border_width), m9f.m61224l(vtg1.m86387n(this, R.attr.baseEssentialSubdued), (int) (u1x0.m82232a(R.dimen.opacity_70, getResources()) * f)));
        ((GradientDrawable) children[2]).setStroke(context.getResources().getDimensionPixelSize(R.dimen.encore_action_button_border_width), vtg1.m86387n(this, R.attr.baseEssentialSubdued));
    }

    public /* synthetic */ SecondaryButtonView(Context context, AttributeSet attributeSet, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
