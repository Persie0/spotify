...
public final class NativeAdsFreeUserSinglePromo extends AbstractC0269h implements sre0 {
    ...
    public static void m13419n(NativeAdsFreeUserSinglePromo nativeAdsFreeUserSinglePromo, String str) {
    ...
    public static void m13420o(NativeAdsFreeUserSinglePromo nativeAdsFreeUserSinglePromo, String str) {
        nativeAdsFreeUserSinglePromo.getClass();
        str.getClass();
    ...
    public static void m13421p(NativeAdsFreeUserSinglePromo nativeAdsFreeUserSinglePromo, String str) {
        nativeAdsFreeUserSinglePromo.getClass();
        str.getClass();
    ...
    public static void m13422q(NativeAdsFreeUserSinglePromo nativeAdsFreeUserSinglePromo, boolean z) {
        nativeAdsFreeUserSinglePromo.bitField0_ |= 8;
        nativeAdsFreeUserSinglePromo.hasOnDemandAccess_ = z;
    }

    /* JADX INFO: renamed from: r */
    public static void m13423r(NativeAdsFreeUserSinglePromo nativeAdsFreeUserSinglePromo) {
        nativeAdsFreeUserSinglePromo.getClass();
        nativeAdsFreeUserSinglePromo.bitField0_ |= 16;
        nativeAdsFreeUserSinglePromo.nativeAdPromotion_ = "marquee";
    }

    /* JADX INFO: renamed from: s */
    public static wvi0 m13424s() {
        return (wvi0) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new wvi0(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
