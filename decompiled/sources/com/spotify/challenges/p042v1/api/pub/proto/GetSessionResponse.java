...
public final class GetSessionResponse extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0001\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001<\u0000\u0002<\u0000", new Object[]{"state_", "stateCase_", SessionInProgressResponse.class, Empty.class});
        }
        if (iOrdinal == 3) {
            return new GetSessionResponse();
        }
        if (iOrdinal == 4) {
            return new ca10(DEFAULT_INSTANCE, 24);
        }
        if (iOrdinal == 5) {
    ...
    public final SessionInProgressResponse m5921n() {
        return this.stateCase_ == 1 ? (SessionInProgressResponse) this.state_ : SessionInProgressResponse.m5923o();
    }
