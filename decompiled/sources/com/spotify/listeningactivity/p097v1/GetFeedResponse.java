...
public final class GetFeedResponse extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"entities_", FeedEntityWrapper.class});
        }
        if (iOrdinal == 3) {
            return new GetFeedResponse();
        }
        if (iOrdinal == 4) {
            return new k810(DEFAULT_INSTANCE, 6);
        }
        if (iOrdinal == 5) {
