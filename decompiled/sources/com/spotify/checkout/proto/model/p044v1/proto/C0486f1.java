...
/* JADX INFO: renamed from: com.spotify.checkout.proto.model.v1.proto.f1 */
/* JADX INFO: loaded from: classes5.dex */
public final class C0486f1 extends AbstractC0268g implements sre0 {
    ...
    public final void m6556m(List list) {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6407n((SpotifyCheckoutNative.SummarySection) this.instance, list);
    }
    ...
    public final void m6557q(C0489g1 c0489g1) {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6408o((SpotifyCheckoutNative.SummarySection) this.instance, (SpotifyCheckoutNative.SummarySection.ItemRow) c0489g1.build());
    }

    /* JADX INFO: renamed from: r */
    public final void m6558r(TimelineV2 timelineV2) {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6409p((SpotifyCheckoutNative.SummarySection) this.instance, timelineV2);
    }

    /* JADX INFO: renamed from: s */
    public final void m6559s() {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6410q((SpotifyCheckoutNative.SummarySection) this.instance);
    }

    /* JADX INFO: renamed from: t */
    public final void m6560t() {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6411r((SpotifyCheckoutNative.SummarySection) this.instance);
    }

    /* JADX INFO: renamed from: u */
    public final void m6561u() {
        copyOnWrite();
        SpotifyCheckoutNative.SummarySection.m6412s((SpotifyCheckoutNative.SummarySection) this.instance);
    }
