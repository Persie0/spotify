...
/* JADX INFO: renamed from: com.spotify.checkout.proto.model.v1.proto.n */
/* JADX INFO: loaded from: classes5.dex */
public final class C0508n extends AbstractC0268g implements sre0 {
    ...
    public final void m6617m(CheckoutItemUnavailable checkoutItemUnavailable) {
        copyOnWrite();
        GetCheckoutPageResponse.m6053n((GetCheckoutPageResponse) this.instance, checkoutItemUnavailable);
    }
    ...
    public final void m6618q(CheckoutStatus checkoutStatus) {
        copyOnWrite();
        GetCheckoutPageResponse.m6054o((GetCheckoutPageResponse) this.instance, checkoutStatus);
    }

    /* JADX INFO: renamed from: r */
    public final void m6619r(Error error) {
        copyOnWrite();
        GetCheckoutPageResponse.m6055p((GetCheckoutPageResponse) this.instance, error);
    }

    /* JADX INFO: renamed from: s */
    public final void m6620s(GetCheckoutPageResponse.GpbCheckout gpbCheckout) {
        copyOnWrite();
        GetCheckoutPageResponse.m6056q((GetCheckoutPageResponse) this.instance, gpbCheckout);
    }

    /* JADX INFO: renamed from: t */
    public final void m6621t(rkv0 rkv0Var) {
        copyOnWrite();
        GetCheckoutPageResponse.m6057r((GetCheckoutPageResponse) this.instance, (Redirect) rkv0Var.build());
    }

    /* JADX INFO: renamed from: u */
    public final void m6622u(GetCheckoutPageResponse.SpotifyCheckout spotifyCheckout) {
        copyOnWrite();
        GetCheckoutPageResponse.m6058s((GetCheckoutPageResponse) this.instance, spotifyCheckout);
    }

    /* JADX INFO: renamed from: v */
    public final void m6623v(SpotifyCheckoutNative spotifyCheckoutNative) {
        copyOnWrite();
        GetCheckoutPageResponse.m6059t((GetCheckoutPageResponse) this.instance, spotifyCheckoutNative);
    }

    /* JADX INFO: renamed from: w */
    public final void m6624w(GetCheckoutPageResponse.UcbCheckout ucbCheckout) {
        copyOnWrite();
        GetCheckoutPageResponse.m6060u((GetCheckoutPageResponse) this.instance, ucbCheckout);
    }
