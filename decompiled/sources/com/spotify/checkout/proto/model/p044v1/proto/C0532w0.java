...
/* JADX INFO: renamed from: com.spotify.checkout.proto.model.v1.proto.w0 */
/* JADX INFO: loaded from: classes5.dex */
public final class C0532w0 extends AbstractC0268g implements sre0 {
    ...
    public final void m6676m(Iterable iterable) {
        copyOnWrite();
        SpotifyCheckoutNative.PaymentSection.m6360n((SpotifyCheckoutNative.PaymentSection) this.instance, iterable);
    }
    ...
    public final void m6677q(SpotifyCheckoutNative.PaymentSection.CurrentPaymentDetails currentPaymentDetails) {
        copyOnWrite();
        SpotifyCheckoutNative.PaymentSection.m6361o((SpotifyCheckoutNative.PaymentSection) this.instance, currentPaymentDetails);
    }

    /* JADX INFO: renamed from: r */
    public final void m6678r(C0474b1 c0474b1) {
        copyOnWrite();
        SpotifyCheckoutNative.PaymentSection.m6362p((SpotifyCheckoutNative.PaymentSection) this.instance, (SpotifyCheckoutNative.PaymentSection.PaymentArgs) c0474b1.build());
    }

    /* JADX INFO: renamed from: s */
    public final void m6679s(String str) {
        copyOnWrite();
        SpotifyCheckoutNative.PaymentSection.m6363q((SpotifyCheckoutNative.PaymentSection) this.instance, str);
    }
