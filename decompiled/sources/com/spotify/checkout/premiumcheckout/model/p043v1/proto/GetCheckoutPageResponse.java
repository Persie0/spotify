...
public final class GetCheckoutPageResponse extends AbstractC0269h implements sre0 {
    ...
    public static final class RedirectToWebResponse extends AbstractC0269h implements sre0 {
        ...
        static {
            ...
            AbstractC0269h.registerDefaultInstance(RedirectToWebResponse.class, redirectToWebResponse);
        }
        ...
        public static RedirectToWebResponse m5934n() {
        ...
        public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
            ...
            if (iOrdinal == 4) {
                return new C0468b(DEFAULT_INSTANCE);
            }
            if (iOrdinal == 5) {
                return DEFAULT_INSTANCE;
            }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0001\u0000\u0002\u0002\u0001\u0000\u0000\u0000\u0002<\u0000", new Object[]{"response_", "responseCase_", RedirectToWebResponse.class});
        }
        if (iOrdinal == 3) {
            return new GetCheckoutPageResponse();
        }
        if (iOrdinal == 4) {
            return new C0467a(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    /* JADX INFO: renamed from: n */
    public final RedirectToWebResponse m5933n() {
        return this.responseCase_ == 2 ? (RedirectToWebResponse) this.response_ : RedirectToWebResponse.m5934n();
    }
