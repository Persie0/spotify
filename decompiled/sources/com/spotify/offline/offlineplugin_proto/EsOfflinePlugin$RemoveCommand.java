...
public final class EsOfflinePlugin$RemoveCommand extends AbstractC0269h implements sre0 {
    ...
    public static final class Header extends AbstractC0269h implements sre0 {
        ...
        public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
            ...
            if (iOrdinal == 4) {
                return new C1086l(DEFAULT_INSTANCE);
            }
            if (iOrdinal == 5) {
    ...
    public static final class Query extends AbstractC0269h implements sre0 {
        ...
        public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
            ...
            if (iOrdinal == 2) {
                return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0001\u0000\u0000\u0001Ȉ\u00022", new Object[]{"link_", "metadata_", AbstractC1088n.f6397a});
            }
            if (iOrdinal == 3) {
                return new Query();
            }
            if (iOrdinal == 4) {
                return new C1087m(DEFAULT_INSTANCE);
            }
            if (iOrdinal == 5) {
                return DEFAULT_INSTANCE;
            }
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(EsOfflinePlugin$RemoveCommand.class, esOfflinePlugin$RemoveCommand);
    }
    ...
    public static EsOfflinePlugin$RemoveCommand m16066o(byte[] bArr) {
        return (EsOfflinePlugin$RemoveCommand) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new C1085k(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
