...
public final class OfflinePlugin$TargetFormat extends AbstractC0269h implements sre0 {
    public static final int BITRATE_FIELD_NUMBER = 1;
    private static final OfflinePlugin$TargetFormat DEFAULT_INSTANCE;
    private static volatile r2n0 PARSER;
    private int bitrate_;

    static {
        OfflinePlugin$TargetFormat offlinePlugin$TargetFormat = new OfflinePlugin$TargetFormat();
        DEFAULT_INSTANCE = offlinePlugin$TargetFormat;
        AbstractC0269h.registerDefaultInstance(OfflinePlugin$TargetFormat.class, offlinePlugin$TargetFormat);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new bpj0(DEFAULT_INSTANCE, 25);
        }
        if (iOrdinal == 5) {
