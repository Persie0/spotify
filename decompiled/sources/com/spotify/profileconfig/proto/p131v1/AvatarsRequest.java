...
public final class AvatarsRequest extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(AvatarsRequest.class, avatarsRequest);
    }
    ...
    public static void m19845n(AvatarsRequest avatarsRequest, String str) {
    ...
    public static ma8 m19846o() {
        return (ma8) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new ma8(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
