...
public final class Verification extends AbstractC0269h implements sre0 {
    ...
    public static final int SK_AD_NETWORK_FIELD_NUMBER = 1;
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0001\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001<\u0000", new Object[]{"type_", "typeCase_", SKAdNetworkData.class});
        }
        if (iOrdinal == 3) {
            return new Verification();
        }
        if (iOrdinal == 4) {
            return new h2b1(DEFAULT_INSTANCE, 16);
        }
        if (iOrdinal == 5) {
