...
public final class ImageBytes extends AbstractC0269h implements sre0 {
    ...
    public static void m20977n(ImageBytes imageBytes, cva cvaVar) {
        imageBytes.getClass();
        imageBytes.imageBytes_ = cvaVar;
    }

    /* JADX INFO: renamed from: o */
    public static void m20978o(ImageBytes imageBytes, String str) {
        imageBytes.getClass();
        imageBytes.mimeType_ = str;
    }

    /* JADX INFO: renamed from: p */
    public static n440 m20979p() {
        return (n440) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new n440(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
