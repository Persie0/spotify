...
public final class ShowShowRequest$ContinueListeningSection extends AbstractC0269h implements sre0 {
    private static final ShowShowRequest$ContinueListeningSection DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = showShowRequest$ContinueListeningSection;
        AbstractC0269h.registerDefaultInstance(ShowShowRequest$ContinueListeningSection.class, showShowRequest$ContinueListeningSection);
    }
    ...
    public static ShowShowRequest$ContinueListeningSection m15503n() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new fi11(DEFAULT_INSTANCE, 26);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final ShowShowRequest$ProtoShowRequestItem m15504o() {
