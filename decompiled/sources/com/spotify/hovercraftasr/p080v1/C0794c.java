...
/* JADX INFO: renamed from: com.spotify.hovercraftasr.v1.c */
/* JADX INFO: loaded from: classes7.dex */
public final class C0794c extends AbstractC0268g implements sre0 {
    ...
    public final void m11890m(String str) {
        copyOnWrite();
        AsrStreamRequest.InteractionManagerParams.m11869n((AsrStreamRequest.InteractionManagerParams) this.instance, str);
    }
    ...
    public final void m11891q(String str) {
        copyOnWrite();
        AsrStreamRequest.InteractionManagerParams.m11870o((AsrStreamRequest.InteractionManagerParams) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m11892r(String str) {
        copyOnWrite();
        AsrStreamRequest.InteractionManagerParams.m11871p((AsrStreamRequest.InteractionManagerParams) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m11893s(String str) {
        copyOnWrite();
        AsrStreamRequest.InteractionManagerParams.m11872q((AsrStreamRequest.InteractionManagerParams) this.instance, str);
    }
