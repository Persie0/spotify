...
/* JADX INFO: renamed from: com.spotify.messages.l */
/* JADX INFO: loaded from: classes8.dex */
public final class C0894l extends AbstractC0268g implements sre0 {
    ...
    public final void m15026m(String str) {
        copyOnWrite();
        UbiProd1Impression.SourcePaths.Path.Elements.m14612n((UbiProd1Impression.SourcePaths.Path.Elements) this.instance, str);
    }
    ...
    public final void m15027q(String str) {
        copyOnWrite();
        UbiProd1Impression.SourcePaths.Path.Elements.m14613o((UbiProd1Impression.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m15028r(String str) {
        copyOnWrite();
        UbiProd1Impression.SourcePaths.Path.Elements.m14614p((UbiProd1Impression.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m15029s(String str) {
        copyOnWrite();
        UbiProd1Impression.SourcePaths.Path.Elements.m14615q((UbiProd1Impression.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m15030t(String str) {
        copyOnWrite();
        UbiProd1Impression.SourcePaths.Path.Elements.m14616r((UbiProd1Impression.SourcePaths.Path.Elements) this.instance, str);
    }
