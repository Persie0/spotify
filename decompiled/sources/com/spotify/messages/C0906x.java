...
/* JADX INFO: renamed from: com.spotify.messages.x */
/* JADX INFO: loaded from: classes8.dex */
public final class C0906x extends AbstractC0268g implements sre0 {
    ...
    public final void m15161m(String str) {
        copyOnWrite();
        UbiProd1InteractionNonAuth.SourcePaths.Path.Elements.m14768n((UbiProd1InteractionNonAuth.SourcePaths.Path.Elements) this.instance, str);
    }
    ...
    public final void m15162q(String str) {
        copyOnWrite();
        UbiProd1InteractionNonAuth.SourcePaths.Path.Elements.m14769o((UbiProd1InteractionNonAuth.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: r */
    public final void m15163r(String str) {
        copyOnWrite();
        UbiProd1InteractionNonAuth.SourcePaths.Path.Elements.m14770p((UbiProd1InteractionNonAuth.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: s */
    public final void m15164s(String str) {
        copyOnWrite();
        UbiProd1InteractionNonAuth.SourcePaths.Path.Elements.m14771q((UbiProd1InteractionNonAuth.SourcePaths.Path.Elements) this.instance, str);
    }

    /* JADX INFO: renamed from: t */
    public final void m15165t(String str) {
        copyOnWrite();
        UbiProd1InteractionNonAuth.SourcePaths.Path.Elements.m14772r((UbiProd1InteractionNonAuth.SourcePaths.Path.Elements) this.instance, str);
    }
