...
public final class Background extends AbstractC0269h implements sre0 {
    ...
    public static Background m9909p() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new na8(DEFAULT_INSTANCE, 4);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final Color m9911o() {
        return this.formatCase_ == 1 ? (Color) this.format_ : Color.m9919n();
    }

    /* JADX INFO: renamed from: q */
    public final int m9912q() {
    ...
    public final Image m9913r() {
        return this.formatCase_ == 3 ? (Image) this.format_ : Image.m9922n();
    }

    /* JADX INFO: renamed from: s */
    public final Video m9914s() {
        return this.formatCase_ == 2 ? (Video) this.format_ : Video.m9924n();
    }
