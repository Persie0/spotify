...
public final class Location extends AbstractC0269h implements sre0 {
    ...
    public static Location m10048r(byte[] bArr) {
        return (Location) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new lj90(DEFAULT_INSTANCE, 20);
        }
        if (iOrdinal == 5) {
    ...
    public final PhysicalLocation m10050o() {
        return this.detailsCase_ == 4 ? (PhysicalLocation) this.details_ : PhysicalLocation.m10053o();
    }

    /* JADX INFO: renamed from: p */
    public final String m10051p() {
        return this.venueUri_;
    }

    /* JADX INFO: renamed from: q */
    public final boolean m10052q() {
