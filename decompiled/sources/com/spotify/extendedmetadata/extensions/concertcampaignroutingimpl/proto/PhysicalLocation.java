...
public final class PhysicalLocation extends AbstractC0269h implements sre0 {
    ...
    public static PhysicalLocation m10002o() {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new hnn0(DEFAULT_INSTANCE, 8);
        }
        if (iOrdinal == 5) {
            return DEFAULT_INSTANCE;
        }
    ...
    public final LatLon m10004p() {
        LatLon latLon = this.latLong_;
        return latLon == null ? LatLon.m9994n() : latLon;
    }
