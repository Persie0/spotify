package com.spotify.adsdisplay.elementimpl.feedback.events.proto;
...
public final class AdFeedbackEvent extends AbstractC0269h implements sre0 {
    ...
    public static void m2770n(AdFeedbackEvent adFeedbackEvent, String str) {
    ...
    public static void m2771o(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2772p(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2773q(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2774r(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2775s(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2776t(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
    ...
    public static void m2777u(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
        adFeedbackEvent.bitField0_ |= 8192;
        adFeedbackEvent.productName_ = str;
    }

    /* JADX INFO: renamed from: v */
    public static void m2778v(AdFeedbackEvent adFeedbackEvent, long j) {
        adFeedbackEvent.bitField0_ |= 128;
        adFeedbackEvent.progress_ = j;
    }

    /* JADX INFO: renamed from: w */
    public static void m2779w(AdFeedbackEvent adFeedbackEvent, String str) {
        adFeedbackEvent.getClass();
        str.getClass();
        adFeedbackEvent.bitField0_ |= 4096;
        adFeedbackEvent.slot_ = str;
    }

    /* JADX INFO: renamed from: x */
    public static void m2780x(AdFeedbackEvent adFeedbackEvent, double d) {
        adFeedbackEvent.bitField0_ |= 64;
        adFeedbackEvent.volume_ = d;
    }

    /* JADX INFO: renamed from: y */
    public static fo0 m2781y() {
        return (fo0) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new fo0(DEFAULT_INSTANCE);
        }
        if (iOrdinal == 5) {
