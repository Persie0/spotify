...
public final class ReactionsRow extends AbstractC0269h implements sre0 {
    ...
    public static ReactionsRow m19460q(byte[] bArr) {
        return (ReactionsRow) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0001\u0000\u0001Ț\u0002\u0004\u0003Ȉ", new Object[]{"topReactionUnicode_", "numberOfReactions_", "usersReactionUnicode_"});
        }
        if (iOrdinal == 3) {
            return new ReactionsRow();
        }
        if (iOrdinal == 4) {
            return new u6u0(DEFAULT_INSTANCE, 9);
        }
        if (iOrdinal == 5) {
    ...
    public final ae50 m19462o() {
        return this.topReactionUnicode_;
    }

    /* JADX INFO: renamed from: p */
    public final String m19463p() {
