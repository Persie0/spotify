...
public final class Metadata$Restriction extends AbstractC0269h implements sre0 {
    ...
    private static final vd50 catalogue_converter_ = new m95(17);
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0005\u0001\u0001\u0001\u0005\u0005\u0000\u0002\u0000\u0001ࠞ\u0002;\u0000\u0003;\u0000\u0004᠌\u0000\u0005\u001a", new Object[]{"countryRestriction_", "countryRestrictionCase_", "bitField0_", "catalogue_", nq6.f157167x, "type_", nq6.f157169z, "catalogueStr_"});
        }
        if (iOrdinal == 3) {
            return new Metadata$Restriction();
        }
        if (iOrdinal == 4) {
            return new x5f0(DEFAULT_INSTANCE, 1);
        }
        if (iOrdinal == 5) {
