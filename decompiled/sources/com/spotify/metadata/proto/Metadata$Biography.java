...
public final class Metadata$Biography extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0002\u0000\u0001ဈ\u0000\u0002\u001b\u0003\u001b", new Object[]{"bitField0_", "text_", "portrait_", Metadata$Image.class, "portraitGroup_", Metadata$ImageGroup.class});
        }
        if (iOrdinal == 3) {
            return new Metadata$Biography();
        }
        if (iOrdinal == 4) {
            return new n5f0(DEFAULT_INSTANCE, 1);
        }
        if (iOrdinal == 5) {
