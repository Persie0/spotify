...
public final class Metadata$ArtistWithRole extends AbstractC0269h implements sre0 {
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0000\u0000\u0001ည\u0000\u0002ဈ\u0001\u0003᠌\u0002", new Object[]{"bitField0_", "artistGid_", "artistName_", "role_", nq6.f157155l});
        }
        if (iOrdinal == 3) {
            return new Metadata$ArtistWithRole();
        }
        if (iOrdinal == 4) {
            return new dbd0(DEFAULT_INSTANCE, 23);
        }
        if (iOrdinal == 5) {
