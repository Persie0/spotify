...
public final class Metadata$Availability extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        DEFAULT_INSTANCE = metadata$Availability;
        AbstractC0269h.registerDefaultInstance(Metadata$Availability.class, metadata$Availability);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 2) {
            return AbstractC0269h.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0001\u0000\u0001\u001a\u0002ဉ\u0000", new Object[]{"bitField0_", "catalogueStr_", "start_"});
        }
        if (iOrdinal == 3) {
            return new Metadata$Availability();
        }
        if (iOrdinal == 4) {
            return new n5f0(DEFAULT_INSTANCE, 0);
        }
        if (iOrdinal == 5) {
