...
public final class ReplacePendingEventResponse extends AbstractC0269h implements sre0 {
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(ReplacePendingEventResponse.class, replacePendingEventResponse);
    }
    ...
    public static ReplacePendingEventResponse m16976p(byte[] bArr) {
        return (ReplacePendingEventResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }
    ...
    public final Object dynamicMethod(z110 z110Var, Object obj, Object obj2) {
        ...
        if (iOrdinal == 4) {
            return new i8w0(DEFAULT_INSTANCE, 8);
        }
        if (iOrdinal == 5) {
