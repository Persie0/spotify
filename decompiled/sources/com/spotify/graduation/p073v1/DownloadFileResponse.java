...
public final class DownloadFileResponse extends AbstractC0269h implements DownloadFileResponseOrBuilder {
    private static final DownloadFileResponse DEFAULT_INSTANCE;
    public static final int LINK_FIELD_NUMBER = 1;
    private static volatile r2n0 PARSER;
    private String link_ = "";

    /* JADX INFO: renamed from: com.spotify.graduation.v1.DownloadFileResponse$1 */
    public static /* synthetic */ class C07741 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f4144xa1df5c61;
    ...
    public static final class Builder extends AbstractC0268g implements DownloadFileResponseOrBuilder {
        ...
        public final Builder clearLink() {
            copyOnWrite();
            ((DownloadFileResponse) this.instance).clearLink();
            return this;
        }
        ...
        @Override // com.spotify.graduation.p073v1.DownloadFileResponseOrBuilder
        public final String getLink() {
            return ((DownloadFileResponse) this.instance).getLink();
        }

        @Override // com.spotify.graduation.p073v1.DownloadFileResponseOrBuilder
        public final gva getLinkBytes() {
        ...
        public final Builder setLink(String str) {
            copyOnWrite();
            ((DownloadFileResponse) this.instance).setLink(str);
            return this;
        }

        public final Builder setLinkBytes(gva gvaVar) {
            copyOnWrite();
            ((DownloadFileResponse) this.instance).setLinkBytes(gvaVar);
            return this;
        }
    ...
    static {
        ...
        AbstractC0269h.registerDefaultInstance(DownloadFileResponse.class, downloadFileResponse);
    }
    ...
    public static DownloadFileResponse parseDelimitedFrom(InputStream inputStream) {
        return (DownloadFileResponse) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static DownloadFileResponse parseFrom(ByteBuffer byteBuffer) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public static DownloadFileResponse parseDelimitedFrom(InputStream inputStream, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static DownloadFileResponse parseFrom(ByteBuffer byteBuffer, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, byteBuffer, auxVar);
    }

    public static DownloadFileResponse parseFrom(gva gvaVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar);
    }

    public static DownloadFileResponse parseFrom(gva gvaVar, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, gvaVar, auxVar);
    }

    public static DownloadFileResponse parseFrom(byte[] bArr) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static DownloadFileResponse parseFrom(byte[] bArr, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, bArr, auxVar);
    }

    public static DownloadFileResponse parseFrom(InputStream inputStream) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static DownloadFileResponse parseFrom(InputStream inputStream, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, inputStream, auxVar);
    }

    public static DownloadFileResponse parseFrom(owe oweVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar);
    }

    public static DownloadFileResponse parseFrom(owe oweVar, aux auxVar) {
        return (DownloadFileResponse) AbstractC0269h.parseFrom(DEFAULT_INSTANCE, oweVar, auxVar);
    }
}
