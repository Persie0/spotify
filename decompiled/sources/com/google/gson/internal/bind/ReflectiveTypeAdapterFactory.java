        ...
        if (!cls.isInterface()) {
            ...
            while (rawType != Object.class) {
                ...
                while (i < length) {
                    ...
                    boolean zExcludeField2 = reflectiveTypeAdapterFactory.excludeField(field, z);
                    if (zExcludeField || zExcludeField2) {
                        ...
                        for (?? r13 = z; r13 < size; r13++) {
                            ...
                            BoundField boundField3 = (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory2.createBoundField(gson, field, str, TypeToken.get(typeResolve), z2, zExcludeField2));
                            if (boundField2 != null) {
