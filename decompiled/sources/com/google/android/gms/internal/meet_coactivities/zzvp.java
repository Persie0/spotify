...
final class zzvp {
    ...
    public static String zzd(byte[] bArr, int i, int i2) throws zztj {
        int i3;
        ...
        while (i < i4) {
            ...
            if (zzvn.zzd(b2)) {
                ...
                if (b2 < -32) {
                    ...
                    int i8 = i + 2;
                    i += 3;
                    zzvn.zzb(b2, bArr[i7], bArr[i8], cArr, i6);
                } else {
                    if (i7 >= i4 - 2) {
                        throw zztj.zzd();
                    }
                    ...
                    byte b5 = bArr[i + 2];
                    i += 4;
                    zzvn.zza(b2, b4, b5, bArr[i9], cArr, i6);
                    i6 += 2;
                }
                i6 = i3;
            }
    ...
    public static boolean zze(byte[] bArr, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (iZza >= 0) {
                ...
                if ((((i6 + ContentType.LONG_FORM_ON_DEMAND) + (iZza << 28)) >> 30) != 0) {
                    return false;
                }
                int i7 = i + 3;
                if (bArr[i5] > -65) {
