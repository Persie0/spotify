...
final class zzvm {
    ...
    static {
        ...
        if (unsafeZzg != null) {
            if (zZzv) {
                zzvjVar = new zzvk(unsafeZzg);
            } else if (zZzv2) {
                zzvjVar = new zzvj(unsafeZzg);
            }
        }
        zzf = zzvjVar;
        if (zzvjVar == null) {
            ...
            try {
                Class<?> cls3 = zzvjVar.zza.getClass();
        ...
        if (zzvlVar2 == null) {
            ...
            try {
                Class<?> cls4 = zzvlVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzvlVar = zzf) != null) {
            zzvlVar.zza.objectFieldOffset(fieldZzB);
        }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzvl zzvlVar = zzf;
        long j2 = (-4) & j;
        int i = zzvlVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzvlVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzvlVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzvlVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzvi());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzvm.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
