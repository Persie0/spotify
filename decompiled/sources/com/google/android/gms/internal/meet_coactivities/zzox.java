...
public enum zzox {
    ...
    static {
        ...
        for (zzox zzoxVar : values()) {
            if (map.put(Character.valueOf(zzoxVar.zzH), zzoxVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(zzoxVar)));
            }
        }
    ...
    public static final zzox zzb(char c) {
        return (zzox) zzF.get(Character.valueOf(c));
    }
