...
interface zzvs {
    ...
    @Deprecated
    void zzq(int i, Object obj, zzur zzurVar);
    ...
    void zzv(int i, zztx zztxVar, Map map);

    void zzw(int i, Object obj, zzur zzurVar);

    void zzx(int i, Object obj);
